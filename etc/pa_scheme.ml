...
(define loc_of_sexpr
  (lambda_match
   ((or (Sacc loc _ _) (Santi loc _ _) (Sarr loc _) (Schar loc _)
     ...
     (Sfloat loc _) (Slid loc _) (Slidv loc _) (Slist loc _) (Squot loc _ _)
     (Srec loc _) (Sstring loc _) (Suid loc _) (Suidv loc _))
    loc)))
