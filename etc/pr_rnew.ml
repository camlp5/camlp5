...
value rec sequence_box ctx horiz vertic el k =
  ...
  in
  let s2 =
    vlistl (semi_after expr_wh) expr_wh (shi ctx 2) (tab (shi ctx 2)) el ""
  in
             ...
             horiz_vertic
               ...
               (fun () ->
                  ...
                  let s2 =
                    horiz_vertic
                      (fun () ->
                         sprintf "%swhen %s ->" (tab ctx) (expr zc "" e ""))
                      (fun () ->
    ...
    (fun () ->
       ...
       let s2 =
         if cl = [] then
           ...
           horiz_vertic
             (fun () ->
                sprintf "%s%s%s%s" (tab (shi ctx 2)) (ctyp zc "" te "")
        ...
        horiz_vertic
         ...
         (fun () ->
            ...
            let s3 =
              horiz_vertic
                (fun () ->
                   sprintf "%selse %s%s" (tab ctx) (expr zc "" e3 "") k)
                (fun () ->
