...
OBJS=ploc.cmo plexing.cmo plexer.cmo gramext.cmo gramalgo.cmo grammar.cmo diff.cmo extfold.cmo extfun.cmo eprinter.cmo fstream.cmo pretty.cmo stdpp.cmo token.cmo
SHELL=/bin/sh
TARGET=gramlib.cma
