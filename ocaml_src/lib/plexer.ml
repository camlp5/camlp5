...
let gmake () =
  ...
  let glexr =
    ref
      {tok_func = (fun _ -> raise (Match_failure ("plexer.ml", 620, 17)));
       tok_using = (fun _ -> raise (Match_failure ("plexer.ml", 620, 37)));
       tok_removing = (fun _ -> raise (Match_failure ("plexer.ml", 620, 60)));
