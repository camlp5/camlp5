...
let sslist_aux loc a_name vala min sep s =
  let rl =
    let r1 =
      let prod =
        let n = mk_name loc (MLast.ExLid (loc, a_name)) in
...
let sslist loc min sep s =
  let vala loc x = x in sslist_aux loc "a_list" vala min sep s
;;
...
let ssflag loc s = let vala loc x = x in ssflag_aux loc "a_flag" vala s;;
   ...
   [Grammar.Entry.obj (expr : 'expr Grammar.Entry.e),
     ...
     [[],
      ...
      [Gramext.Stoken ("UIDENT", "FUNCTION"); Gramext.Stoken ("", ":");
       ...
       Gramext.Snterm
         (Grammar.Entry.obj (semi_sep : 'semi_sep Grammar.Entry.e))],
      Gramext.action
        (fun _ (f : 'qualid) _ _ (loc : Ploc.t) -> (f : 'efunction))]];
    ...
    [None, None,
     [[Gramext.Stoken ("", "[");
      ...
      Gramext.action (fun _ _ (loc : Ploc.t) -> ([] : 'rule_list))]];
    ...
    [None, None,
     [[Gramext.Snterm (Grammar.Entry.obj (qualid : 'qualid Grammar.Entry.e))],
      Gramext.action
        (fun (e : 'qualid) (loc : Ploc.t) -> (mk_name loc e : 'name))]];
    ...
    [None, None,
     ...
     [[Gramext.Stoken ("LIDENT", "")],
      Gramext.action
        (fun (i : string) (loc : Ploc.t) -> (MLast.ExLid (loc, i) : 'qualid));
      [Gramext.Stoken ("UIDENT", "")],
      Gramext.action
        (fun (i : string) (loc : Ploc.t) ->
    ...
    [None, None,
     [[Gramext.Stoken ("", "$");
       Gramext.Snterm (Grammar.Entry.obj (expr : 'expr Grammar.Entry.e));
       Gramext.Stoken ("", "$")],
      Gramext.action (fun _ (e : 'expr) _ (loc : Ploc.t) -> (e : 'string));
      [Gramext.Stoken ("STRING", "")],
      Gramext.action
