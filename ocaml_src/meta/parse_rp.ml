...
module type PARSE_RP_SIG = sig module Base : Mlsyntax.PARSEBASESIG;; end;;

module PA (Base : Mlsyntax.PARSEBASESIG) :
  PARSE_RP_SIG with module Base = Base =
  struct
    module Base = Base;;
    open Base.Parsers;;
    open Base;;
    Grammar.safe_extend
      (let _ = (expr : 'expr Grammar.Entry.e)
       ...
       [Grammar.extension (expr : 'expr Grammar.Entry.e)
            ...
            Grammar.production
              (Grammar.r_next
               ...
               (fun _ (pcl : 'parser_case list) _ (po : 'ipatt option) _ _
                    (e : 'expr) (ext, attrs : 'ext_attributes) _
                    (loc : Ploc.t) ->
              ...
              (Grammar.r_next
                 (Grammar.r_next
                    (Grammar.r_next Grammar.r_stop
                       (Grammar.s_nterm
                          (stream_patt_comp :
                           'stream_patt_comp Grammar.Entry.e)))
                    (Grammar.s_token ("", ";")))
                 (Grammar.s_nterm
        ...
        Grammar.extension
          (stream_patt_kont : 'stream_patt_kont Grammar.Entry.e) None
          [None, None,
           [Grammar.production
              (Grammar.r_next
                 (Grammar.r_next Grammar.r_stop
        ...
        Grammar.extension
          (stream_patt_comp : 'stream_patt_comp Grammar.Entry.e) None
          [None, None,
           [Grammar.production
              (Grammar.r_next Grammar.r_stop
              ...
              (Grammar.r_next
                 (Grammar.r_next
                    ...
                    (Grammar.s_list0sep
                       (Grammar.s_nterm
                          (stream_expr_comp :
                           'stream_expr_comp Grammar.Entry.e))
                       (Grammar.s_token ("", ";")) false))
                 (Grammar.s_token ("", ":]")),
               "194fe98d",
               (fun _ (se : 'stream_expr_comp list) _ (loc : Ploc.t) ->
                  (cstream loc se : 'expr)))]];
        Grammar.extension
          (stream_expr_comp : 'stream_expr_comp Grammar.Entry.e) None
          [None, None,
           [Grammar.production
              (Grammar.r_next Grammar.r_stop
                 (Grammar.s_nterm (expr : 'expr Grammar.Entry.e)),
