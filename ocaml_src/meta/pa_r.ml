         ...
         (Gramext.srules
            [[Gramext.Stoken ("", "=");
              Gramext.Snterm
                (Grammar.Entry.obj (expr : 'expr Grammar.Entry.e))],
             Gramext.action
               (fun (e : 'expr) _ (loc : Ploc.t) -> (e : 'e__10))]);
       Gramext.Stoken ("", "}")],
      Gramext.action
        (fun _ (eo : 'e__10 option) (p : 'patt_tcon) _ _ (loc : Ploc.t) ->
         ...
         (Gramext.srules
            [[Gramext.Stoken ("", "=");
              Gramext.Snterm
                (Grammar.Entry.obj (patt : 'patt Grammar.Entry.e))],
             Gramext.action
               (fun (p : 'patt) _ (loc : Ploc.t) -> (p : 'e__9))]);
       Gramext.Stoken ("", "}")],
      Gramext.action
        (fun _ (po : 'e__9 option) (p : 'patt_tcon) _ _ (loc : Ploc.t) ->
         ...
         (Gramext.srules
            [[Gramext.Stoken ("", "=");
              Gramext.Snterm
                (Grammar.Entry.obj (expr : 'expr Grammar.Entry.e))],
             Gramext.action
               (fun (e : 'expr) _ (loc : Ploc.t) -> (e : 'e__12))]);
       Gramext.Stoken ("", "}")],
      Gramext.action
        (fun _ (eo : 'e__12 option) (p : 'ipatt_tcon) _ _ (loc : Ploc.t) ->
         ...
         (Gramext.srules
            [[Gramext.Stoken ("", "=");
              Gramext.Snterm
                (Grammar.Entry.obj (patt : 'patt Grammar.Entry.e))],
             Gramext.action
               (fun (p : 'patt) _ (loc : Ploc.t) -> (p : 'e__11))]);
       Gramext.Stoken ("", "}")],
      Gramext.action
        (fun _ (po : 'e__11 option) (p : 'ipatt_tcon) _ _ (loc : Ploc.t) ->
    ...
    [Some "label", Some Gramext.NonA,
     [[Gramext.Stoken ("QUESTIONIDENT", "")],
         ...
         (Gramext.srules
            [[Gramext.Stoken ("", "=");
              Gramext.Snterm
                (Grammar.Entry.obj (expr : 'expr Grammar.Entry.e))],
             Gramext.action
               (fun (e : 'expr) _ (loc : Ploc.t) -> (e : 'e__14))]);
       Gramext.Stoken ("", "}")],
      Gramext.action
      ...
      [Gramext.Stoken ("", "~"); Gramext.Stoken ("", "{");
       ...
       Gramext.Stoken ("", "}")],
      Gramext.action
        (fun _ (eo : 'e__13 option) (p : 'patt_tcon) _ _ (loc : Ploc.t) ->
