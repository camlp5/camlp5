        ...
        Grammar.production
          (Grammar.r_next
           ...
           (fun (item_attrs : 'item_attribute list)
                ...
                (loc : Ploc.t) ->
              (MLast.StExc (loc, c, tl, b, alg_attrs, []) : 'str_item)));
        Grammar.production
          (Grammar.r_next
             (Grammar.r_next
                (Grammar.r_next Grammar.r_stop
        ...
        Grammar.production
          (Grammar.r_next
           ...
           (fun (item_attrs : 'item_attribute list)
                ...
                (_, c, tl, _ : 'constructor_declaration_sans_alg_attrs) _
                (loc : Ploc.t) ->
              (MLast.SgExc (loc, c, tl, alg_attrs, []) : 'sig_item)));
        Grammar.production
          (Grammar.r_next
             (Grammar.r_next
                (Grammar.r_next Grammar.r_stop
        ...
        Grammar.production
          (Grammar.r_next
             ...
             (Grammar.s_list0
                (Grammar.s_nterm
                   (alg_attribute : 'alg_attribute Grammar.Entry.e))),
           (fun (attrs : 'alg_attribute list) (t : 'ctyp) _ (ci : string)
                (loc : Ploc.t) ->
        ...
        Grammar.production
          (Grammar.r_next
             ...
             (Grammar.s_list0
                (Grammar.s_nterm
                   (alg_attribute : 'alg_attribute Grammar.Entry.e))),
           (fun (attrs : 'alg_attribute list) (cal : 'ctyp list) _
                      ...
                      [Grammar.production
                         (Grammar.r_next
                          ...
                          (fun _ (s : 'class_str_item) (loc : Ploc.t) ->
                             (s : 'e__11)))])))
             (Grammar.s_token ("", "end")),
           (fun _ (st : 'e__11 list) _ (loc : Ploc.t) ->
                      ...
                      [Grammar.production
                         (Grammar.r_next
                          ...
                          (fun _ (s : 'class_sig_item) (loc : Ploc.t) ->
                             (s : 'e__13)))])))
             (Grammar.s_token ("", "end")),
           (fun _ (st : 'e__13 list) _ (loc : Ploc.t) ->
                      ...
                      [Grammar.production
                         (Grammar.r_next
                          ...
                          (fun (e : 'expr) _ (loc : Ploc.t) ->
                             (e : 'e__14)))])))
             (Grammar.s_token ("", "}")),
           (fun _ (eo : 'e__14 option) (p : 'patt_tcon) _ _ (loc : Ploc.t) ->
                   ...
                   [Grammar.production
                      (Grammar.r_next
                         (Grammar.r_next Grammar.r_stop
                            (Grammar.s_token ("", "=")))
                         (Grammar.s_nterm (patt : 'patt Grammar.Entry.e)),
                       (fun (p : 'patt) _ (loc : Ploc.t) -> (p : 'e__15)))])),
           (fun (po : 'e__15 option) (p : 'patt_tcon) (loc : Ploc.t) ->
                      ...
                      [Grammar.production
                         (Grammar.r_next
                          ...
                          (fun (e : 'expr) _ (loc : Ploc.t) ->
                             (e : 'e__16)))])))
             (Grammar.s_token ("", "}")),
           (fun _ (eo : 'e__16 option) (p : 'ipatt_tcon) _ _ (loc : Ploc.t) ->
                   ...
                   [Grammar.production
                      (Grammar.r_next
                         (Grammar.r_next Grammar.r_stop
                            (Grammar.s_token ("", "=")))
                         (Grammar.s_nterm (patt : 'patt Grammar.Entry.e)),
                       (fun (p : 'patt) _ (loc : Ploc.t) -> (p : 'e__17)))])),
           (fun (po : 'e__17 option) (p : 'ipatt_tcon) (loc : Ploc.t) ->
