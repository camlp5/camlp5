...
Grammar.extend
  (let _ = (sig_item : 'sig_item Grammar.Entry.e)
   ...
   [Grammar.Entry.obj (module_expr : 'module_expr Grammar.Entry.e), None,
    ...
    [None, None,
     [[Gramext.Stoken ("ANTIQUOT_LOC", "_")],
      ...
      Gramext.action
        (fun (s : string) (loc : Ploc.t) ->
           (failwith "antiquot" : 'mod_ident2));
      [Gramext.Stoken ("ANTIQUOT_LOC", "_list")],
      Gramext.action
        (fun (s : string) (loc : Ploc.t) ->
           (failwith "antiquot" : 'mod_ident2));
     ...
     [[Gramext.Stoken ("", "initializer");
      ...
      [Gramext.Stoken ("", "method");
       ...
       Gramext.Snterm
         (Grammar.Entry.obj (fun_binding : 'fun_binding Grammar.Entry.e))],
      Gramext.action
        (fun (e : 'fun_binding) (topt : 'polyt option) (l : 'label2)
      ...
      [Gramext.Stoken ("", "method"); Gramext.Stoken ("", "virtual");
       ...
       Gramext.Snterm (Grammar.Entry.obj (ctyp : 'ctyp Grammar.Entry.e))],
      Gramext.action
        (fun (t : 'ctyp) _ (l : 'label2) (pf : bool) _ _ (loc : Ploc.t) ->
      ...
      Gramext.action
        (fun (e : 'cvalue_binding) (lab : 'label2) (mf : bool) _
             (loc : Ploc.t) ->
    ...
    [None, None,
     [[Gramext.Stoken ("LIDENT", "")],
      Gramext.action (fun (i : string) (loc : Ploc.t) -> (i : 'label2))]];
    ...
    [None, None,
     [[Gramext.Stoken ("", "object");
      ...
      [Gramext.Snterm
       ...
       Gramext.Stoken ("", "]")],
      Gramext.action
        (fun _ (tl : 'ctyp list) _ (id : 'clty_longident2) (loc : Ploc.t) ->
    ...
    [None, None,
     [[Gramext.Stoken ("", "type");
      ...
      [Gramext.Stoken ("", "method");
       ...
       Gramext.Snterm (Grammar.Entry.obj (ctyp : 'ctyp Grammar.Entry.e))],
      Gramext.action
        (fun (t : 'ctyp) _ (l : 'label2) (pf : bool) _ (loc : Ploc.t) ->
      ...
      [Gramext.Stoken ("", "value");
       ...
       Gramext.Snterm (Grammar.Entry.obj (ctyp : 'ctyp Grammar.Entry.e))],
      Gramext.action
        (fun (t : 'ctyp) _ (l : 'label2) (mf : bool) _ (loc : Ploc.t) ->
    ...
    [None, None,
     [[Gramext.Stoken ("ANTIQUOT_LOC", "_list")],
      Gramext.action
        (fun (s : string) (loc : Ploc.t) ->
           (failwith "antiquot" : 'clty_longident2));
      [Gramext.Stoken ("ANTIQUOT_LOC", "list")],
      Gramext.action
        (fun (s : string) (loc : Ploc.t) ->
           (failwith "antiquot" : 'clty_longident2));
    ...
    [None, None,
     [[Gramext.Stoken ("TILDEANTIQUOT_LOC", "_")],
      Gramext.action
    ...
    None,
    [None, None,
     [[Gramext.Stoken ("TILDEANTIQUOTCOLON_LOC", "_")],
      Gramext.action
        (fun (a : string) (loc : Ploc.t) ->
           (failwith "antiquot" : 'tildeidentcolon));
      [Gramext.Stoken ("TILDEANTIQUOTCOLON_LOC", "")],
      Gramext.action
        (fun (a : string) (loc : Ploc.t) ->
           (failwith "antiquot" : 'tildeidentcolon));
    ...
    [None, None,
     [[Gramext.Stoken ("QUESTIONANTIQUOT_LOC", "_")],
      Gramext.action
        (fun (a : string) (loc : Ploc.t) ->
           (failwith "antiquot" : 'questionident));
      [Gramext.Stoken ("QUESTIONANTIQUOT_LOC", "")],
      Gramext.action
        (fun (a : string) (loc : Ploc.t) ->
           (failwith "antiquot" : 'questionident));
    ...
    None,
    [None, None,
     [[Gramext.Stoken ("QUESTIONANTIQUOTCOLON_LOC", "_")],
      Gramext.action
        (fun (a : string) (loc : Ploc.t) ->
           (failwith "antiquot" : 'questionidentcolon));
      [Gramext.Stoken ("QUESTIONANTIQUOTCOLON_LOC", "")],
      Gramext.action
        (fun (a : string) (loc : Ploc.t) ->
           (failwith "antiquot" : 'questionidentcolon));
    ...
    None,
    [None, None,
     [[Gramext.Stoken ("ANTIQUOT_LOC", "_to")],
      Gramext.action
        (fun (s : string) (loc : Ploc.t) ->
