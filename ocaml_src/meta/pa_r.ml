...
Grammar.safe_extend
  (let _ = (sig_item : 'sig_item Grammar.Entry.e)
   ...
   in
   [Grammar.extension (located_rawstring : 'located_rawstring Grammar.Entry.e)
      None
      [None, None,
       [Grammar.production
          (Grammar.r_next Grammar.r_stop (Grammar.s_token ("RAWSTRING", "")),
           ...
           (fun (s : string) (loc : Ploc.t) ->
              (let (delimsize, s) =
               ...
               loc, s :
               'located_rawstring)))]];
    Grammar.extension (located_string : 'located_string Grammar.Entry.e) None
      [None, None,
       [Grammar.production
       ...
       [Grammar.production
          (Grammar.r_next
           ...
           (fun (item_attrs : 'item_attributes) (ec : 'extension_constructor)
                (ext : 'ext_opt) (loc : Ploc.t) ->
              (str_item_to_inline (MLast.StExc (loc, ec, item_attrs)) ext :
               'str_item_exception)))]];
          ...
          (Grammar.r_next
           ...
           (fun (l : 'mod_binding list) (r : bool)
              ...
              (let l =
               ...
               'str_item_module)))]];
    Grammar.extension (str_item_open : 'str_item_open Grammar.Entry.e) None
      [None, None,
       [Grammar.production
          (Grammar.r_next
             (Grammar.r_next
           ...
           (fun (attrs : 'item_attributes) (me : 'module_expr)
                (ext, attrs1 : 'ext_attributes) (ovf : bool) (loc : Ploc.t) ->
              (let attrs =
              ...
              (let l =
                 match l, attrs0 with
                   h :: t, _ :: _ ->
                     ...
                     let attrs =
                       merge_left_auxiliary_attrs ~nonterm_name:"expr-let-rec"
                         ~left_name:"algebraic attributes"
        ...
        Grammar.production
          (Grammar.r_next
           ...
           (fun (p : 'patt) (ext, attrs : 'ext_attributes) _ (loc : Ploc.t) ->
              (patt_to_inline (MLast.PaExc (loc, p)) ext attrs : 'patt)))];
       None, Some Gramext.NonA,
       [Grammar.production
          (Grammar.r_next
             (Grammar.r_next (Grammar.r_next Grammar.r_stop Grammar.s_self)
             ...
             (Grammar.s_rules
                [Grammar.production
                 ...
                 Grammar.production
                   (Grammar.r_next Grammar.r_stop
                      (Grammar.s_token ("", "..")),
                    "194fe98d", (fun _ (loc : Ploc.t) -> (false : 'e__12)))]),
           "194fe98d",
             ...
             (Grammar.s_rules
                [Grammar.production
                 ...
                 Grammar.production
                   (Grammar.r_next Grammar.r_stop
                      (Grammar.s_token ("", "..")),
                    "194fe98d", (fun _ (loc : Ploc.t) -> (false : 'e__13)))]),
           "194fe98d",
       ...
       [Grammar.production
          (Grammar.r_next
                         ...
                         (Grammar.s_rules
                            [Grammar.production
                               (Grammar.r_next Grammar.r_stop
                                  (Grammar.s_token ("", ":=")),
                                "194fe98d",
                                (fun _ (loc : Ploc.t) -> (false : 'e__14)));
                             Grammar.production
                               (Grammar.r_next Grammar.r_stop
                                  (Grammar.s_token ("", "=")),
                                "194fe98d",
                                (fun _ (loc : Ploc.t) -> (true : 'e__14)))]))
                      (Grammar.s_flag (Grammar.s_token ("", "private"))))
                   (Grammar.s_nterm (ctyp : 'ctyp Grammar.Entry.e)))
                (Grammar.s_list0
                   (Grammar.s_nterm
           ...
           (fun (attrs : 'item_attributes) (cl : 'constrain list) (tk : 'ctyp)
                (pf : bool) (isDecl : 'e__14) (tpl : 'type_parameter list)
        ...
        Grammar.production
          (Grammar.r_next
           ...
           (fun (ce : 'class_fun_def) (p : 'ipatt)
              ...
              (class_expr_wrap_attrs (MLast.CeFun (loc, p, ce)) alg_attrs :
               'class_expr)))];
       Some "alg_attribute", Some Gramext.LeftA,
       [Grammar.production
          (Grammar.r_next
       ...
       [Grammar.production
        ...
        Grammar.production
          (Grammar.r_next
             ...
             (Grammar.s_token ("", "}")),
           "194fe98d",
           (fun _ (eo : 'e__21 option) (p : 'patt_tcon) _ _ (loc : Ploc.t) ->
       ...
       [Grammar.production
        ...
        Grammar.production
          (Grammar.r_next
             ...
             (Grammar.s_token ("", "}")),
           "194fe98d",
           (fun _ (eo : 'e__23 option) (p : 'ipatt_tcon) _ _ (loc : Ploc.t) ->
                ...
                (Grammar.s_rules
                   [Grammar.production
                      (Grammar.r_next
                         ...
                         (Grammar.s_nterm (patt : 'patt Grammar.Entry.e)),
                       "194fe98d",
                       (fun (p : 'patt) _ (loc : Ploc.t) -> (p : 'e__24)))])),
           "194fe98d",
