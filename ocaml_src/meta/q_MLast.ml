        ...
        Grammar.production
          (Grammar.r_next
             (Grammar.r_next
                ...
                (Grammar.s_token ("", ")")))
             Grammar.s_self,
           (fun (mt : 'module_declaration) _ (t : 'module_type) _ (i : 'e__46)
                _ (loc : Ploc.t) ->
              (Qast.Node
                 ("MtFun",
                  [Qast.Loc;
        ...
        Grammar.production
          (Grammar.r_next
             (Grammar.r_next
                ...
                (Grammar.s_token ("", ":=")))
             (Grammar.s_nterm (ctyp : 'ctyp Grammar.Entry.e)),
           (fun (t : 'ctyp) _ (tpl : 'e__51) (i : 'e__50) _ (loc : Ploc.t) ->
                   ...
                   (Grammar.s_rules
                      [Grammar.production
                         (Grammar.r_next Grammar.r_stop
                          ...
                          (fun (a : bool) (loc : Ploc.t) ->
                             (Qast.VaVal (Qast.Bool a) : 'e__49)));
                       Grammar.production
                         (Grammar.r_next Grammar.r_stop
                            (Grammar.s_token ("ANTIQUOT", "_opt")),
                          (fun (a : string) (loc : Ploc.t) ->
                             (Qast.VaAnt ("_opt", loc, a) : 'e__49)));
                       Grammar.production
                         (Grammar.r_next Grammar.r_stop
                            (Grammar.s_token ("ANTIQUOT", "opt")),
                          (fun (a : string) (loc : Ploc.t) ->
                         ...
                         (Grammar.r_next Grammar.r_stop
                          ...
                          (fun (a : string) (loc : Ploc.t) ->
                             (Qast.VaVal (Qast.VaAnt ("flag", loc, a)) :
                              'e__49)))])))
             (Grammar.s_nterm (ctyp : 'ctyp Grammar.Entry.e)),
           (fun (t : 'ctyp) (pf : 'e__49) _ (tpl : 'e__48) (i : 'e__47) _
                (loc : Ploc.t) ->
      ...
      [Some "top", Some Gramext.RightA,
                         ...
                         (Grammar.r_next Grammar.r_stop
                          ...
                          (fun (a : string) (loc : Ploc.t) ->
                             (Qast.VaVal (Qast.VaAnt ("list", loc, a)) :
                              'e__62)))])))
             (Grammar.s_token ("", "}")),
           (fun _ (seq : 'e__62) _ _ (e : 'expr) _ (loc : Ploc.t) ->
                         ...
                         (Grammar.r_next Grammar.r_stop
                          ...
                          (fun (a : string) (loc : Ploc.t) ->
                             (Qast.VaVal (Qast.VaAnt ("list", loc, a)) :
                              'e__61)))])))
             (Grammar.s_token ("", "}")),
           (fun _ (seq : 'e__61) _ _ (e2 : 'expr) (df : 'e__60) (e1 : 'expr) _
                         ...
                         (Grammar.r_next Grammar.r_stop
                          ...
                          (fun (a : string) (loc : Ploc.t) ->
                             (Qast.VaVal (Qast.VaAnt ("list", loc, a)) :
                              'e__58)))])))
             (Grammar.s_token ("", "}")),
           (fun _ (seq : 'e__58) _ _ (loc : Ploc.t) ->
        ...
        Grammar.production
          (Grammar.r_next
             (Grammar.r_next
                ...
                (Grammar.s_token ("", "in")))
             Grammar.s_self,
           (fun (e : 'expr) _ (mb : 'mod_fun_binding) (m : 'e__57) _ _
                (loc : Ploc.t) ->
        ...
        Grammar.production
          (Grammar.r_next
             (Grammar.r_next
                            ...
                            [Grammar.production
                               (Grammar.r_next Grammar.r_stop
                                  (Grammar.s_flag
                                     (Grammar.s_token ("", "rec"))),
                                (fun (a : bool) (loc : Ploc.t) ->
                                   (Qast.VaVal (Qast.Bool a) : 'e__55)));
                             Grammar.production
                               (Grammar.r_next Grammar.r_stop
                                  (Grammar.s_token ("ANTIQUOT", "_opt")),
                                (fun (a : string) (loc : Ploc.t) ->
                                   (Qast.VaAnt ("_opt", loc, a) : 'e__55)));
                             Grammar.production
                               (Grammar.r_next Grammar.r_stop
                                  (Grammar.s_token ("ANTIQUOT", "opt")),
                                (fun (a : string) (loc : Ploc.t) ->
                ...
                (Grammar.s_token ("", "in")))
             Grammar.s_self,
           (fun (x : 'expr) _ (l : 'e__56) (r : 'e__55) _ (loc : Ploc.t) ->
       ...
       [Grammar.production
          (Grammar.r_next
           ...
           (fun (lb : 'let_binding) (rf : 'e__63) _ (e : 'expr)
                (loc : Ploc.t) ->
              (Qast.Node
                         ...
                         (Grammar.r_next Grammar.r_stop
                          ...
                          (fun (a : string) (loc : Ploc.t) ->
                             (Qast.VaVal (Qast.VaAnt ("list", loc, a)) :
                              'e__64)))])))
             (Grammar.s_token ("", "}")),
           (fun _ (el : 'e__64) _ _ (e : 'expr) (loc : Ploc.t) ->
                         ...
                         (Grammar.r_next Grammar.r_stop
                          ...
                          (fun (a : string) (loc : Ploc.t) ->
                             (Qast.VaVal (Qast.VaAnt ("list", loc, a)) :
                              'e__77)))])))
             (Grammar.s_token ("", "}")),
           (fun _ (lel : 'e__77) _ _ (e : 'expr) _ _ (loc : Ploc.t) ->
                   ...
                   [Grammar.production
                    ...
                    Grammar.production
                      (Grammar.r_next Grammar.r_stop
                       ...
                       (fun (a : string) (loc : Ploc.t) ->
                          (Qast.VaAnt ("_nativeint", loc, a) : 'e__68)));
                    Grammar.production
                      (Grammar.r_next Grammar.r_stop
        ...
        Grammar.production
          (Grammar.r_next
             (Grammar.r_next
                ...
                (Grammar.s_token ("", "in")))
             Grammar.s_self,
           (fun (el : 'sequence) _ (mb : 'mod_fun_binding) (m : 'e__83) _ _
                (loc : Ploc.t) ->
              (Qast.List
                 [Qast.Node
        ...
        Grammar.production
          (Grammar.r_next
             (Grammar.r_next
                ...
                (Grammar.s_token ("", "in")))
             Grammar.s_self,
           (fun (el : 'sequence) _ (l : 'e__82) (rf : 'e__81) _
                (loc : Ploc.t) ->
              (Qast.List
                 [Qast.Node
       ...
       [Grammar.production
          (Grammar.r_next
             (Grammar.r_next
                         ...
                         [Grammar.production
                            (Grammar.r_next Grammar.r_stop
                             ...
                             (fun (a : 'when_expr option) (loc : Ploc.t) ->
                                (Qast.VaVal (Qast.Option a) : 'e__84)));
                          Grammar.production
                            (Grammar.r_next Grammar.r_stop
                               (Grammar.s_token ("ANTIQUOT", "_opt")),
                             (fun (a : string) (loc : Ploc.t) ->
                ...
                (Grammar.s_token ("", "->")))
             (Grammar.s_nterm (expr : 'expr Grammar.Entry.e)),
           (fun (e : 'expr) _ (w : 'e__84) (aso : 'as_patt_opt) (p : 'patt)
                (loc : Ploc.t) ->
                   ...
                   [Grammar.production
                    ...
                    Grammar.production
                      (Grammar.r_next Grammar.r_stop
                         (Grammar.s_token ("ANTIQUOT", "_nativeint")),
                       (fun (a : string) (loc : Ploc.t) ->
                          (Qast.VaAnt ("_nativeint", loc, a) : 'e__91)));
                    Grammar.production
                      (Grammar.r_next Grammar.r_stop
                         (Grammar.s_token ("ANTIQUOT", "nativeint")),
                       (fun (a : string) (loc : Ploc.t) ->
                   ...
                   [Grammar.production
                    ...
                    Grammar.production
                      (Grammar.r_next Grammar.r_stop
                         (Grammar.s_token ("ANTIQUOT", "")),
                       (fun (a : string) (loc : Ploc.t) ->
                          (Qast.VaVal (Qast.VaAnt ("", loc, a)) : 'e__85)));
                    Grammar.production
                      (Grammar.r_next Grammar.r_stop
                         (Grammar.s_token ("ANTIQUOT", "_lid")),
                       (fun (a : string) (loc : Ploc.t) ->
                          (Qast.VaAnt ("_lid", loc, a) : 'e__85)));
                    Grammar.production
                      (Grammar.r_next Grammar.r_stop
                         (Grammar.s_token ("ANTIQUOT", "lid")),
                       (fun (a : string) (loc : Ploc.t) ->
        ...
        Grammar.production
          (Grammar.r_next
             (Grammar.r_next
                ...
                (Grammar.s_token ("", ":")))
             (Grammar.s_nterm (module_type : 'module_type Grammar.Entry.e)),
           (fun (mt : 'module_type) _ (s : 'e__99) _ (loc : Ploc.t) ->
        ...
        Grammar.production
          (Grammar.r_next
             (Grammar.r_next
                ...
                (Grammar.s_token ("", ":")))
             (Grammar.s_nterm (module_type : 'module_type Grammar.Entry.e)),
           (fun (mt : 'module_type) _ (s : 'e__108) _ (loc : Ploc.t) ->
              (Qast.Node ("PaUnp", [Qast.Loc; s; Qast.Option (Some mt)]) :
               'paren_ipatt)));
        Grammar.production
          (Grammar.r_next
                    ...
                    Grammar.production
                      (Grammar.r_next Grammar.r_stop
                       ...
                       (fun (a : string) (loc : Ploc.t) ->
                          (Qast.VaVal (Qast.VaAnt ("list", loc, a)) :
                           'e__113)))])),
           (fun (cl : 'e__113) (tk : 'ctyp) (pf : 'e__112) _ (tpl : 'e__111)
                (n : 'e__110) (loc : Ploc.t) ->
              (Qast.Record
                         ...
                         (Grammar.r_next Grammar.r_stop
                          ...
                          (fun (a : string) (loc : Ploc.t) ->
                             (Qast.VaVal (Qast.VaAnt ("priv", loc, a)) :
                              'e__118)))])))
             Grammar.s_self,
           (fun (t2 : 'ctyp) (pf : 'e__118) _ (t1 : 'ctyp) (loc : Ploc.t) ->
        ...
        Grammar.production
          (Grammar.r_next
             (Grammar.r_next
                ...
                (Grammar.s_token ("", ":")))
             (Grammar.s_nterm (ctyp : 'ctyp Grammar.Entry.e)),
           (fun (t : 'ctyp) _ (ci : 'e__129) (loc : Ploc.t) ->
                    ...
                    Grammar.production
                      (Grammar.r_next Grammar.r_stop
                       ...
                       (fun (a : string) (loc : Ploc.t) ->
                          (Qast.VaVal (Qast.VaAnt ("list", loc, a)) :
                           'e__128)))])),
           (fun (cal : 'e__128) _ (ci : 'e__127) (loc : Ploc.t) ->
                         ...
                         (Grammar.s_rules
                            [Grammar.production
                               (Grammar.r_next Grammar.r_stop
                                ...
                                (fun (a : bool) (loc : Ploc.t) ->
                                   (Qast.VaVal (Qast.Bool a) : 'e__135)));
                             Grammar.production
                               (Grammar.r_next Grammar.r_stop
                                  (Grammar.s_token ("ANTIQUOT", "_opt")),
                                (fun (a : string) (loc : Ploc.t) ->
                                   (Qast.VaAnt ("_opt", loc, a) : 'e__135)));
                             Grammar.production
                               (Grammar.r_next Grammar.r_stop
                                  (Grammar.s_token ("ANTIQUOT", "opt")),
                                (fun (a : string) (loc : Ploc.t) ->
       ...
       [Grammar.production
          (Grammar.r_next
             (Grammar.r_next
                ...
                (Grammar.s_token ("", "in")))
             Grammar.s_self,
           (fun (ce : 'class_expr) _ (lb : 'e__139) (rf : 'e__138) _
                (loc : Ploc.t) ->
       ...
       [Grammar.production
                    ...
                    Grammar.production
                      (Grammar.r_next Grammar.r_stop
                       ...
                       (fun (a : string) (loc : Ploc.t) ->
                          (Qast.VaVal (Qast.VaAnt ("list", loc, a)) :
                           'e__143)))])),
           (fun (ci : 'e__143) _ (ctcl : 'e__142) _ (loc : Ploc.t) ->
        ...
        Grammar.production
          (Grammar.r_next
                         ...
                         [Grammar.production
                            (Grammar.r_next Grammar.r_stop
                             ...
                             (fun (a : 'class_self_patt option)
                                  (loc : Ploc.t) ->
                                (Qast.VaVal (Qast.Option a) : 'e__141)));
                          Grammar.production
                            (Grammar.r_next Grammar.r_stop
                               (Grammar.s_token ("ANTIQUOT", "_opt")),
                             (fun (a : string) (loc : Ploc.t) ->
             ...
             (Grammar.s_token ("", "end")),
           (fun _ (cf : 'class_structure) (cspo : 'e__141) _ (loc : Ploc.t) ->
                    ...
                    Grammar.production
                      (Grammar.r_next Grammar.r_stop
                       ...
                       (fun (a : string) (loc : Ploc.t) ->
                          (Qast.VaVal (Qast.VaAnt ("list", loc, a)) :
                           'e__145)))])),
           (fun (cf : 'e__145) (loc : Ploc.t) -> (cf : 'class_structure)))]];
       ...
       [Grammar.production
                         ...
                         (Grammar.r_next Grammar.r_stop
                          ...
                          (fun (a : string) (loc : Ploc.t) ->
                             (Qast.VaVal (Qast.VaAnt ("opt", loc, a)) :
                              'e__159)))])))
             (Grammar.s_nterm (fun_binding : 'fun_binding Grammar.Entry.e)),
           (fun (e : 'fun_binding) (topt : 'e__159) (l : 'e__158)
                (pf : 'e__157) (ovf : 'e__156) _ (loc : Ploc.t) ->
        ...
        Grammar.production
          (Grammar.r_next
             (Grammar.r_next
                ...
                (Grammar.s_token ("", ":")))
             (Grammar.s_nterm (ctyp : 'ctyp Grammar.Entry.e)),
           (fun (t : 'ctyp) _ (l : 'e__155) (pf : 'e__154) _ _
                (loc : Ploc.t) ->
        ...
        Grammar.production
          (Grammar.r_next
             (Grammar.r_next
                ...
                (Grammar.s_token ("", ":")))
             (Grammar.s_nterm (ctyp : 'ctyp Grammar.Entry.e)),
           (fun (t : 'ctyp) _ (lab : 'e__153) (mf : 'e__152) _ _
                (loc : Ploc.t) ->
        ...
        Grammar.production
          (Grammar.r_next
           ...
           (fun (e : 'cvalue_binding) (lab : 'e__151) (mf : 'e__150)
                (ovf : 'e__149) _ (loc : Ploc.t) ->
                   ...
                   [Grammar.production
                      (Grammar.r_next Grammar.r_stop
                       ...
                       (fun (a : 'as_lident option) (loc : Ploc.t) ->
                          (Qast.VaVal (Qast.Option a) : 'e__148)));
                    Grammar.production
                      (Grammar.r_next Grammar.r_stop
                         (Grammar.s_token ("ANTIQUOT", "_opt")),
                       (fun (a : string) (loc : Ploc.t) ->
                    ...
                    Grammar.production
                      (Grammar.r_next Grammar.r_stop
                       ...
                       (fun (a : string) (loc : Ploc.t) ->
                          (Qast.VaVal (Qast.VaAnt ("opt", loc, a)) :
                           'e__148)))])),
           (fun (pb : 'e__148) (ce : 'class_expr) _ (loc : Ploc.t) ->
                         ...
                         (Grammar.r_next Grammar.r_stop
                          ...
                          (fun (a : string) (loc : Ploc.t) ->
                             (Qast.VaVal (Qast.VaAnt ("list", loc, a)) :
                              'e__163)))])))
             (Grammar.s_token ("", "]")),
           (fun _ (tl : 'e__163) _ (ct : 'class_type) (loc : Ploc.t) ->
                         ...
                         (Grammar.r_next Grammar.r_stop
                          ...
                          (fun (a : string) (loc : Ploc.t) ->
                             (Qast.VaVal (Qast.VaAnt ("list", loc, a)) :
                              'e__162)))])))
             (Grammar.s_token ("", "end")),
           (fun _ (csf : 'e__162) (cst : 'e__160) _ (loc : Ploc.t) ->
        ...
        Grammar.production
          (Grammar.r_next
             (Grammar.r_next
                ...
                (Grammar.s_token ("", ":")))
             (Grammar.s_nterm (ctyp : 'ctyp Grammar.Entry.e)),
           (fun (t : 'ctyp) _ (l : 'e__173) (pf : 'e__172) _ (loc : Ploc.t) ->
        ...
        Grammar.production
          (Grammar.r_next
             (Grammar.r_next
                ...
                (Grammar.s_token ("", ":")))
             (Grammar.s_nterm (ctyp : 'ctyp Grammar.Entry.e)),
           (fun (t : 'ctyp) _ (l : 'e__171) (pf : 'e__170) _ _
                (loc : Ploc.t) ->
        ...
        Grammar.production
          (Grammar.r_next
             (Grammar.r_next
                ...
                (Grammar.s_token ("", ":")))
             (Grammar.s_nterm (ctyp : 'ctyp Grammar.Entry.e)),
           (fun (t : 'ctyp) _ (l : 'e__169) (mf : 'e__168) _ (loc : Ploc.t) ->
                    ...
                    Grammar.production
                      (Grammar.r_next Grammar.r_stop
                       ...
                       (fun (a : string) (loc : Ploc.t) ->
                          (Qast.VaVal (Qast.VaAnt ("lid", loc, a)) :
                           'e__180)))])),
           (fun (lab : 'e__180) _ (e : 'expr) (loc : Ploc.t) ->
                         ...
                         (Grammar.r_next Grammar.r_stop
                          ...
                          (fun (a : string) (loc : Ploc.t) ->
                             (Qast.VaVal (Qast.VaAnt ("flag", loc, a)) :
                              'e__184)))])))
             (Grammar.s_token ("", ">")),
           (fun _ (v : 'e__184) (ml : 'e__183) _ (loc : Ploc.t) ->
                   ...
                   (Grammar.s_rules
                      [Grammar.production
                         (Grammar.r_next Grammar.r_stop
                          ...
                          (fun (a : 'a_qic) (loc : Ploc.t) -> (a : 'e__186)));
                       Grammar.production
                         (Grammar.r_next Grammar.r_stop
                   ...
                   (Grammar.s_rules
                      [Grammar.production
                         (Grammar.r_next Grammar.r_stop
                          ...
                          (fun (a : 'a_tic) (loc : Ploc.t) -> (a : 'e__185)));
                       Grammar.production
                         (Grammar.r_next Grammar.r_stop
                         ...
                         (Grammar.r_next Grammar.r_stop
                          ...
                          (fun (a : string) (loc : Ploc.t) ->
                             (Qast.VaVal (Qast.VaAnt ("list", loc, a)) :
                              'e__187)))])))
             (Grammar.s_token ("", "]")),
           (fun _ (ntl : 'e__187) _ (rfl : 'poly_variant_list) _ _
                (loc : Ploc.t) ->
              (Qast.Node
                 ("TyVrn",
                  [Qast.Loc; rfl;
                    ...
                    Grammar.production
                      (Grammar.r_next Grammar.r_stop
                       ...
                       (fun (a : string) (loc : Ploc.t) ->
                          (Qast.VaVal (Qast.VaAnt ("list", loc, a)) :
                           'e__192)))])),
           (fun (l : 'e__192) (ao : 'e__191) _ (i : 'e__190) _
                (loc : Ploc.t) ->
                ...
                (Grammar.s_rules
                   [Grammar.production
                      (Grammar.r_next Grammar.r_stop
                       ...
                       (fun (a : 'a_ti) (loc : Ploc.t) -> (a : 'e__199)));
                    Grammar.production
                      (Grammar.r_next Grammar.r_stop
                   ...
                   (Grammar.s_rules
                      [Grammar.production
                         (Grammar.r_next Grammar.r_stop
                            (Grammar.s_nterm
                               (a_tic : 'a_tic Grammar.Entry.e)),
                          (fun (a : 'a_tic) (loc : Ploc.t) -> (a : 'e__198)));
                       Grammar.production
                         (Grammar.r_next Grammar.r_stop
                            (Grammar.s_token ("TILDEIDENTCOLON", "")),
                          (fun (a : string) (loc : Ploc.t) ->
                         ...
                         (Grammar.r_next Grammar.r_stop
                          ...
                          (fun (a : string) (loc : Ploc.t) ->
                             (Qast.VaVal (Qast.VaAnt ("~:", loc, a)) :
                              'e__198)))])))
             Grammar.s_self,
           (fun (p : 'patt) (i : 'e__198) (loc : Ploc.t) ->
              (let _ = warning_deprecated_since_6_00 loc in
               Qast.Node
                 ("PaLab",
                  [Qast.Loc;
                         ...
                         (Grammar.r_next Grammar.r_stop
                          ...
                          (fun (a : string) (loc : Ploc.t) ->
                             (Qast.VaVal (Qast.VaAnt ("opt", loc, a)) :
                              'e__197)))])))
             (Grammar.s_token ("", "}")),
           (fun _ (eo : 'e__197) (p : 'patt_tcon) _ _ (loc : Ploc.t) ->
                         ...
                         (Grammar.r_next Grammar.r_stop
                          ...
                          (fun (a : string) (loc : Ploc.t) ->
                             (Qast.VaVal (Qast.VaAnt ("list", loc, a)) :
                              'e__195)))])))
             (Grammar.s_token ("", "}")),
           (fun _ (lppo : 'e__195) _ _ (loc : Ploc.t) ->
                            ...
                            (Grammar.s_rules
                               [Grammar.production
                                  (Grammar.r_next
                                   ...
                                   (fun (p : 'patt) _ (loc : Ploc.t) ->
                                      (p : 'e__200)))])),
                       (fun (a : 'e__200 option) (loc : Ploc.t) ->
                    ...
                    Grammar.production
                      (Grammar.r_next Grammar.r_stop
                       ...
                       (fun (a : string) (loc : Ploc.t) ->
                          (Qast.VaVal (Qast.VaAnt ("opt", loc, a)) :
                           'e__201)))])),
           (fun (po : 'e__201) (p : 'patt_tcon) (loc : Ploc.t) ->
             ...
             (Grammar.s_facto
                (Grammar.s_rules
                   [Grammar.production
                      (Grammar.r_next Grammar.r_stop
                         (Grammar.s_nterm (a_ti : 'a_ti Grammar.Entry.e)),
                       (fun (a : 'a_ti) (loc : Ploc.t) -> (a : 'e__206)));
                    Grammar.production
                      (Grammar.r_next Grammar.r_stop
                         (Grammar.s_token ("TILDEIDENT", "")),
                       (fun (a : string) (loc : Ploc.t) ->
                   ...
                   (Grammar.s_rules
                      [Grammar.production
                         (Grammar.r_next Grammar.r_stop
                            (Grammar.s_nterm
                               (a_tic : 'a_tic Grammar.Entry.e)),
                          (fun (a : 'a_tic) (loc : Ploc.t) -> (a : 'e__205)));
                       Grammar.production
                         (Grammar.r_next Grammar.r_stop
                            (Grammar.s_token ("TILDEIDENTCOLON", "")),
                          (fun (a : string) (loc : Ploc.t) ->
                         ...
                         (Grammar.r_next Grammar.r_stop
                          ...
                          (fun (a : string) (loc : Ploc.t) ->
                             (Qast.VaVal (Qast.VaAnt ("~:", loc, a)) :
                              'e__205)))])))
             Grammar.s_self,
           (fun (p : 'ipatt) (i : 'e__205) (loc : Ploc.t) ->
              (let _ = warning_deprecated_since_6_00 loc in
               Qast.Node
                 ("PaLab",
                  [Qast.Loc;
                         ...
                         (Grammar.r_next Grammar.r_stop
                          ...
                          (fun (a : string) (loc : Ploc.t) ->
                             (Qast.VaVal (Qast.VaAnt ("opt", loc, a)) :
                              'e__204)))])))
             (Grammar.s_token ("", "}")),
           (fun _ (eo : 'e__204) (p : 'ipatt_tcon) _ _ (loc : Ploc.t) ->
                         ...
                         (Grammar.r_next Grammar.r_stop
                          ...
                          (fun (a : string) (loc : Ploc.t) ->
                             (Qast.VaVal (Qast.VaAnt ("list", loc, a)) :
                              'e__202)))])))
             (Grammar.s_token ("", "}")),
           (fun _ (lppo : 'e__202) _ _ (loc : Ploc.t) ->
                            ...
                            (Grammar.s_rules
                               [Grammar.production
                                  (Grammar.r_next
                                   ...
                                   (fun (p : 'patt) _ (loc : Ploc.t) ->
                                      (p : 'e__207)))])),
                       (fun (a : 'e__207 option) (loc : Ploc.t) ->
                    ...
                    Grammar.production
                      (Grammar.r_next Grammar.r_stop
                       ...
                       (fun (a : string) (loc : Ploc.t) ->
                          (Qast.VaVal (Qast.VaAnt ("opt", loc, a)) :
                           'e__208)))])),
           (fun (po : 'e__208) (p : 'ipatt_tcon) (loc : Ploc.t) ->
        ...
        Grammar.production
          (Grammar.r_next
             (Grammar.r_next
                ...
                (Grammar.s_nterm (expr : 'expr Grammar.Entry.e)))
             (Grammar.s_token ("", ")")),
           (fun _ (e : 'expr) _ (i : 'e__220) _ _ (loc : Ploc.t) ->
              (Qast.Node
                 ("PaOlb",
                  [Qast.Loc; Qast.Node ("PaLid", [Qast.Loc; i]);
        ...
        Grammar.production
          (Grammar.r_next
             (Grammar.r_next
                ...
                (Grammar.s_nterm (ctyp : 'ctyp Grammar.Entry.e)))
             (Grammar.s_token ("", ")")),
           (fun _ (t : 'ctyp) _ (i : 'e__219) _ _ (loc : Ploc.t) ->
              (Qast.Node
                 ("PaOlb",
                  [Qast.Loc;
                   Qast.Node
        ...
        Grammar.production
          (Grammar.r_next
             (Grammar.r_next
                ...
                (Grammar.s_nterm (expr : 'expr Grammar.Entry.e)))
             (Grammar.s_token ("", ")")),
           (fun _ (e : 'expr) _ (t : 'ctyp) _ (i : 'e__218) _ _
                (loc : Ploc.t) ->
              (Qast.Node
                 ("PaOlb",
                  [Qast.Loc;
                ...
                (Grammar.s_rules
                   [Grammar.production
                      (Grammar.r_next Grammar.r_stop
                       ...
                       (fun (a : 'a_qi) (loc : Ploc.t) -> (a : 'e__217)));
                    Grammar.production
                      (Grammar.r_next Grammar.r_stop
                         ...
                         (Grammar.r_next Grammar.r_stop
                          ...
                          (fun (a : string) (loc : Ploc.t) ->
                             (Qast.VaVal (Qast.VaAnt ("lid", loc, a)) :
                              'e__216)))])))
             (Grammar.s_token ("", ")")),
           (fun _ (j : 'e__216) _ (i : 'e__215) (loc : Ploc.t) ->
              (Qast.Node
                 ("PaOlb",
                  [Qast.Loc; Qast.Node ("PaLid", [Qast.Loc; i]);
                   Qast.VaVal
        ...
        Grammar.production
          (Grammar.r_next
             (Grammar.r_next
                ...
                (Grammar.s_nterm (expr : 'expr Grammar.Entry.e)))
             (Grammar.s_token ("", ")")),
           (fun _ (e : 'expr) _ (j : 'e__214) _ (i : 'e__213)
                (loc : Ploc.t) ->
              (Qast.Node
                 ("PaOlb",
                  [Qast.Loc; Qast.Node ("PaLid", [Qast.Loc; i]);
        ...
        Grammar.production
          (Grammar.r_next
             (Grammar.r_next
                ...
                (Grammar.s_nterm (ctyp : 'ctyp Grammar.Entry.e)))
             (Grammar.s_token ("", ")")),
           (fun _ (t : 'ctyp) _ (j : 'e__212) _ (i : 'e__211)
                (loc : Ploc.t) ->
              (Qast.Node
                 ("PaOlb",
                  [Qast.Loc;
        ...
        Grammar.production
          (Grammar.r_next
             (Grammar.r_next
                ...
                (Grammar.s_nterm (expr : 'expr Grammar.Entry.e)))
             (Grammar.s_token ("", ")")),
           (fun _ (e : 'expr) _ (t : 'ctyp) _ (j : 'e__210) _ (i : 'e__209)
                (loc : Ploc.t) ->
              (Qast.Node
                 ("PaOlb",
                  [Qast.Loc;
             ...
             (Grammar.s_facto
                (Grammar.s_rules
                   [Grammar.production
                      (Grammar.r_next Grammar.r_stop
                         (Grammar.s_nterm (a_qi : 'a_qi Grammar.Entry.e)),
                       (fun (a : 'a_qi) (loc : Ploc.t) -> (a : 'e__227)));
                    Grammar.production
                      (Grammar.r_next Grammar.r_stop
                         (Grammar.s_token ("QUESTIONIDENT", "")),
                       (fun (a : string) (loc : Ploc.t) ->
             ...
             (Grammar.s_facto
                (Grammar.s_rules
                   [Grammar.production
                      (Grammar.r_next Grammar.r_stop
                         (Grammar.s_nterm (a_ti : 'a_ti Grammar.Entry.e)),
                       (fun (a : 'a_ti) (loc : Ploc.t) -> (a : 'e__225)));
                    Grammar.production
                      (Grammar.r_next Grammar.r_stop
                         (Grammar.s_token ("TILDEIDENT", "")),
                       (fun (a : string) (loc : Ploc.t) ->
                         ...
                         (Grammar.r_next Grammar.r_stop
                          ...
                          (fun (a : string) (loc : Ploc.t) ->
                             (Qast.VaVal (Qast.VaAnt ("~:", loc, a)) :
                              'e__224)))])))
             Grammar.s_self,
           (fun (e : 'expr) (i : 'e__224) (loc : Ploc.t) ->
              (let _ = warning_deprecated_since_6_00 loc in
               Qast.Node
                 ("ExLab",
                  [Qast.Loc;
                         ...
                         (Grammar.r_next Grammar.r_stop
                          ...
                          (fun (a : string) (loc : Ploc.t) ->
                             (Qast.VaVal (Qast.VaAnt ("opt", loc, a)) :
                              'e__223)))])))
             (Grammar.s_token ("", "}")),
           (fun _ (eo : 'e__223) (p : 'ipatt_tcon) _ _ (loc : Ploc.t) ->
                         ...
                         (Grammar.r_next Grammar.r_stop
                          ...
                          (fun (a : string) (loc : Ploc.t) ->
                             (Qast.VaVal (Qast.VaAnt ("list", loc, a)) :
                              'e__222)))])))
             (Grammar.s_token ("", "}")),
           (fun _ (lpeo : 'e__222) _ _ (loc : Ploc.t) ->
                    ...
                    Grammar.production
                      (Grammar.r_next Grammar.r_stop
                       ...
                       (fun (a : string) (loc : Ploc.t) ->
                          (Qast.VaVal (Qast.VaAnt ("opt", loc, a)) :
                           'e__228)))])),
           (fun (eo : 'e__228) (p : 'ipatt_tcon) (loc : Ploc.t) ->
      ...
      [None, None,
       [Grammar.production
          (Grammar.r_next
           ...
           (fun (e : 'expr) _ (jal : 'e__231) _ (loc : Ploc.t) ->
                      ...
                      (Grammar.r_next Grammar.r_stop
                       ...
                       (fun (a : string) (loc : Ploc.t) ->
                          (Qast.VaVal (Qast.VaAnt ("jid", loc, a)) :
                           'e__233)))])),
           (fun (ji : 'e__233) _ (eo : 'e__232) _ (loc : Ploc.t) ->
