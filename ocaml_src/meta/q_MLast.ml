   ...
   [Grammar.Entry.obj (module_expr : 'module_expr Grammar.Entry.e), None,
    ...
    [Some "top", None,
     ...
     [[Gramext.Stoken ("", "("); Gramext.Sself; Gramext.Stoken ("", ")")],
      ...
      Gramext.action
        (fun (ci : 'e__121) _ (ctcl : 'e__120) _ (loc : Ploc.t) ->
       ...
       Gramext.Sfacto
         (Gramext.srules
            [[Gramext.Sopt
             ...
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
                  (Qast.VaVal (Qast.VaAnt ("opt", loc, a)) : 'e__119))]);
       Gramext.Snterm
         (Grammar.Entry.obj
            (class_structure : 'class_structure Grammar.Entry.e));
       Gramext.Stoken ("", "end")],
      Gramext.action
        (fun _ (cf : 'class_structure) (cspo : 'e__119) _ (loc : Ploc.t) ->
       ...
       Gramext.Sfacto
         (Gramext.srules
            [[Gramext.Sflag (Gramext.Stoken ("", "private"))],
             ...
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
                  (Qast.VaVal (Qast.VaAnt ("priv", loc, a)) : 'e__132))]);
       Gramext.Sfacto
         (Gramext.srules
            [[Gramext.Snterm
    ...
    [Some "top", None,
     [[Gramext.Sself; Gramext.Stoken ("", "[");
       ...
       Gramext.Stoken ("", "]")],
      Gramext.action
        (fun _ (tl : 'e__138) _ (ct : 'class_type) (loc : Ploc.t) ->
      ...
      [Gramext.Stoken ("", "object");
            ...
            [[Gramext.Sopt
             ...
             Gramext.action
               (fun (a : 'class_self_type option) (loc : Ploc.t) ->
                  (Qast.VaVal (Qast.Option a) : 'e__135));
             [Gramext.Stoken ("ANTIQUOT", "_opt")],
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
       ...
       Gramext.Stoken ("", "end")],
      Gramext.action
        (fun _ (csf : 'e__137) (cst : 'e__135) _ (loc : Ploc.t) ->
     ...
     [[Gramext.Sfacto
         (Gramext.srules
            [[Gramext.Stoken ("UIDENT", "")],
             ...
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
                  (Qast.VaAnt ("_id", loc, a) : 'e__140));
             [Gramext.Stoken ("ANTIQUOT", "id")],
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
                  (Qast.VaVal (Qast.VaAnt ("id", loc, a)) : 'e__140))])],
      Gramext.action
      ...
      [Gramext.Sfacto
         (Gramext.srules
            [[Gramext.Stoken ("LIDENT", "")],
             ...
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
                  (Qast.VaAnt ("_id", loc, a) : 'e__139));
             [Gramext.Stoken ("ANTIQUOT", "id")],
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
                  (Qast.VaVal (Qast.VaAnt ("id", loc, a)) : 'e__139))])],
      Gramext.action
