   ...
   [Grammar.Entry.obj (module_expr : 'module_expr Grammar.Entry.e), None,
      ...
      Gramext.action
        (fun (ctl : 'constructor_declaration) _ (loc : Token.location) ->
           (let (_, c, tl) =
              ...
              | _ ->
                  match () with
                  _ -> raise (Match_failure ("q_MLast.ml", 368, 20))
            in
                ...
                [[Gramext.Snterm
                 ...
                 Gramext.action
                   (fun _ (cf : 'class_str_item) (loc : Token.location) ->
                      (cf : 'e__15))])],
          Gramext.action
            (fun (a : 'e__15 list) (loc : Token.location) ->
               (Qast.List a : 'a_list));
          [Gramext.Snterm
             (Grammar.Entry.obj (a_list : 'a_list Grammar.Entry.e))],
          Gramext.action
                ...
                [[Gramext.Stoken ("", "mutable")],
                 Gramext.action
                   (fun (x : string) (loc : Token.location) ->
                      (Qast.Str x : 'e__17))])],
          Gramext.action
            (fun (a : 'e__17 option) (loc : Token.location) ->
               (Qast.Option a : 'a_opt));
          [Gramext.Snterm
             (Grammar.Entry.obj (a_opt : 'a_opt Grammar.Entry.e))],
          Gramext.action
                ...
                [[Gramext.Snterm
                 ...
                 Gramext.action
                   (fun _ (csf : 'class_sig_item) (loc : Token.location) ->
                      (csf : 'e__20))])],
          Gramext.action
            (fun (a : 'e__20 list) (loc : Token.location) ->
               (Qast.List a : 'a_list));
          [Gramext.Snterm
             (Grammar.Entry.obj (a_list : 'a_list Grammar.Entry.e))],
          Gramext.action
                ...
                [[Gramext.Stoken ("", "mutable")],
                 Gramext.action
                   (fun (x : string) (loc : Token.location) ->
                      (Qast.Str x : 'e__22))])],
          Gramext.action
            (fun (a : 'e__22 option) (loc : Token.location) ->
               (Qast.Option a : 'a_opt));
          [Gramext.Snterm
             (Grammar.Entry.obj (a_opt : 'a_opt Grammar.Entry.e))],
          Gramext.action
    ...
    [None, None,
     [[Gramext.Stoken ("", "while"); Gramext.Sself; Gramext.Stoken ("", "do");
                ...
                [[Gramext.Snterm
                 ...
                 Gramext.action
                   (fun _ (e : 'expr) (loc : Token.location) ->
                      (e : 'e__31))])],
          Gramext.action
            (fun (a : 'e__31 list) (loc : Token.location) ->
               (Qast.List a : 'a_list));
          [Gramext.Snterm
             (Grammar.Entry.obj (a_list : 'a_list Grammar.Entry.e))],
          Gramext.action
       ...
       Gramext.Stoken ("", "done")],
      Gramext.action
        (fun _ _ (seq : 'a_list) _ (e : 'expr) _ (loc : Token.location) ->
           (Qast.Node ("ExWhi", [Qast.Loc; e; seq]) : 'expr));
      [Gramext.Stoken ("", "for");
       Gramext.Snterm
         (Grammar.Entry.obj (a_LIDENT : 'a_LIDENT Grammar.Entry.e));
                ...
                [[Gramext.Snterm
                 ...
                 Gramext.action
                   (fun _ (e : 'expr) (loc : Token.location) ->
                      (e : 'e__30))])],
          Gramext.action
            (fun (a : 'e__30 list) (loc : Token.location) ->
               (Qast.List a : 'a_list));
          [Gramext.Snterm
             (Grammar.Entry.obj (a_list : 'a_list Grammar.Entry.e))],
          Gramext.action
      ...
      [Gramext.Stoken ("", "do");
                ...
                [[Gramext.Snterm
                 ...
                 Gramext.action
                   (fun _ (e : 'expr) (loc : Token.location) ->
                      (e : 'e__29))])],
          Gramext.action
            (fun (a : 'e__29 list) (loc : Token.location) ->
               (Qast.List a : 'a_list));
          [Gramext.Snterm
             (Grammar.Entry.obj (a_list : 'a_list Grammar.Entry.e))],
          Gramext.action
       ...
       Gramext.Sself],
      Gramext.action
        (fun (e : 'expr) _ _ (seq : 'a_list) _ (loc : Token.location) ->
    ...
    [None, None,
     [[Gramext.Stoken ("", "object"); Gramext.Stoken ("ANTIQUOT", "");
                ...
                [[Gramext.Snterm
                 ...
                 Gramext.action
                   (fun _ (cf : 'class_str_item) (loc : Token.location) ->
                      (cf : 'e__32))])],
          Gramext.action
            (fun (a : 'e__32 list) (loc : Token.location) ->
               (Qast.List a : 'a_list));
          [Gramext.Snterm
             (Grammar.Entry.obj (a_list : 'a_list Grammar.Entry.e))],
          Gramext.action
       ...
       Gramext.Stoken ("", "end")],
      Gramext.action
        (fun _ (csl : 'a_list) _ (x : string) _ (loc : Token.location) ->
    ...
    [None, None,
     [[Gramext.Stoken ("", "object"); Gramext.Stoken ("ANTIQUOT", "");
                ...
                [[Gramext.Snterm
                 ...
                 Gramext.action
                   (fun _ (csf : 'class_sig_item) (loc : Token.location) ->
                      (csf : 'e__34))])],
          Gramext.action
            (fun (a : 'e__34 list) (loc : Token.location) ->
               (Qast.List a : 'a_list));
          [Gramext.Snterm
             (Grammar.Entry.obj (a_list : 'a_list Grammar.Entry.e))],
          Gramext.action
       ...
       Gramext.Stoken ("", "end")],
      Gramext.action
        (fun _ (csf : 'a_list) _ (x : string) _ (loc : Token.location) ->
           (let _ = warn_antiq loc "3.05" in
            Qast.Node
              ("CtSig",
               [Qast.Loc; Qast.Option None;
      ...
      [Gramext.Stoken ("", "object"); Gramext.Stoken ("ANTIQUOT", "");
                ...
                [[Gramext.Snterm
                 ...
                 Gramext.action
                   (fun _ (csf : 'class_sig_item) (loc : Token.location) ->
                      (csf : 'e__33))])],
          Gramext.action
            (fun (a : 'e__33 list) (loc : Token.location) ->
               (Qast.List a : 'a_list));
          [Gramext.Snterm
             (Grammar.Entry.obj (a_list : 'a_list Grammar.Entry.e))],
          Gramext.action
       ...
       Gramext.Stoken ("", "end")],
      Gramext.action
        (fun _ (csf : 'a_list) (x : string) _ (loc : Token.location) ->
           (let _ = warn_antiq loc "3.05" in
       ...
       Gramext.srules
         [[Gramext.Slist1sep
          ...
          Gramext.action
            (fun (a : 'a_list) (loc : Token.location) -> (a : 'a_list))]],
      Gramext.action
        (fun (l : 'a_list) (r : string) _ (loc : Token.location) ->
           (let _ = warn_antiq loc "3.06+18" in
    ...
    [None, None,
     [[Gramext.Stoken ("", "value"); Gramext.Stoken ("ANTIQUOT", "mut");
      ...
      Gramext.action
        (fun (pb : string) (ce : 'class_expr) _ (loc : Token.location) ->
           (let _ = warn_antiq loc "3.06+18" in
