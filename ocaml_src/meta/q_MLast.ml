       ...
       [Grammar.production
        ...
        Grammar.production
          (Grammar.r_next
           ...
           (fun (mt : 'mod_type_fun_binding) (i : 'e__13) _ _
                (loc : Ploc.t) ->
        ...
        Grammar.production
          (Grammar.r_next
             (Grammar.r_next
                ...
                (Grammar.s_token ("", ")")))
             Grammar.s_self,
           (fun (mb : 'mod_fun_binding) _ (mt : 'module_type) _ (m : 'e__26) _
                (loc : Ploc.t) ->
              (Qast.Node
                 ("MeFun",
                  [Qast.Loc;
                    ...
                    Grammar.production
                      (Grammar.r_next Grammar.r_stop
                       ...
                       (fun (a : string) (loc : Ploc.t) ->
                          (Qast.VaVal (Qast.VaAnt ("list", loc, a)) :
                           'e__28)))])),
           (fun (wcl : 'e__28) _ (mt : 'module_type) (loc : Ploc.t) ->
                    ...
                    Grammar.production
                      (Grammar.r_next Grammar.r_stop
                       ...
                       (fun (a : string) (loc : Ploc.t) ->
                          (Qast.VaVal (Qast.VaAnt ("list", loc, a)) :
                           'e__33)))])),
           (fun (st : 'e__33) (loc : Ploc.t) -> (st : 'signature)))]];
        ...
        Grammar.production
          (Grammar.r_next
             (Grammar.r_next
                ...
                (Grammar.s_token ("", ":")))
             (Grammar.s_nterm (ctyp : 'ctyp Grammar.Entry.e)),
           (fun (t : 'ctyp) _ (i : 'e__43) _ (loc : Ploc.t) ->
        ...
        Grammar.production
          (Grammar.r_next
             (Grammar.r_next
                ...
                (Grammar.s_token ("", "=")))
             (Grammar.s_nterm (module_type : 'module_type Grammar.Entry.e)),
           (fun (mt : 'module_type) _ (i : 'e__40) _ _ (loc : Ploc.t) ->
                    ...
                    Grammar.production
                      (Grammar.r_next Grammar.r_stop
                       ...
                       (fun (a : string) (loc : Ploc.t) ->
                          (Qast.VaVal (Qast.VaAnt ("list", loc, a)) :
                           'e__39)))])),
           (fun (l : 'e__39) (rf : 'e__38) _ (loc : Ploc.t) ->
                    ...
                    Grammar.production
                      (Grammar.r_next Grammar.r_stop
                       ...
                       (fun (a : string) (loc : Ploc.t) ->
                          (Qast.VaVal (Qast.VaAnt ("list", loc, a)) :
                           'e__37)))])),
           (fun (pd : 'e__37) _ (t : 'ctyp) _ (i : 'e__36) _ (loc : Ploc.t) ->
          ...
          (Grammar.r_next
           ...
           (fun (ctl : 'constructor_declaration) _ (loc : Ploc.t) ->
              (let (_, c, tl, _) =
                 match ctl with
                   Qast.Tuple [xx1; xx2; xx3; xx4] -> xx1, xx2, xx3, xx4
                 | _ -> raise (Match_failure ("q_MLast.ml", 399, 19))
               in
      ...
      [None, None,
       [Grammar.production
          (Grammar.r_next
           ...
           (fun (mt : 'module_declaration) (i : 'e__49) (loc : Ploc.t) ->
       ...
       [Grammar.production
          (Grammar.r_next
             (Grammar.r_next
                ...
                (Grammar.s_token ("", ")")))
             Grammar.s_self,
           (fun (mt : 'module_declaration) _ (t : 'module_type) _ (i : 'e__50)
                _ (loc : Ploc.t) ->
              (Qast.Node
                 ("MtFun",
                  [Qast.Loc;
       ...
       [Grammar.production
          (Grammar.r_next
             (Grammar.r_next
                ...
                (Grammar.s_token ("", ":=")))
             (Grammar.s_nterm (module_expr : 'module_expr Grammar.Entry.e)),
           (fun (me : 'module_expr) _ (i : 'e__57) _ (loc : Ploc.t) ->
        ...
        Grammar.production
          (Grammar.r_next
             (Grammar.r_next
                ...
                (Grammar.s_token ("", ":=")))
             (Grammar.s_nterm (ctyp : 'ctyp Grammar.Entry.e)),
           (fun (t : 'ctyp) _ (tpl : 'e__55) (i : 'e__54) _ (loc : Ploc.t) ->
                         ...
                         (Grammar.r_next Grammar.r_stop
                          ...
                          (fun (a : string) (loc : Ploc.t) ->
                             (Qast.VaVal (Qast.VaAnt ("flag", loc, a)) :
                              'e__53)))])))
             (Grammar.s_nterm (ctyp : 'ctyp Grammar.Entry.e)),
           (fun (t : 'ctyp) (pf : 'e__53) _ (tpl : 'e__52) (i : 'e__51) _
                (loc : Ploc.t) ->
                         ...
                         (Grammar.r_next Grammar.r_stop
                          ...
                          (fun (a : string) (loc : Ploc.t) ->
                             (Qast.VaVal (Qast.VaAnt ("opt", loc, a)) :
                              'e__162)))])))
             (Grammar.s_nterm (fun_binding : 'fun_binding Grammar.Entry.e)),
           (fun (e : 'fun_binding) (topt : 'e__162) (l : 'e__161)
                (pf : 'e__160) (ovf : 'e__159) _ (loc : Ploc.t) ->
        ...
        Grammar.production
          (Grammar.r_next
             (Grammar.r_next
                ...
                (Grammar.s_token ("", ":")))
             (Grammar.s_nterm (ctyp : 'ctyp Grammar.Entry.e)),
           (fun (t : 'ctyp) _ (l : 'e__158) (pf : 'e__157) _ _
                (loc : Ploc.t) ->
        ...
        Grammar.production
          (Grammar.r_next
             (Grammar.r_next
                ...
                (Grammar.s_token ("", ":")))
             (Grammar.s_nterm (ctyp : 'ctyp Grammar.Entry.e)),
           (fun (t : 'ctyp) _ (l : 'e__174) (pf : 'e__173) _ _
                (loc : Ploc.t) ->
                    ...
                    Grammar.production
                      (Grammar.r_next Grammar.r_stop
                       ...
                       (fun (a : string) (loc : Ploc.t) ->
                          (Qast.VaVal (Qast.VaAnt ("list", loc, a)) :
                           'e__195)))])),
           (fun (l : 'e__195) (ao : 'e__194) _ (i : 'e__193) _
                (loc : Ploc.t) ->
                ...
                (Grammar.s_rules
                   [Grammar.production
                      (Grammar.r_next Grammar.r_stop
                       ...
                       (fun (a : 'a_ti) (loc : Ploc.t) -> (a : 'e__202)));
                    Grammar.production
                      (Grammar.r_next Grammar.r_stop
             ...
             (Grammar.s_facto
                (Grammar.s_rules
                   [Grammar.production
                      (Grammar.r_next Grammar.r_stop
                         (Grammar.s_nterm (a_ti : 'a_ti Grammar.Entry.e)),
                       (fun (a : 'a_ti) (loc : Ploc.t) -> (a : 'e__209)));
                    Grammar.production
                      (Grammar.r_next Grammar.r_stop
                         (Grammar.s_token ("TILDEIDENT", "")),
                       (fun (a : string) (loc : Ploc.t) ->
        ...
        Grammar.production
          (Grammar.r_next
             (Grammar.r_next
                ...
                (Grammar.s_nterm (expr : 'expr Grammar.Entry.e)))
             (Grammar.s_token ("", ")")),
           (fun _ (e : 'expr) _ (t : 'ctyp) _ (i : 'e__221) _ _
                (loc : Ploc.t) ->
              (Qast.Node
                 ("PaOlb",
                  [Qast.Loc;
                ...
                (Grammar.s_rules
                   [Grammar.production
                      (Grammar.r_next Grammar.r_stop
                       ...
                       (fun (a : 'a_qi) (loc : Ploc.t) -> (a : 'e__220)));
                    Grammar.production
                      (Grammar.r_next Grammar.r_stop
        ...
        Grammar.production
          (Grammar.r_next
             (Grammar.r_next
                ...
                (Grammar.s_nterm (expr : 'expr Grammar.Entry.e)))
             (Grammar.s_token ("", ")")),
           (fun _ (e : 'expr) _ (j : 'e__217) _ (i : 'e__216)
                (loc : Ploc.t) ->
              (Qast.Node
                 ("PaOlb",
                  [Qast.Loc; Qast.Node ("PaLid", [Qast.Loc; i]);
        ...
        Grammar.production
          (Grammar.r_next
             (Grammar.r_next
                ...
                (Grammar.s_nterm (ctyp : 'ctyp Grammar.Entry.e)))
             (Grammar.s_token ("", ")")),
           (fun _ (t : 'ctyp) _ (j : 'e__215) _ (i : 'e__214)
                (loc : Ploc.t) ->
              (Qast.Node
                 ("PaOlb",
                  [Qast.Loc;
             ...
             (Grammar.s_facto
                (Grammar.s_rules
                   [Grammar.production
                      (Grammar.r_next Grammar.r_stop
                         (Grammar.s_nterm (a_qi : 'a_qi Grammar.Entry.e)),
                       (fun (a : 'a_qi) (loc : Ploc.t) -> (a : 'e__230)));
                    Grammar.production
                      (Grammar.r_next Grammar.r_stop
                         (Grammar.s_token ("QUESTIONIDENT", "")),
                       (fun (a : string) (loc : Ploc.t) ->
                      ...
                      (Grammar.r_next Grammar.r_stop
                       ...
                       (fun (a : string) (loc : Ploc.t) ->
                          (Qast.VaVal (Qast.VaAnt ("jid", loc, a)) :
                           'e__236)))])),
           (fun (ji : 'e__236) _ (eo : 'e__235) _ (loc : Ploc.t) ->
       ...
       [Grammar.production
          (Grammar.r_next
             (Grammar.r_next
                ...
                (Grammar.s_token ("", "=")))
             (Grammar.s_nterm (expr : 'expr Grammar.Entry.e)),
           (fun (e : 'expr) _ (jpl : 'e__238) (loc : Ploc.t) ->
                         ...
                         (Grammar.r_next Grammar.r_stop
                          ...
                          (fun (a : string) (loc : Ploc.t) ->
                             (Qast.VaVal (Qast.VaAnt ("opt", loc, a)) :
                              'e__239)))])))
             (Grammar.s_token ("", ")")),
           (fun _ (op : 'e__239) _ (ji : 'joinident) (loc : Ploc.t) ->
