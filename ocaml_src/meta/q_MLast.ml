   ...
   [Grammar.Entry.obj (module_expr : 'module_expr Grammar.Entry.e), None,
    ...
    [Some "top", Some Gramext.RightA,
     [[Gramext.Stoken ("", "while"); Gramext.Sself; Gramext.Stoken ("", "do");
       ...
       Gramext.Stoken ("", "}")],
      Gramext.action
        (fun _ (seq : 'a_list2) _ _ (e : 'expr) _ (loc : Ploc.t) ->
      ...
      Gramext.action
        (fun _ (seq : 'sequence) _ _ (e : 'expr) _ (loc : Ploc.t) ->
           (Qast.Node ("ExWhi", [Qast.Loc; e; Qast.VaVal seq]) : 'expr));
      [Gramext.Stoken ("", "for");
       Gramext.Snterm
         (Grammar.Entry.obj (a_LIDENT : 'a_LIDENT Grammar.Entry.e));
       Gramext.Stoken ("", "="); Gramext.Sself;
       ...
       Gramext.Stoken ("", "}")],
      Gramext.action
        (fun _ (seq : 'a_list2) _ _ (e2 : 'expr) (df : 'direction_flag)
      ...
      [Gramext.Stoken ("", "do"); Gramext.Stoken ("", "{");
       ...
       Gramext.Stoken ("", "}")],
      Gramext.action
        (fun _ (seq : 'a_list2) _ _ (loc : Ploc.t) ->
           (Qast.Node ("ExSeq", [Qast.Loc; seq]) : 'expr));
      [Gramext.Stoken ("", "do"); Gramext.Stoken ("", "{");
       Gramext.Snterm
         (Grammar.Entry.obj (sequence : 'sequence Grammar.Entry.e));
       Gramext.Stoken ("", "}")],
    ...
    [None, Some Gramext.RightA,
     [[Gramext.Snterm
       ...
       Gramext.Stoken ("", "."); Gramext.Sself],
      Gramext.action
        (fun (j : 'expr_ident) _ (i : 'a_UIDENT2) (loc : Ploc.t) ->
    ...
    [None, Some Gramext.LeftA,
     ...
     [[Gramext.Stoken ("", "_")],
      ...
      [Gramext.Stoken ("", "("); Gramext.Sself; Gramext.Stoken ("", ")")],
      Gramext.action (fun _ (p : 'patt) _ (loc : Ploc.t) -> (p : 'patt));
      [Gramext.Stoken ("", "("); Gramext.Stoken ("", ")")],
      Gramext.action
        (fun _ _ (loc : Ploc.t) ->
    ...
    [None, None,
     [[Gramext.Stoken ("", "_")],
      ...
      [Gramext.Stoken ("", "("); Gramext.Sself; Gramext.Stoken ("", ",");
       ...
       Gramext.Stoken ("", ")")],
      Gramext.action
        (fun _ (pl : 'a_list) _ (p : 'ipatt) _ (loc : Ploc.t) ->
           (Qast.Node ("PaTup", [Qast.Loc; Qast.VaVal (Qast.Cons (p, pl))]) :
            'ipatt));
      [Gramext.Stoken ("", "("); Gramext.Sself; Gramext.Stoken ("", "as");
       Gramext.Sself; Gramext.Stoken ("", ")")],
      Gramext.action
        (fun _ (p2 : 'ipatt) _ (p : 'ipatt) _ (loc : Ploc.t) ->
           (Qast.Node ("PaAli", [Qast.Loc; p; p2]) : 'ipatt));
      [Gramext.Stoken ("", "("); Gramext.Sself; Gramext.Stoken ("", ":");
       Gramext.Snterm (Grammar.Entry.obj (ctyp : 'ctyp Grammar.Entry.e));
       Gramext.Stoken ("", ")")],
      Gramext.action
        (fun _ (t : 'ctyp) _ (p : 'ipatt) _ (loc : Ploc.t) ->
           (Qast.Node ("PaTyc", [Qast.Loc; p; t]) : 'ipatt));
      [Gramext.Stoken ("", "("); Gramext.Sself; Gramext.Stoken ("", ")")],
      Gramext.action (fun _ (p : 'ipatt) _ (loc : Ploc.t) -> (p : 'ipatt));
      [Gramext.Stoken ("", "("); Gramext.Stoken ("", ")")],
      Gramext.action
        (fun _ _ (loc : Ploc.t) ->
