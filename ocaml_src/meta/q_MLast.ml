   ...
   [Grammar.Entry.obj (module_expr : 'module_expr Grammar.Entry.e), None,
       ...
       Gramext.srules
         [[Gramext.Slist1sep
          ...
          Gramext.action
            (fun (a : 'a_list2) (loc : Ploc.t) -> (a : 'a_list2))]],
      Gramext.action
        (fun (l : Qast.t) (r : Qast.t) _ (loc : Ploc.t) ->
    ...
    [None, None,
     [[],
      ...
      Gramext.action
        (fun (a : 'e__4) _ (loc : Ploc.t) -> (a : 'rebind_exn))]];
       ...
       Gramext.Sfacto
         (Gramext.srules
            [[Gramext.Snterm
             ...
             Gramext.action
               (fun (a : 'ident) (loc : Ploc.t) -> (Qast.VaVal a : 'e__6));
             [Gramext.Stoken ("ANTIQUOT", "_")],
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
       ...
       Gramext.srules
         [[Gramext.Slist1sep
          ...
          Gramext.action
            (fun (a : 'a_list2) (loc : Ploc.t) -> (a : 'a_list2))]],
      Gramext.action
        (fun (l : Qast.t) (rf : Qast.t) _ (loc : Ploc.t) ->
    ...
    [None, None,
     [[Gramext.Stoken ("", "module");
       Gramext.Sfacto
         (Gramext.srules
            [[Gramext.Snterm
             ...
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
                  (Qast.VaAnt ("_", loc, a) : 'e__10));
             [Gramext.Stoken ("ANTIQUOT", "")],
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
                  (Qast.VaVal (Qast.VaAnt ("", loc, a)) : 'e__10));
             [Gramext.Stoken ("ANTIQUOT", "_list")],
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
       ...
       Gramext.Snterm
         (Grammar.Entry.obj (module_expr : 'module_expr Grammar.Entry.e))],
      Gramext.action
        (fun (me : 'module_expr) _ (i : 'e__10) _ (loc : Ploc.t) ->
      ...
      [Gramext.Stoken ("", "type");
       ...
       Gramext.Snterm (Grammar.Entry.obj (ctyp : 'ctyp Grammar.Entry.e))],
      Gramext.action
        (fun (t : 'ctyp) (pf : Qast.t) _ (tpl : Qast.t) (i : 'e__9) _
             (loc : Ploc.t) ->
    ...
    [Some "top", Some Gramext.RightA,
     [[Gramext.Stoken ("", "while"); Gramext.Sself; Gramext.Stoken ("", "do");
       ...
       Gramext.Stoken ("", "}")],
      Gramext.action
        (fun _ (seq : 'e__14) _ _ (e : 'expr) _ (loc : Ploc.t) ->
      ...
      [Gramext.Stoken ("", "for");
       ...
       Gramext.Sfacto
         (Gramext.srules
            [[Gramext.Snterm
             ...
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
                  (Qast.VaAnt ("_to", loc, a) : 'e__12));
             [Gramext.Stoken ("ANTIQUOT", "to")],
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
                  (Qast.VaVal (Qast.VaAnt ("to", loc, a)) : 'e__12))]);
       ...
       Gramext.Stoken ("", "}")],
      Gramext.action
        (fun _ (seq : 'e__13) _ _ (e2 : 'expr) (df : 'e__12) (e1 : 'expr) _
      ...
      [Gramext.Stoken ("", "do"); Gramext.Stoken ("", "{");
       ...
       Gramext.Stoken ("", "}")],
      Gramext.action
        (fun _ (seq : 'e__11) _ _ (loc : Ploc.t) ->
      ...
      [Gramext.Stoken ("", "let");
       ...
       Gramext.Stoken ("", "in"); Gramext.Sself],
      Gramext.action
        (fun (x : 'expr) _ (l : Qast.t) (r : Qast.t) _ (loc : Ploc.t) ->
     ...
     [[Gramext.Sself; Gramext.Stoken ("", "where");
      ...
      Gramext.action
        (fun (lb : 'let_binding) (rf : Qast.t) _ (e : 'expr) (loc : Ploc.t) ->
           (Qast.Node
    ...
    [None, None,
     [[Gramext.Snterm (Grammar.Entry.obj (expr : 'expr Grammar.Entry.e))],
      ...
      [Gramext.Stoken ("", "let");
       ...
       Gramext.Stoken ("", "in"); Gramext.Sself],
      Gramext.action
        (fun (el : 'sequence) _ (l : Qast.t) (rf : Qast.t) _ (loc : Ploc.t) ->
           (Qast.List
              [Qast.Node
       ...
       Gramext.srules
         [[Gramext.Slist0
          ...
          Gramext.action
            (fun (a : 'a_list2) (loc : Ploc.t) -> (a : 'a_list2))]],
      Gramext.action
        (fun (cl : Qast.t) (tk : 'ctyp) (pf : Qast.t) _ (tpl : Qast.t)
       ...
       Gramext.Sfacto
         (Gramext.srules
            [[Gramext.Snterm
                (Grammar.Entry.obj (ident : 'ident Grammar.Entry.e))],
             Gramext.action
               (fun (a : 'ident) (loc : Ploc.t) -> (Qast.VaVal a : 'e__16));
             [Gramext.Stoken ("ANTIQUOT", "_")],
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
       ...
       Gramext.Sfacto
         (Gramext.srules
            [[Gramext.Snterm
                (Grammar.Entry.obj (ident : 'ident Grammar.Entry.e))],
             Gramext.action
               (fun (a : 'ident) (loc : Ploc.t) -> (Qast.VaVal a : 'e__15));
             [Gramext.Stoken ("ANTIQUOT", "_")],
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
                  (Qast.VaAnt ("_", loc, a) : 'e__15));
             [Gramext.Stoken ("ANTIQUOT", "")],
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
                  (Qast.VaVal (Qast.VaAnt ("", loc, a)) : 'e__15))])],
      Gramext.action
        (fun (i : 'e__15) _ (loc : Ploc.t) ->
       ...
       Gramext.Sfacto
         (Gramext.srules
            [[Gramext.Snterm
                (Grammar.Entry.obj (ident : 'ident Grammar.Entry.e))],
             Gramext.action
               (fun (a : 'ident) (loc : Ploc.t) -> (Qast.VaVal a : 'e__18));
             [Gramext.Stoken ("ANTIQUOT", "_")],
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
     ...
     [[Gramext.srules
      ...
      Gramext.action
        (fun (cfb : 'class_fun_binding) (ctp : 'class_type_parameters)
             (i : 'a_LIDENT2) (vf : Qast.t) (loc : Ploc.t) ->
           (Qast.Record
    ...
    [Some "top", None,
     [[Gramext.Stoken ("", "let");
       ...
       Gramext.Stoken ("", "in"); Gramext.Sself],
      Gramext.action
        (fun (ce : 'class_expr) _ (lb : Qast.t) (rf : Qast.t) _
             (loc : Ploc.t) ->
     ...
     [[Gramext.Stoken ("", "("); Gramext.Sself; Gramext.Stoken ("", ")")],
      ...
      [Gramext.Sfacto
       ...
       Gramext.Stoken ("", "]")],
      Gramext.action
        (fun _ (ctcl : Qast.t) _ (ci : 'e__19) (loc : Ploc.t) ->
     ...
     [[Gramext.Stoken ("", "initializer");
      ...
      [Gramext.Stoken ("", "method");
       ...
       Gramext.Sfacto
         (Gramext.srules
            [[Gramext.Snterm
             ...
             Gramext.action
               (fun (a : 'label) (loc : Ploc.t) -> (Qast.VaVal a : 'e__25));
       ...
       Gramext.Snterm
         (Grammar.Entry.obj (fun_binding : 'fun_binding Grammar.Entry.e))],
      Gramext.action
        (fun (e : 'fun_binding) (topt : Qast.t) (l : 'e__25) (pf : Qast.t) _
             (loc : Ploc.t) ->
       ...
       Gramext.Sfacto
         (Gramext.srules
            [[Gramext.Snterm
                (Grammar.Entry.obj (label : 'label Grammar.Entry.e))],
             Gramext.action
               (fun (a : 'label) (loc : Ploc.t) -> (Qast.VaVal a : 'e__24));
             [Gramext.Stoken ("ANTIQUOT", "_lid")],
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
                  (Qast.VaAnt ("_lid", loc, a) : 'e__24));
             [Gramext.Stoken ("ANTIQUOT", "lid")],
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
                  (Qast.VaVal (Qast.VaAnt ("lid", loc, a)) : 'e__24))]);
       Gramext.Stoken ("", ":");
       Gramext.Snterm (Grammar.Entry.obj (ctyp : 'ctyp Grammar.Entry.e))],
      Gramext.action
        (fun (t : 'ctyp) _ (l : 'e__24) (pf : Qast.t) _ _ (loc : Ploc.t) ->
       ...
       Gramext.Sfacto
         (Gramext.srules
            [[Gramext.Snterm
                (Grammar.Entry.obj (label : 'label Grammar.Entry.e))],
             Gramext.action
               (fun (a : 'label) (loc : Ploc.t) -> (Qast.VaVal a : 'e__23));
             [Gramext.Stoken ("ANTIQUOT", "_lid")],
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
                  (Qast.VaAnt ("_lid", loc, a) : 'e__23));
             [Gramext.Stoken ("ANTIQUOT", "lid")],
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
                  (Qast.VaVal (Qast.VaAnt ("lid", loc, a)) : 'e__23))]);
       Gramext.Snterm
         (Grammar.Entry.obj
            (cvalue_binding : 'cvalue_binding Grammar.Entry.e))],
      Gramext.action
        (fun (e : 'cvalue_binding) (lab : 'e__23) (mf : Qast.t) _
             (loc : Ploc.t) ->
    ...
    [None, None,
     [[Gramext.Stoken ("", "object");
      ...
      [Gramext.Sfacto
       ...
       Gramext.Stoken ("", "]")],
      Gramext.action
        (fun _ (tl : Qast.t) _ (id : 'e__26) (loc : Ploc.t) ->
    ...
    [None, None,
     [[Gramext.Stoken ("", "type");
       ...
       Gramext.Sfacto
         (Gramext.srules
            [[Gramext.Snterm
                (Grammar.Entry.obj (label : 'label Grammar.Entry.e))],
             Gramext.action
               (fun (a : 'label) (loc : Ploc.t) -> (Qast.VaVal a : 'e__32));
             [Gramext.Stoken ("ANTIQUOT", "_lid")],
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
                  (Qast.VaAnt ("_lid", loc, a) : 'e__32));
             [Gramext.Stoken ("ANTIQUOT", "lid")],
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
                  (Qast.VaVal (Qast.VaAnt ("lid", loc, a)) : 'e__32))]);
       Gramext.Stoken ("", ":");
       Gramext.Snterm (Grammar.Entry.obj (ctyp : 'ctyp Grammar.Entry.e))],
      Gramext.action
        (fun (t : 'ctyp) _ (l : 'e__32) (pf : Qast.t) _ (loc : Ploc.t) ->
      ...
      [Gramext.Stoken ("", "method"); Gramext.Stoken ("", "virtual");
       ...
       Gramext.Sfacto
         (Gramext.srules
            [[Gramext.Snterm
                (Grammar.Entry.obj (label : 'label Grammar.Entry.e))],
             Gramext.action
               (fun (a : 'label) (loc : Ploc.t) -> (Qast.VaVal a : 'e__31));
             [Gramext.Stoken ("ANTIQUOT", "_lid")],
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
       ...
       Gramext.Snterm (Grammar.Entry.obj (ctyp : 'ctyp Grammar.Entry.e))],
      Gramext.action
        (fun (t : 'ctyp) _ (l : 'e__31) (pf : Qast.t) _ _ (loc : Ploc.t) ->
      ...
      [Gramext.Stoken ("", "value");
       ...
       Gramext.Sfacto
         (Gramext.srules
            [[Gramext.Snterm
                (Grammar.Entry.obj (label : 'label Grammar.Entry.e))],
             Gramext.action
               (fun (a : 'label) (loc : Ploc.t) -> (Qast.VaVal a : 'e__30));
             [Gramext.Stoken ("ANTIQUOT", "_lid")],
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
       ...
       Gramext.Snterm (Grammar.Entry.obj (ctyp : 'ctyp Grammar.Entry.e))],
      Gramext.action
        (fun (t : 'ctyp) _ (l : 'e__30) (mf : Qast.t) _ (loc : Ploc.t) ->
     ...
     [[Gramext.srules
      ...
      Gramext.action
        (fun (ct : 'class_type) _ (ctp : 'class_type_parameters)
             (n : 'a_LIDENT2) (vf : Qast.t) (loc : Ploc.t) ->
           (Qast.Record
    ...
    [None, None,
     [[Gramext.Sself; Gramext.Stoken ("", "#");
      ...
      Gramext.action
        (fun (lab : 'e__34) _ (e : 'expr) (loc : Ploc.t) ->
    ...
    [None, None,
     [[Gramext.Stoken ("", "<");
       ...
       Gramext.Stoken ("", ">")],
      Gramext.action
        (fun _ (v : Qast.t) (ml : Qast.t) _ (loc : Ploc.t) ->
     ...
     [[Gramext.Snterm
         (Grammar.Entry.obj
            (a_QUESTIONIDENTCOLON2 :
             'a_QUESTIONIDENTCOLON2 Grammar.Entry.e))],
      Gramext.action
        (fun (i : 'a_QUESTIONIDENTCOLON2) (loc : Ploc.t) ->
           (i : 'questionidentcolon))]];
    Grammar.Entry.obj (ctyp : 'ctyp Grammar.Entry.e),
    Some (Gramext.Level "simple"),
    [None, None,
     [[Gramext.Stoken ("", "["); Gramext.Stoken ("", "<");
       ...
       Gramext.Sfacto
         (Gramext.srules
            [[Gramext.Snterm
                (Grammar.Entry.obj (ident : 'ident Grammar.Entry.e))],
             Gramext.action
               (fun (a : 'ident) (loc : Ploc.t) -> (Qast.VaVal a : 'e__37));
             [Gramext.Stoken ("ANTIQUOT", "_")],
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
       ...
       Gramext.srules
         [[Gramext.Slist1sep
          ...
          Gramext.action
            (fun (a : 'a_list2) (loc : Ploc.t) -> (a : 'a_list2))]],
      Gramext.action
        (fun (l : Qast.t) (ao : Qast.t) _ (i : 'e__37) _ (loc : Ploc.t) ->
       ...
       Gramext.Sfacto
         (Gramext.srules
            [[Gramext.Snterm
                (Grammar.Entry.obj (ident : 'ident Grammar.Entry.e))],
             Gramext.action
               (fun (a : 'ident) (loc : Ploc.t) -> (Qast.VaVal a : 'e__36));
             [Gramext.Stoken ("ANTIQUOT", "_")],
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
    ...
    [None, None,
     [[Gramext.Stoken ("", "?"); Gramext.Stoken ("", "(");
      ...
      [Gramext.Snterm
       ...
       Gramext.Stoken ("", ")")],
      Gramext.action
        (fun _ (eo : Qast.t) (p : 'patt_tcon) _ (i : 'questionidentcolon)
             (loc : Ploc.t) ->
           (Qast.Node
              ("PaOlb",
    ...
    [None, None,
     [[Gramext.Stoken ("", "?"); Gramext.Stoken ("", "(");
      ...
      [Gramext.Snterm
       ...
       Gramext.Stoken ("", ")")],
      Gramext.action
        (fun _ (eo : Qast.t) (p : 'ipatt_tcon) _ (i : 'questionidentcolon)
             (loc : Ploc.t) ->
           (Qast.Node
              ("PaOlb",
               [Qast.Loc; i; Qast.Option (Some (Qast.Tuple [p; eo]))]) :
       ...
       Gramext.Sfacto
         (Gramext.srules
            [[Gramext.Snterm
                (Grammar.Entry.obj (ident : 'ident Grammar.Entry.e))],
             Gramext.action
               (fun (a : 'ident) (loc : Ploc.t) -> (Qast.VaVal a : 'e__40));
             [Gramext.Stoken ("ANTIQUOT", "_")],
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
   ...
   [Grammar.Entry.obj (str_item : 'str_item Grammar.Entry.e), None,
    ...
    [None, None,
     [[],
      ...
      Gramext.action
        (fun (a : string) (loc : Ploc.t) ->
           (Qast.VaAnt ("_opt", loc, a) : 'dir_param));
      [Gramext.Stoken ("ANTIQUOT", "opt")],
      Gramext.action
        (fun (a : string) (loc : Ploc.t) ->
           (Qast.VaVal (Qast.VaAnt ("opt", loc, a)) : 'dir_param))]]]);;
  ...
  [Grammar.Entry.obj (module_expr : 'module_expr Grammar.Entry.e),
   ...
   [None, None,
    [[Gramext.Stoken ("ANTIQUOT", "_flag")],
     Gramext.action
       (fun (a : string) (loc : Ploc.t) ->
          (Qast.VaAnt ("_flag", loc, a) : 'a_flag2));
     [Gramext.Stoken ("ANTIQUOT", "flag")],
     Gramext.action
       (fun (a : string) (loc : Ploc.t) ->
          (Qast.VaVal (Qast.VaAnt ("flag", loc, a)) : 'a_flag2))]];
   Grammar.Entry.obj (a_opt : 'a_opt Grammar.Entry.e), None,
   [None, None,
   ...
   [None, None,
    [[Gramext.Stoken ("ANTIQUOT", "opt")],
     Gramext.action
       (fun (a : string) (loc : Ploc.t) ->
          (Qast.VaVal (Qast.VaAnt ("opt", loc, a)) : 'a_flag2))]];
   ...
   [None, None,
    [[Gramext.Stoken ("INT", "")],
     ...
     Gramext.action
       (fun (a : string) (loc : Ploc.t) ->
          (Qast.VaVal (Qast.VaAnt ("", loc, a)) : 'a_INT2));
   ...
   [None, None,
    [[Gramext.Stoken ("INT_l", "")],
     ...
     Gramext.action
       (fun (a : string) (loc : Ploc.t) ->
          (Qast.VaVal (Qast.VaAnt ("", loc, a)) : 'a_INT_l2));
   ...
   [None, None,
    [[Gramext.Stoken ("INT_n", "")],
     ...
     Gramext.action
       (fun (a : string) (loc : Ploc.t) ->
          (Qast.VaVal (Qast.VaAnt ("", loc, a)) : 'a_INT_n2));
   ...
   [None, None,
    [[Gramext.Stoken ("FLOAT", "")],
     ...
     Gramext.action
       (fun (a : string) (loc : Ploc.t) ->
          (Qast.VaVal (Qast.VaAnt ("", loc, a)) : 'a_FLOAT2));
   ...
   [None, None,
    [[Gramext.Stoken ("STRING", "")],
     ...
     Gramext.action
       (fun (a : string) (loc : Ploc.t) ->
          (Qast.VaVal (Qast.VaAnt ("", loc, a)) : 'a_STRING2));
   ...
   [None, None,
    [[Gramext.Stoken ("CHAR", "")],
     ...
     Gramext.action
       (fun (a : string) (loc : Ploc.t) ->
          (Qast.VaVal (Qast.VaAnt ("", loc, a)) : 'a_CHAR2));
