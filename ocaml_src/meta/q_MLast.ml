                      ...
                      (Grammar.r_next Grammar.r_stop
                       ...
                       (fun (a : string) (loc : Ploc.t) ->
                          (Qast.VaVal (Qast.VaAnt ("uid", loc, a)) :
                           'e__188)))])),
           "194fe98d",
           (fun (ci : 'e__188) (loc : Ploc.t) -> (ci : 'cons_ident)))]];
    Grammar.extension
      (constructor_declaration : 'constructor_declaration Grammar.Entry.e)
      None
      [None, None,
      ...
      [None, None,
       [Grammar.production
          (Grammar.r_next
           ...
           "194fe98d",
           (fun (alg_attrs : 'alg_attributes) (rto : 'e__193)
                (loc : Ploc.t) ->
        ...
        Grammar.production
          (Grammar.r_next
             ...
             (Grammar.s_nterm
                (alg_attributes : 'alg_attributes Grammar.Entry.e)),
           "194fe98d",
           (fun (alg_attrs : 'alg_attributes) (rto : 'e__191) (cal : 'e__189)
        ...
        Grammar.production
          (Grammar.r_next
                      ...
                      [Grammar.production
                       ...
                       Grammar.production
                         (Grammar.r_next Grammar.r_stop
                          ...
                          "194fe98d",
                          (fun (a : string) (loc : Ploc.t) ->
                             (Qast.VaAnt ("_longid", loc, a) : 'e__194)));
                       Grammar.production
                         (Grammar.r_next Grammar.r_stop
                            (Grammar.s_token ("ANTIQUOT", "longid")),
                          "194fe98d",
             ...
             (Grammar.s_nterm
                (alg_attributes : 'alg_attributes Grammar.Entry.e)),
           "194fe98d",
           (fun (alg_attrs : 'alg_attributes) (b : 'e__194) _
       ...
       [Grammar.production
          (Grammar.r_next
           ...
           (fun (attrs : 'item_attributes) (cfb : 'class_fun_binding)
                (ctp : 'class_type_parameters) (i : 'e__200) (vf : 'e__199)
                (loc : Ploc.t) ->
              (Qast.Record
      ...
      [Some "top", None,
       [Grammar.production
          (Grammar.r_next
             ...
             Grammar.s_self,
           "194fe98d",
           (fun (ce : 'class_expr) _ (i : 'extended_longident) (ovf : 'e__204)
                _ _ (loc : Ploc.t) ->
        ...
        Grammar.production
          (Grammar.r_next
             ...
             Grammar.s_self,
           "194fe98d",
           (fun (ce : 'class_expr) _ (lb : 'e__203) (rf : 'e__202) _
                (loc : Ploc.t) ->
       ...
       [Grammar.production
          (Grammar.r_next
                      ...
                      [Grammar.production
                       ...
                       Grammar.production
                         (Grammar.r_next Grammar.r_stop
                          ...
                          "194fe98d",
                          (fun (a : string) (loc : Ploc.t) ->
                             (Qast.VaAnt ("_attribute", loc, a) : 'e__205)));
                       Grammar.production
                         (Grammar.r_next Grammar.r_stop
                            (Grammar.s_token ("ANTIQUOT", "attribute")),
                          "194fe98d",
             ...
             (Grammar.s_token ("", "]")),
           "194fe98d",
           (fun _ (attr : 'e__205) _ (t1 : 'class_expr) (loc : Ploc.t) ->
                   ...
                   [Grammar.production
                    ...
                    Grammar.production
                      (Grammar.r_next Grammar.r_stop
                       ...
                       "194fe98d",
                       (fun (a : string) (loc : Ploc.t) ->
                          (Qast.VaAnt ("_lilongid", loc, a) : 'e__210)));
                    Grammar.production
                      (Grammar.r_next Grammar.r_stop
                         (Grammar.s_token ("ANTIQUOT", "lilongid")),
                       "194fe98d",
                       (fun (a : string) (loc : Ploc.t) ->
                          (Qast.VaVal (Qast.VaAnt ("lilongid", loc, a)) :
                           'e__210)))])),
           "194fe98d",
           (fun (cli : 'e__210) _ (ctcl : 'e__209) _ (loc : Ploc.t) ->
                      ...
                      (Grammar.r_next Grammar.r_stop
                       ...
                       (fun (a : string) (loc : Ploc.t) ->
                          (Qast.VaVal (Qast.VaAnt ("list", loc, a)) :
                           'e__212)))])),
           "194fe98d",
           (fun (cf : 'e__212) (loc : Ploc.t) -> (cf : 'class_structure)))]];
        ...
        Grammar.production
          (Grammar.r_next
             ...
             (Grammar.s_nterm
                (item_attributes : 'item_attributes Grammar.Entry.e)),
           "194fe98d",
           (fun (attrs : 'item_attributes) (e : 'fun_binding) (topt : 'e__227)
                (l : 'e__226) (pf : 'e__225) (ovf : 'e__224) _
                (loc : Ploc.t) ->
        ...
        Grammar.production
          (Grammar.r_next
             ...
             (Grammar.s_nterm
                (item_attributes : 'item_attributes Grammar.Entry.e)),
           "194fe98d",
           (fun (attrs : 'item_attributes) (t : 'ctyp) _ (lab : 'e__221)
                (mf : 'e__220) _ _ (loc : Ploc.t) ->
        ...
        Grammar.production
          (Grammar.r_next
           ...
           (fun (attrs : 'item_attributes) (e : 'cvalue_binding)
                (lab : 'e__219) (mf : 'e__218) (ovf : 'e__217) _
                (loc : Ploc.t) ->
        ...
        Grammar.production
          (Grammar.r_next
             ...
             (Grammar.s_nterm
                (item_attributes : 'item_attributes Grammar.Entry.e)),
           "194fe98d",
           (fun (attrs : 'item_attributes) (pb : 'e__216) (ce : 'class_expr)
                (ovf : 'e__215) _ (loc : Ploc.t) ->
      ...
      [Some "top", Some Gramext.RightA,
       [Grammar.production
          (Grammar.r_next
             ...
             Grammar.s_self,
           "194fe98d",
           (fun (ce : 'class_type) _ (i : 'extended_longident) (ovf : 'e__228)
                _ _ (loc : Ploc.t) ->
       ...
       [Grammar.production
          (Grammar.r_next
                      ...
                      [Grammar.production
                       ...
                       Grammar.production
                         (Grammar.r_next Grammar.r_stop
                          ...
                          "194fe98d",
                          (fun (a : string) (loc : Ploc.t) ->
                             (Qast.VaAnt ("_attribute", loc, a) : 'e__229)));
                       Grammar.production
                         (Grammar.r_next Grammar.r_stop
                            (Grammar.s_token ("ANTIQUOT", "attribute")),
                          "194fe98d",
             ...
             (Grammar.s_token ("", "]")),
           "194fe98d",
           (fun _ (attr : 'e__229) _ (t1 : 'class_type) (loc : Ploc.t) ->
       ...
       [Grammar.production
          (Grammar.r_next
             ...
             (Grammar.s_token ("", "]")),
           "194fe98d",
           (fun _ (tl : 'e__233) _ (ct : 'class_type) (loc : Ploc.t) ->
        ...
        Grammar.production
          (Grammar.r_next
             ...
             (Grammar.s_token ("", "end")),
           "194fe98d",
           (fun _ (csf : 'e__232) (cst : 'e__230) _ (loc : Ploc.t) ->
                      ...
                      (Grammar.r_next Grammar.r_stop
                       ...
                       (fun (a : string) (loc : Ploc.t) ->
                          (Qast.VaVal (Qast.VaAnt ("lid", loc, a)) :
                           'e__234)))])),
           "194fe98d",
           (fun (i : 'e__234) _ (li : 'extended_longident) (loc : Ploc.t) ->
        ...
        Grammar.production
          (Grammar.r_next
           ...
           (fun (attrs : 'item_attributes) (t : 'ctyp) _ (l : 'e__240)
                (vf : 'e__239) (mf : 'e__238) _ (loc : Ploc.t) ->
      ...
      [None, Some Gramext.LeftA,
       [Grammar.production
          (Grammar.r_next
             ...
             (Grammar.s_token ("", "end")),
           "194fe98d",
           (fun _ (cf : 'class_structure) (cspo : 'e__250) _ (loc : Ploc.t) ->
                   ...
                   [Grammar.production
                    ...
                    Grammar.production
                      (Grammar.r_next Grammar.r_stop
                       ...
                       "194fe98d",
                       (fun (a : string) (loc : Ploc.t) ->
                          (Qast.VaAnt ("_lilongid", loc, a) : 'e__249)));
                    Grammar.production
                      (Grammar.r_next Grammar.r_stop
                         (Grammar.s_token ("ANTIQUOT", "lilongid")),
                       "194fe98d",
                      ...
                      (Grammar.r_next Grammar.r_stop
                       ...
                       (fun (a : string) (loc : Ploc.t) ->
                          (Qast.VaVal (Qast.VaAnt ("lid", loc, a)) :
                           'e__251)))])),
           "194fe98d",
           (fun (lab : 'e__251) _ (e : 'expr) (loc : Ploc.t) ->
      ...
      [None, None,
       [Grammar.production
          (Grammar.r_next
             ...
             (Grammar.s_token ("", ">")),
           "194fe98d",
           (fun _ (v : 'e__255) (ml : 'e__254) _ (loc : Ploc.t) ->
                         ...
                         [Grammar.production
                          ...
                          Grammar.production
                            (Grammar.r_next Grammar.r_stop
                             ...
                             "194fe98d",
                             (fun (a : string) (loc : Ploc.t) ->
                                (Qast.VaAnt ("_longid", loc, a) : 'e__259)));
                          Grammar.production
                            (Grammar.r_next Grammar.r_stop
                               (Grammar.s_token ("ANTIQUOT", "longid")),
                             "194fe98d",
                      ...
                      (Grammar.r_next Grammar.r_stop
                       ...
                       (fun (a : string) (loc : Ploc.t) ->
                          (Qast.VaVal (Qast.VaAnt ("lid", loc, a)) :
                           'e__260)))])),
           "194fe98d",
           (fun (i : 'e__260) _ (li : 'e__259) (loc : Ploc.t) ->
       ...
       [Grammar.production
                   ...
                   (Grammar.s_rules
                      [Grammar.production
                         (Grammar.r_next Grammar.r_stop
                          ...
                          "194fe98d",
                          (fun (a : 'a_qic) (loc : Ploc.t) -> (a : 'e__263)));
                       Grammar.production
                         (Grammar.r_next Grammar.r_stop
        ...
        Grammar.production
          (Grammar.r_next
             ...
             Grammar.s_self,
           "194fe98d",
           (fun (t : 'ctyp) (i : 'e__262) (loc : Ploc.t) ->
      ...
      [None, None,
       [Grammar.production
          (Grammar.r_next
             ...
             (Grammar.s_token ("", "]")),
           "194fe98d",
           (fun _ (ntl : 'e__264) _ (rfl : 'poly_variant_list) _ _
                (loc : Ploc.t) ->
              (Qast.Node
                 ("TyVrn",
                  [Qast.Loc; rfl;
        ...
        Grammar.production
          (Grammar.r_next
             ...
             (Grammar.s_nterm
                (alg_attributes : 'alg_attributes Grammar.Entry.e)),
           "194fe98d",
           (fun (alg_attrs : 'alg_attributes) (l : 'e__269) (ao : 'e__268) _
                (i : 'e__267) _ (loc : Ploc.t) ->
        ...
        Grammar.production
          (Grammar.r_next
             ...
             (Grammar.s_nterm
                (alg_attributes : 'alg_attributes Grammar.Entry.e)),
           "194fe98d",
           (fun (alg_attrs : 'alg_attributes) (i : 'e__266) _
                (loc : Ploc.t) ->
              (Qast.Node
                 ("PvTag",
       ...
       [Grammar.production
        ...
        Grammar.production
          (Grammar.r_next
             ...
             Grammar.s_self,
           "194fe98d",
           (fun (p : 'patt) (i : 'e__276) (loc : Ploc.t) ->
              (let _ = warning_deprecated_since_6_00 loc in
               Qast.Node
                 ("PaLab",
                  [Qast.Loc; Qast.Node ("PaLid", [Qast.Loc; i]);
        ...
        Grammar.production
          (Grammar.r_next
             ...
             (Grammar.s_token ("", "}")),
           "194fe98d",
           (fun _ (eo : 'e__275) (p : 'patt_tcon) _ _ (loc : Ploc.t) ->
        ...
        Grammar.production
          (Grammar.r_next
             ...
             (Grammar.s_token ("", "}")),
           "194fe98d",
           (fun _ (po : 'e__273) (p : 'patt_tcon) _ _ (loc : Ploc.t) ->
                   ...
                   [Grammar.production
                    ...
                    Grammar.production
                      (Grammar.r_next Grammar.r_stop
                       ...
                       "194fe98d",
                       (fun (a : string) (loc : Ploc.t) ->
                          (Qast.VaAnt ("_lilongid", loc, a) : 'e__271)));
                    Grammar.production
                      (Grammar.r_next Grammar.r_stop
                         (Grammar.s_token ("ANTIQUOT", "lilongid")),
                       "194fe98d",
       ...
       [Grammar.production
        ...
        Grammar.production
          (Grammar.r_next
             ...
             Grammar.s_self,
           "194fe98d",
           (fun (p : 'ipatt) (i : 'e__282) (loc : Ploc.t) ->
              (let _ = warning_deprecated_since_6_00 loc in
               Qast.Node
                 ("PaLab",
                  [Qast.Loc; Qast.Node ("PaLid", [Qast.Loc; i]);
        ...
        Grammar.production
          (Grammar.r_next
             ...
             (Grammar.s_token ("", "}")),
           "194fe98d",
           (fun _ (po : 'e__279) (p : 'ipatt_tcon) _ _ (loc : Ploc.t) ->
