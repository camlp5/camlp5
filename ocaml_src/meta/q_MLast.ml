       ...
       [Grammar.production
                   ...
                   (Grammar.s_rules
                      [Grammar.production
                         (Grammar.r_next Grammar.r_stop
                          ...
                          "1154dceb",
                          (fun (a : 'a_qic) (loc : Ploc.t) -> (a : 'e__254)));
                       Grammar.production
                         (Grammar.r_next Grammar.r_stop
        ...
        Grammar.production
          (Grammar.r_next
             ...
             Grammar.s_self,
           "1154dceb",
           (fun (t : 'ctyp) (i : 'e__253) (loc : Ploc.t) ->
      ...
      [None, None,
       [Grammar.production
          (Grammar.r_next
             ...
             (Grammar.s_token ("", "]")),
           "1154dceb",
           (fun _ (ntl : 'e__255) _ (rfl : 'poly_variant_list) _ _
                (loc : Ploc.t) ->
              (Qast.Node
                 ("TyVrn",
                  [Qast.Loc; rfl;
        ...
        Grammar.production
          (Grammar.r_next
             ...
             (Grammar.s_nterm
                (alg_attributes : 'alg_attributes Grammar.Entry.e)),
           "1154dceb",
           (fun (alg_attrs : 'alg_attributes) (l : 'e__260) (ao : 'e__259) _
                (i : 'e__258) _ (loc : Ploc.t) ->
        ...
        Grammar.production
          (Grammar.r_next
             ...
             (Grammar.s_nterm
                (alg_attributes : 'alg_attributes Grammar.Entry.e)),
           "1154dceb",
           (fun (alg_attrs : 'alg_attributes) (i : 'e__257) _
                (loc : Ploc.t) ->
              (Qast.Node
                 ("PvTag",
       ...
       [Grammar.production
        ...
        Grammar.production
          (Grammar.r_next
             ...
             Grammar.s_self,
           "1154dceb",
           (fun (p : 'patt) (i : 'e__266) (loc : Ploc.t) ->
              (let _ = warning_deprecated_since_6_00 loc in
               Qast.Node
                 ("PaLab",
                  [Qast.Loc;
        ...
        Grammar.production
          (Grammar.r_next
             ...
             (Grammar.s_token ("", "}")),
           "1154dceb",
           (fun _ (eo : 'e__265) (p : 'patt_tcon) _ _ (loc : Ploc.t) ->
                   ...
                   [Grammar.production
                    ...
                    Grammar.production
                      (Grammar.r_next Grammar.r_stop
                       ...
                       "1154dceb",
                       (fun (a : string) (loc : Ploc.t) ->
                          (Qast.VaAnt ("_lilongid", loc, a) : 'e__262)));
                    Grammar.production
                      (Grammar.r_next Grammar.r_stop
                         (Grammar.s_token ("ANTIQUOT", "lilongid")),
                       "1154dceb",
                      ...
                      (Grammar.r_next Grammar.r_stop
                       ...
                       (fun (a : string) (loc : Ploc.t) ->
                          (Qast.VaVal (Qast.VaAnt ("opt", loc, a)) :
                           'e__269)))])),
           "1154dceb",
           (fun (po : 'e__269) (p : 'patt_tcon) (loc : Ploc.t) ->
       ...
       [Grammar.production
        ...
        Grammar.production
          (Grammar.r_next
             ...
             Grammar.s_self,
           "1154dceb",
           (fun (p : 'ipatt) (i : 'e__273) (loc : Ploc.t) ->
              (let _ = warning_deprecated_since_6_00 loc in
               Qast.Node
                 ("PaLab",
                  [Qast.Loc;
                      ...
                      (Grammar.r_next Grammar.r_stop
                       ...
                       (fun (a : string) (loc : Ploc.t) ->
                          (Qast.VaVal (Qast.VaAnt ("opt", loc, a)) :
                           'e__276)))])),
           "1154dceb",
           (fun (po : 'e__276) (p : 'ipatt_tcon) (loc : Ploc.t) ->
       ...
       [Grammar.production
        ...
        Grammar.production
          (Grammar.r_next
             ...
             (Grammar.s_token ("", ")")),
           "1154dceb",
           (fun _ (e : 'expr) _ (i : 'e__288) _ _ (loc : Ploc.t) ->
              (Qast.Node
                 ("PaOlb",
                  [Qast.Loc; Qast.Node ("PaLid", [Qast.Loc; i]);
        ...
        Grammar.production
          (Grammar.r_next
             ...
             (Grammar.s_token ("", ")")),
           "1154dceb",
           (fun _ (t : 'ctyp) _ (i : 'e__287) _ _ (loc : Ploc.t) ->
              (Qast.Node
                 ("PaOlb",
                  [Qast.Loc;
                   Qast.Node
        ...
        Grammar.production
          (Grammar.r_next
             ...
             (Grammar.s_token ("", ")")),
           "1154dceb",
           (fun _ (e : 'expr) _ (t : 'ctyp) _ (i : 'e__286) _ _
                (loc : Ploc.t) ->
              (Qast.Node
                 ("PaOlb",
                  [Qast.Loc;
        ...
        Grammar.production
          (Grammar.r_next
             ...
             (Grammar.s_token ("", ")")),
           "1154dceb",
           (fun _ (j : 'e__284) _ (i : 'e__283) (loc : Ploc.t) ->
              (Qast.Node
                 ("PaOlb",
                  [Qast.Loc; Qast.Node ("PaLid", [Qast.Loc; i]);
                   Qast.VaVal
        ...
        Grammar.production
          (Grammar.r_next
             ...
             (Grammar.s_token ("", ")")),
           "1154dceb",
           (fun _ (e : 'expr) _ (j : 'e__282) _ (i : 'e__281)
                (loc : Ploc.t) ->
              (Qast.Node
                 ("PaOlb",
                  [Qast.Loc; Qast.Node ("PaLid", [Qast.Loc; i]);
        ...
        Grammar.production
          (Grammar.r_next
             ...
             (Grammar.s_token ("", ")")),
           "1154dceb",
           (fun _ (t : 'ctyp) _ (j : 'e__280) _ (i : 'e__279)
                (loc : Ploc.t) ->
              (Qast.Node
                 ("PaOlb",
                  [Qast.Loc;
        ...
        Grammar.production
          (Grammar.r_next
             ...
             (Grammar.s_token ("", ")")),
           "1154dceb",
           (fun _ (e : 'expr) _ (t : 'ctyp) _ (j : 'e__278) _ (i : 'e__277)
                (loc : Ploc.t) ->
              (Qast.Node
                 ("PaOlb",
                  [Qast.Loc;
       ...
       [Grammar.production
                ...
                (Grammar.s_rules
                   [Grammar.production
                      (Grammar.r_next Grammar.r_stop
                         (Grammar.s_nterm (a_qi : 'a_qi Grammar.Entry.e)),
                       "1154dceb",
                       (fun (a : 'a_qi) (loc : Ploc.t) -> (a : 'e__295)));
                    Grammar.production
                      (Grammar.r_next Grammar.r_stop
                         (Grammar.s_token ("QUESTIONIDENT", "")),
                       "1154dceb",
        ...
        Grammar.production
          (Grammar.r_next
                      ...
                      [Grammar.production
                         (Grammar.r_next Grammar.r_stop
                            (Grammar.s_nterm
                               (a_qic : 'a_qic Grammar.Entry.e)),
                          "1154dceb",
                          (fun (a : 'a_qic) (loc : Ploc.t) -> (a : 'e__294)));
                       Grammar.production
                         (Grammar.r_next Grammar.r_stop
                            (Grammar.s_token ("QUESTIONIDENTCOLON", "")),
                          "1154dceb",
             ...
             Grammar.s_self,
           "1154dceb",
           (fun (e : 'expr) (i : 'e__294) (loc : Ploc.t) ->
              (let _ = warning_deprecated_since_6_00 loc in
               Qast.Node
                 ("ExOlb",
                  [Qast.Loc; Qast.Node ("PaLid", [Qast.Loc; i]);
                ...
                (Grammar.s_rules
                   [Grammar.production
                      (Grammar.r_next Grammar.r_stop
                         (Grammar.s_nterm (a_ti : 'a_ti Grammar.Entry.e)),
                       "1154dceb",
                       (fun (a : 'a_ti) (loc : Ploc.t) -> (a : 'e__293)));
                    Grammar.production
                      (Grammar.r_next Grammar.r_stop
                         (Grammar.s_token ("TILDEIDENT", "")),
                       "1154dceb",
                      ...
                      [Grammar.production
                         (Grammar.r_next Grammar.r_stop
                            (Grammar.s_nterm
                               (a_tic : 'a_tic Grammar.Entry.e)),
                          "1154dceb",
                          (fun (a : 'a_tic) (loc : Ploc.t) -> (a : 'e__292)));
                       Grammar.production
                         (Grammar.r_next Grammar.r_stop
                            (Grammar.s_token ("TILDEIDENTCOLON", "")),
                          "1154dceb",
        ...
        Grammar.production
          (Grammar.r_next
             ...
             (Grammar.s_token ("", "}")),
           "1154dceb",
           (fun _ (eo : 'e__291) (p : 'ipatt_tcon) _ _ (loc : Ploc.t) ->
        ...
        Grammar.production
          (Grammar.r_next
             ...
             (Grammar.s_token ("", "}")),
           "1154dceb",
           (fun _ (lpeo : 'e__290) _ _ (loc : Ploc.t) ->
                      ...
                      (Grammar.r_next Grammar.r_stop
                       ...
                       (fun (a : string) (loc : Ploc.t) ->
                          (Qast.VaVal (Qast.VaAnt ("opt", loc, a)) :
                           'e__296)))])),
           "1154dceb",
           (fun (eo : 'e__296) (p : 'ipatt_tcon) (loc : Ploc.t) ->
