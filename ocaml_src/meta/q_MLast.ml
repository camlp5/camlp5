   ...
   [Grammar.Entry.obj (module_expr : 'module_expr Grammar.Entry.e), None,
                ...
                [[Gramext.Snterm
                 ...
                 Gramext.action
                   (fun _ (s : 'sig_item) (loc : Token.location) ->
                      (s : 'e__3))])],
          Gramext.action
            (fun (a : 'e__3 list) (loc : Token.location) ->
               (Qast.List a : 'a_list));
          [Gramext.Snterm
             (Grammar.Entry.obj (a_list : 'a_list Grammar.Entry.e))],
          Gramext.action
       ...
       Gramext.srules
         [[Gramext.Slist1sep
          ...
          Gramext.action
            (fun (a : 'a_list) (loc : Token.location) -> (a : 'a_list))]],
      Gramext.action
        (fun (l : 'a_list) (rf : 'a_flag2) _ (loc : Token.location) ->
                ...
                [[Gramext.Snterm
                 ...
                 Gramext.action
                   (fun _ (s : 'sig_item) (loc : Token.location) ->
                      (s : 'e__4))])],
          Gramext.action
            (fun (a : 'e__4 list) (loc : Token.location) ->
               (Qast.List a : 'a_list));
          [Gramext.Snterm
             (Grammar.Entry.obj (a_list : 'a_list Grammar.Entry.e))],
          Gramext.action
     ...
     [[Gramext.srules
      ...
      Gramext.action
        (fun (cfb : 'class_fun_binding) (ctp : 'class_type_parameters)
             (i : 'a_LIDENT) (vf : 'a_flag) (loc : Token.location) ->
           (Qast.Record
    ...
    [Some "top", None,
     [[Gramext.Stoken ("", "let");
       ...
       Gramext.Stoken ("", "in"); Gramext.Sself],
      Gramext.action
        (fun (ce : 'class_expr) _ (lb : 'a_list) (rf : 'a_flag2) _
             (loc : Token.location) ->
    ...
    [None, None,
     [[Gramext.Stoken ("", "initializer");
      ...
      [Gramext.Stoken ("", "method");
       Gramext.srules
         [[Gramext.Svala
             ("FLAG", Gramext.Sflag (Gramext.Stoken ("", "private")))],
          Gramext.action
            (fun (a : bool MLast.vala) (loc : Token.location) ->
               (Qast.vala (fun a -> Qast.Bool a) a : 'a_flag2));
          [Gramext.Snterm
       ...
       Gramext.Snterm
         (Grammar.Entry.obj (fun_binding : 'fun_binding Grammar.Entry.e))],
      Gramext.action
        (fun (e : 'fun_binding) (topt : 'a_opt) (l : 'label) (pf : 'a_flag2) _
             (loc : Token.location) ->
      ...
      [Gramext.Stoken ("", "method"); Gramext.Stoken ("", "virtual");
       ...
       Gramext.Snterm (Grammar.Entry.obj (ctyp : 'ctyp Grammar.Entry.e))],
      Gramext.action
        (fun (t : 'ctyp) _ (l : 'label) (pf : 'a_flag2) _ _
             (loc : Token.location) ->
           (Qast.Node ("CrVir", [Qast.Loc; l; pf; t]) : 'class_str_item));
      [Gramext.Stoken ("", "value");
       Gramext.srules
         [[Gramext.Svala
             ("FLAG", Gramext.Sflag (Gramext.Stoken ("", "mutable")))],
          Gramext.action
            (fun (a : bool MLast.vala) (loc : Token.location) ->
               (Qast.vala (fun a -> Qast.Bool a) a : 'a_flag2));
          [Gramext.Snterm
      ...
      Gramext.action
        (fun (e : 'cvalue_binding) (lab : 'label) (mf : 'a_flag2) _
             (loc : Token.location) ->
                ...
                [[Gramext.Snterm
                 ...
                 Gramext.action
                   (fun _ (csf : 'class_sig_item) (loc : Token.location) ->
                      (csf : 'e__7))])],
          Gramext.action
            (fun (a : 'e__7 list) (loc : Token.location) ->
               (Qast.List a : 'a_list));
          [Gramext.Snterm
             (Grammar.Entry.obj (a_list : 'a_list Grammar.Entry.e))],
          Gramext.action
    ...
    [None, None,
     [[Gramext.Stoken ("", "type");
      ...
      [Gramext.Stoken ("", "method");
       ...
       Gramext.Snterm (Grammar.Entry.obj (ctyp : 'ctyp Grammar.Entry.e))],
      Gramext.action
        (fun (t : 'ctyp) _ (l : 'label) (pf : 'a_flag2) _
             (loc : Token.location) ->
      ...
      [Gramext.Stoken ("", "value");
       ...
       Gramext.Snterm (Grammar.Entry.obj (ctyp : 'ctyp Grammar.Entry.e))],
      Gramext.action
        (fun (t : 'ctyp) _ (l : 'label) (mf : 'a_flag2) _
             (loc : Token.location) ->
                ...
                [[Gramext.Snterm
                 ...
                 Gramext.action
                   (fun _ (s : 'class_sig_item) (loc : Token.location) ->
                      (s : 'e__8))])],
          Gramext.action
            (fun (a : 'e__8 list) (loc : Token.location) ->
               (Qast.List a : 'a_list));
          [Gramext.Snterm
             (Grammar.Entry.obj (a_list : 'a_list Grammar.Entry.e))],
          Gramext.action
     ...
     [[Gramext.srules
      ...
      Gramext.action
        (fun (ct : 'class_type) _ (ctp : 'class_type_parameters)
             (n : 'a_LIDENT) (vf : 'a_flag) (loc : Token.location) ->
           (Qast.Record
    ...
    [None, None,
     [[Gramext.Stoken ("", "<");
       Gramext.srules
         [[Gramext.Slist0sep
          ...
          Gramext.action
            (fun (a : 'a_list) (loc : Token.location) -> (a : 'a_list))];
       Gramext.srules
         [[Gramext.Svala ("FLAG", Gramext.Sflag (Gramext.Stoken ("", "..")))],
          Gramext.action
            (fun (a : bool MLast.vala) (loc : Token.location) ->
               (Qast.vala (fun a -> Qast.Bool a) a : 'a_flag2));
          [Gramext.Snterm
       ...
       Gramext.Stoken ("", ">")],
      Gramext.action
        (fun _ (v : 'a_flag2) (ml : 'a_list) _ (loc : Token.location) ->
