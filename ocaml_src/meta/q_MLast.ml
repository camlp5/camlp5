       ...
       [Grammar.production
        ...
        Grammar.production
          (Grammar.r_next
           ...
           (fun (p : 'patt) _ (li : 'extended_longident) (loc : Ploc.t) ->
        ...
        Grammar.production
          (Grammar.r_next
             (Grammar.r_next
                ...
                (Grammar.s_token ("", ":")))
             (Grammar.s_nterm (module_type : 'module_type Grammar.Entry.e)),
           (fun (mt : 'module_type) _ (s : 'e__157) _ (loc : Ploc.t) ->
              (Qast.Node ("PaUnp", [Qast.Loc; s; Qast.Option (Some mt)]) :
               'paren_ipatt)));
        Grammar.production
          (Grammar.r_next
       ...
       [Grammar.production
          (Grammar.r_next
                      ...
                      (Grammar.r_next
                         ...
                         (Grammar.s_rules
                            [Grammar.production
                               (Grammar.r_next Grammar.r_stop
                                  (Grammar.s_token ("", ":=")),
                                (fun _ (loc : Ploc.t) -> (false : 'e__161)));
                             Grammar.production
                               (Grammar.r_next Grammar.r_stop
                                  (Grammar.s_token ("", "=")),
                                (fun _ (loc : Ploc.t) -> (true : 'e__161)))]))
                      (Grammar.s_facto
                         (Grammar.s_rules
                            [Grammar.production
                               (Grammar.r_next Grammar.r_stop
           ...
           (fun (attrs : 'item_attributes) (cl : 'e__163) (tk : 'ctyp)
                (pf : 'e__162) (isDecl : 'e__161) (tpl : 'e__160)
                (n : 'e__159) (loc : Ploc.t) ->
              (Qast.Record
      ...
      [None, None,
       [Grammar.production
          (Grammar.r_next
             ...
             (Grammar.s_nterm
                (item_attributes : 'item_attributes Grammar.Entry.e)),
           (fun (attrs : 'item_attributes) (ecs : 'e__167) (pf : 'e__166) _
                (tpl : 'e__165) (n : 'e__164) (loc : Ploc.t) ->
              (Qast.Record
       ...
       [Grammar.production
        ...
        Grammar.production
          (Grammar.r_next
             ...
             (Grammar.s_nterm
                (alg_attributes : 'alg_attributes Grammar.Entry.e)),
           (fun (alg_attrs : 'alg_attributes) (cal : 'e__186) _
                (loc : Ploc.t) ->
                    ...
                    Grammar.production
                      (Grammar.r_next Grammar.r_stop
                       ...
                       (fun (a : string) (loc : Ploc.t) ->
                          (Qast.VaVal (Qast.VaAnt ("list", loc, a)) :
                           'e__202)))])),
           (fun (ci : 'e__202) _ (ctcl : 'e__201) _ (loc : Ploc.t) ->
