   ...
   [Grammar.Entry.obj (module_expr : 'module_expr Grammar.Entry.e), None,
     ...
     [[Gramext.Stoken ("", ":");
      ...
      Gramext.action
        (fun (p : 'patt) _ (t : 'ctyp) _ (loc : Ploc.t) ->
           (Qast.Node ("PaTyc", [Qast.Loc; p; t]) : 'binding_with_patt));
      [Gramext.Stoken ("", "=");
       Gramext.Snterm (Grammar.Entry.obj (patt : 'patt Grammar.Entry.e))],
      Gramext.action
    ...
    [None, None,
     [[Gramext.Stoken ("", ":");
      ...
      Gramext.action
        (fun (e : 'expr) _ (t : 'ctyp) _ (loc : Ploc.t) ->
           (Qast.Node ("ExTyc", [Qast.Loc; e; t]) : 'binding_with_expr));
      [Gramext.Stoken ("", "=");
       Gramext.Snterm (Grammar.Entry.obj (expr : 'expr Grammar.Entry.e))],
      Gramext.action
    ...
    [None, None,
     [[Gramext.Snterm
      ...
      [Gramext.Sfacto
       ...
       Gramext.Sself],
      Gramext.action
        (fun (p : 'patt) (i : 'e__175) (loc : Ploc.t) ->
           (let _ = warning_deprecated_since_6_00 loc in
            Qast.Node
              ("PaLab",
               [Qast.Loc; Qast.Node ("PaLid", [Qast.Loc; i]);
      ...
      [Gramext.Stoken ("", "?"); Gramext.Stoken ("", "{"); Gramext.Sself;
         ...
         (Gramext.srules
            [[Gramext.Sopt
                (Gramext.Snterm
                   (Grammar.Entry.obj
                      (binding_with_expr :
                       'binding_with_expr Grammar.Entry.e)))],
             Gramext.action
               (fun (a : 'binding_with_expr option) (loc : Ploc.t) ->
       ...
       Gramext.Stoken ("", "}")],
      Gramext.action
        (fun _ (eo : 'e__174) (p : 'patt) _ _ (loc : Ploc.t) ->
      ...
      [Gramext.Stoken ("", "~"); Gramext.Stoken ("", "{"); Gramext.Sself;
         ...
         (Gramext.srules
            [[Gramext.Sopt
                (Gramext.Snterm
                   (Grammar.Entry.obj
                      (binding_with_patt :
                       'binding_with_patt Grammar.Entry.e)))],
             Gramext.action
               (fun (a : 'binding_with_patt option) (loc : Ploc.t) ->
                  (Qast.VaVal (Qast.Option a) : 'e__173));
             [Gramext.Stoken ("ANTIQUOT", "_opt")],
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
       ...
       Gramext.Stoken ("", "}")],
      Gramext.action
        (fun _ (po : 'e__173) (p : 'patt) _ _ (loc : Ploc.t) ->
     ...
     [[Gramext.Snterm
      ...
      [Gramext.Sfacto
         (Gramext.srules
            [[Gramext.Snterm
                (Grammar.Entry.obj (a_ti : 'a_ti Grammar.Entry.e))],
             Gramext.action (fun (a : 'a_ti) (loc : Ploc.t) -> (a : 'e__180));
             [Gramext.Stoken ("TILDEIDENT", "")],
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
      ...
      [Gramext.Sfacto
         (Gramext.srules
            [[Gramext.Snterm
                (Grammar.Entry.obj (a_tic : 'a_tic Grammar.Entry.e))],
             Gramext.action
               (fun (a : 'a_tic) (loc : Ploc.t) -> (a : 'e__179));
             [Gramext.Stoken ("TILDEIDENTCOLON", "")],
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
       ...
       Gramext.Sself],
      Gramext.action
        (fun (p : 'ipatt) (i : 'e__179) (loc : Ploc.t) ->
           (let _ = warning_deprecated_since_6_00 loc in
            Qast.Node
              ("PaLab",
               [Qast.Loc; Qast.Node ("PaLid", [Qast.Loc; i]);
      ...
      [Gramext.Stoken ("", "?"); Gramext.Stoken ("", "{"); Gramext.Sself;
       ...
       Gramext.Stoken ("", "}")],
      Gramext.action
        (fun _ (eo : 'e__178) (p : 'ipatt) _ _ (loc : Ploc.t) ->
      ...
      [Gramext.Stoken ("", "~"); Gramext.Stoken ("", "{"); Gramext.Sself;
       ...
       Gramext.Stoken ("", "}")],
      Gramext.action
        (fun _ (po : 'e__177) (p : 'ipatt) _ _ (loc : Ploc.t) ->
    ...
    [None, None,
     [[Gramext.Stoken ("", "?"); Gramext.Stoken ("", "(");
       Gramext.Sfacto
         (Gramext.srules
            [[Gramext.Stoken ("LIDENT", "")],
             ...
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
                  (Qast.VaVal (Qast.VaAnt ("lid", loc, a)) : 'e__193))]);
       Gramext.Stoken ("", ")")],
      Gramext.action
        (fun _ (i : 'e__193) _ _ (loc : Ploc.t) ->
           (Qast.Node
              ("PaOlb",
               [Qast.Loc; Qast.Node ("PaLid", [Qast.Loc; i]);
                Qast.VaVal (Qast.Option None)]) :
      ...
      [Gramext.Stoken ("", "?"); Gramext.Stoken ("", "(");
       ...
       Gramext.Stoken ("", ")")],
      Gramext.action
        (fun _ (e : 'expr) _ (i : 'e__192) _ _ (loc : Ploc.t) ->
           (Qast.Node
              ("PaOlb",
               [Qast.Loc; Qast.Node ("PaLid", [Qast.Loc; i]);
       ...
       Gramext.Sfacto
         (Gramext.srules
            [[Gramext.Stoken ("LIDENT", "")],
             ...
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
                  (Qast.VaVal (Qast.VaAnt ("lid", loc, a)) : 'e__191))]);
       Gramext.Stoken ("", ":");
       Gramext.Snterm (Grammar.Entry.obj (ctyp : 'ctyp Grammar.Entry.e));
       Gramext.Stoken ("", ")")],
      Gramext.action
        (fun _ (t : 'ctyp) _ (i : 'e__191) _ _ (loc : Ploc.t) ->
           (Qast.Node
              ("PaOlb",
               [Qast.Loc;
                Qast.Node
      ...
      [Gramext.Stoken ("", "?"); Gramext.Stoken ("", "(");
       ...
       Gramext.Stoken ("", ")")],
      Gramext.action
        (fun _ (e : 'expr) _ (t : 'ctyp) _ (i : 'e__190) _ _ (loc : Ploc.t) ->
           (Qast.Node
              ("PaOlb",
               [Qast.Loc; Qast.Node ("PaLid", [Qast.Loc; i]);
                Qast.VaVal
                  (Qast.Option
                     (Some (Qast.Node ("ExTyc", [Qast.Loc; e; t]))))]) :
            'patt_option_label));
      [Gramext.Sfacto
         (Gramext.srules
            [[Gramext.Snterm
                (Grammar.Entry.obj (a_qi : 'a_qi Grammar.Entry.e))],
             Gramext.action (fun (a : 'a_qi) (loc : Ploc.t) -> (a : 'e__189));
      ...
      [Gramext.Sfacto
       ...
       Gramext.Stoken ("", ")")],
      Gramext.action
        (fun _ (j : 'e__188) _ (i : 'e__187) (loc : Ploc.t) ->
           (Qast.Node
              ("PaOlb",
               [Qast.Loc; Qast.Node ("PaLid", [Qast.Loc; i]);
                Qast.VaVal
      ...
      [Gramext.Sfacto
       ...
       Gramext.Stoken ("", ")")],
      Gramext.action
        (fun _ (e : 'expr) _ (j : 'e__186) _ (i : 'e__185) (loc : Ploc.t) ->
           (Qast.Node
              ("PaOlb",
               [Qast.Loc; Qast.Node ("PaLid", [Qast.Loc; i]);
                Qast.VaVal
       ...
       Gramext.Sfacto
         (Gramext.srules
            [[Gramext.Stoken ("LIDENT", "")],
             ...
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
                  (Qast.VaVal (Qast.VaAnt ("lid", loc, a)) : 'e__184))]);
       Gramext.Stoken ("", ":");
       Gramext.Snterm (Grammar.Entry.obj (ctyp : 'ctyp Grammar.Entry.e));
       Gramext.Stoken ("", ")")],
      Gramext.action
        (fun _ (t : 'ctyp) _ (j : 'e__184) _ (i : 'e__183) (loc : Ploc.t) ->
           (Qast.Node
              ("PaOlb",
               [Qast.Loc; Qast.Node ("PaLid", [Qast.Loc; i]);
                Qast.VaVal
      ...
      [Gramext.Sfacto
         (Gramext.srules
            [[Gramext.Snterm
                (Grammar.Entry.obj (a_qic : 'a_qic Grammar.Entry.e))],
             Gramext.action
               (fun (a : 'a_qic) (loc : Ploc.t) -> (a : 'e__181));
             [Gramext.Stoken ("QUESTIONIDENTCOLON", "")],
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
       ...
       Gramext.Sfacto
         (Gramext.srules
            [[Gramext.Stoken ("LIDENT", "")],
             ...
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
                  (Qast.VaVal (Qast.VaAnt ("lid", loc, a)) : 'e__182))]);
       Gramext.Stoken ("", ":");
       Gramext.Snterm (Grammar.Entry.obj (ctyp : 'ctyp Grammar.Entry.e));
       Gramext.Stoken ("", "=");
       Gramext.Snterm (Grammar.Entry.obj (expr : 'expr Grammar.Entry.e));
       Gramext.Stoken ("", ")")],
      Gramext.action
        (fun _ (e : 'expr) _ (t : 'ctyp) _ (j : 'e__182) _ (i : 'e__181)
             (loc : Ploc.t) ->
           (Qast.Node
              ("PaOlb",
               [Qast.Loc; Qast.Node ("PaLid", [Qast.Loc; i]);
    ...
    [Some "label", Some Gramext.NonA,
     [[Gramext.Sfacto
         (Gramext.srules
            [[Gramext.Snterm
                (Grammar.Entry.obj (a_qi : 'a_qi Grammar.Entry.e))],
             Gramext.action (fun (a : 'a_qi) (loc : Ploc.t) -> (a : 'e__199));
             [Gramext.Stoken ("QUESTIONIDENT", "")],
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
      ...
      [Gramext.Sfacto
         (Gramext.srules
            [[Gramext.Snterm
                (Grammar.Entry.obj (a_qic : 'a_qic Grammar.Entry.e))],
             Gramext.action
               (fun (a : 'a_qic) (loc : Ploc.t) -> (a : 'e__198));
             [Gramext.Stoken ("QUESTIONIDENTCOLON", "")],
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
       ...
       Gramext.Sself],
      Gramext.action
        (fun (e : 'expr) (i : 'e__198) (loc : Ploc.t) ->
           (Qast.Node
              ("ExOlb",
               [Qast.Loc; Qast.Node ("PaLid", [Qast.Loc; i]);
                Qast.VaVal (Qast.Option (Some e))]) :
      ...
      [Gramext.Sfacto
       ...
       Gramext.Sself],
      Gramext.action
        (fun (e : 'expr) (i : 'e__196) (loc : Ploc.t) ->
           (Qast.Node
              ("ExLab",
               [Qast.Loc; Qast.Node ("PaLid", [Qast.Loc; i]);
                Qast.VaVal (Qast.Option (Some e))]) :
      ...
      [Gramext.Stoken ("", "?"); Gramext.Stoken ("", "{");
       ...
       Gramext.Stoken ("", "}")],
      Gramext.action
        (fun _ (eo : 'e__195) (p : 'patt) _ _ (loc : Ploc.t) ->
      ...
      [Gramext.Stoken ("", "~"); Gramext.Stoken ("", "{");
       ...
       Gramext.Stoken ("", "}")],
      Gramext.action
        (fun _ (eo : 'e__194) (p : 'patt) _ _ (loc : Ploc.t) ->
       ...
       Gramext.Sfacto
         (Gramext.srules
            [[Gramext.Snterm
                (Grammar.Entry.obj (ident : 'ident Grammar.Entry.e))],
             Gramext.action
               (fun (a : 'ident) (loc : Ploc.t) -> (Qast.VaVal a : 'e__200));
             [Gramext.Stoken ("ANTIQUOT", "_")],
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
