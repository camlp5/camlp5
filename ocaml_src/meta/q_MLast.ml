   ...
   [Grammar.Entry.obj (module_expr : 'module_expr Grammar.Entry.e), None,
      ...
      Gramext.action
        (fun (b : 'rebind_exn) (ctl : 'constructor_declaration) _
           ...
           (let (_, c, tl) =
              ...
              | _ -> raise (Match_failure ("q_MLast.ml", 334, 19))
            in
    ...
    [Some "top", None,
     ...
     [[Gramext.Stoken ("", "("); Gramext.Sself; Gramext.Stoken ("", ")")],
      ...
      [Gramext.Stoken ("", "object");
       ...
       Gramext.Stoken ("", "end")],
      Gramext.action
        (fun _ (cf : 'class_structure) (cspo : 'a_opt2) _ (loc : Ploc.t) ->
     ...
     [[Gramext.srules
         [[Gramext.Slist0
          ...
          Gramext.action
            (fun (a : 'a_list2) (loc : Ploc.t) -> (a : 'a_list2))]],
      Gramext.action
        (fun (cf : 'a_list2) (loc : Ploc.t) -> (cf : 'class_structure))]];
    ...
    [None, None,
     [[Gramext.Stoken ("", "["); Gramext.Stoken ("", "<");
       ...
       Gramext.Stoken ("", "]")],
      Gramext.action
        (fun _ (ntl : 'a_list2) _ (rfl : 'poly_variant_list) _ _
             (loc : Ploc.t) ->
           (Qast.Node
              ("TyVrn",
     ...
     [[Gramext.srules
         [[Gramext.Slist0sep
          ...
          Gramext.action
            (fun (a : 'a_list2) (loc : Ploc.t) -> (a : 'a_list2))]],
      Gramext.action
        (fun (rfl : 'a_list2) (loc : Ploc.t) -> (rfl : 'poly_variant_list))]];
       ...
       Gramext.srules
         [[Gramext.Slist1sep
          ...
          Gramext.action
            (fun (a : 'a_list2) (loc : Ploc.t) -> (a : 'a_list2))]],
      Gramext.action
        (fun (l : 'a_list2) (ao : 'a_flag2) _ (i : 'ident2) _
             (loc : Ploc.t) ->
    ...
    [None, None,
     [[Gramext.Stoken ("", "?"); Gramext.Stoken ("", "(");
       ...
       Gramext.Stoken ("", ")")],
      Gramext.action
        (fun _ (eo : 'a_opt2) (p : 'patt_tcon) _ _ (loc : Ploc.t) ->
           (Qast.Node
              ("PaOlb",
      ...
      [Gramext.Snterm
       ...
       Gramext.Stoken ("", ")")],
      Gramext.action
        (fun _ (eo : 'a_opt2) (p : 'patt_tcon) _ (i : 'questionidentcolon)
             (loc : Ploc.t) ->
           (Qast.Node
              ("PaOlb",
    ...
    [None, None,
     [[Gramext.Stoken ("", "?"); Gramext.Stoken ("", "(");
       ...
       Gramext.Stoken ("", ")")],
      Gramext.action
        (fun _ (eo : 'a_opt2) (p : 'ipatt_tcon) _ _ (loc : Ploc.t) ->
           (Qast.Node
              ("PaOlb",
               [Qast.Loc; Qast.VaVal (Qast.Str "");
                Qast.Option (Some (Qast.Tuple [p; eo]))]) :
      ...
      [Gramext.Snterm
       ...
       Gramext.Stoken ("", ")")],
      Gramext.action
        (fun _ (eo : 'a_opt2) (p : 'ipatt_tcon) _ (i : 'questionidentcolon)
             (loc : Ploc.t) ->
           (Qast.Node
              ("PaOlb",
               [Qast.Loc; i; Qast.Option (Some (Qast.Tuple [p; eo]))]) :
