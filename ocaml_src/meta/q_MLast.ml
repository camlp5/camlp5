        ...
        Grammar.production
          (Grammar.r_next
           ...
           (fun (i : 'e__34) _ (loc : Ploc.t) ->
              (Qast.Node ("StOpn", [Qast.Loc; i; Qast.VaVal(Qast.List[])]) : 'str_item)));
        Grammar.production
          (Grammar.r_next
             (Grammar.r_next
                (Grammar.r_next
        ...
        Grammar.production
          (Grammar.r_next
           ...
           (fun (me : 'module_expr) _ (loc : Ploc.t) ->
              (Qast.Node ("StInc", [Qast.Loc; me; Qast.VaVal(Qast.List[])]) : 'str_item)));
        Grammar.production
          (Grammar.r_next
             (Grammar.r_next
                (Grammar.r_next
                   ...
                   [Grammar.production
                    ...
                    Grammar.production
                      (Grammar.r_next Grammar.r_stop
                         (Grammar.s_token ("ANTIQUOT", "")),
                       (fun (a : string) (loc : Ploc.t) ->
                          (Qast.VaVal (Qast.VaAnt ("", loc, a)) : 'e__63)));
                    Grammar.production
                      (Grammar.r_next Grammar.r_stop
                         (Grammar.s_token ("ANTIQUOT", "_list")),
                       (fun (a : string) (loc : Ploc.t) ->
