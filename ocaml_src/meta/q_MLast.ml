      ...
      [None, Some Gramext.LeftA,
       ...
       [Grammar.production
          (Grammar.r_next
                      ...
                      [Grammar.production
                       ...
                       Grammar.production
                         (Grammar.r_next Grammar.r_stop
                          ...
                          "194fe98d",
                          (fun (a : string) (loc : Ploc.t) ->
                             (Qast.VaAnt ("_attribute", loc, a) : 'e__133)));
                       Grammar.production
                         (Grammar.r_next Grammar.r_stop
                            (Grammar.s_token ("ANTIQUOT", "attribute")),
                          "194fe98d",
             ...
             (Grammar.s_token ("", "]")),
           "194fe98d",
           (fun _ (attr : 'e__133) _ (p1 : 'patt) (loc : Ploc.t) ->
                   ...
                   [Grammar.production
                    ...
                    Grammar.production
                      (Grammar.r_next Grammar.r_stop
                       ...
                       "194fe98d",
                       (fun (a : string) (loc : Ploc.t) ->
                          (Qast.VaAnt ("_nativeint", loc, a) : 'e__137)));
                    Grammar.production
                      (Grammar.r_next Grammar.r_stop
                         (Grammar.s_token ("ANTIQUOT", "nativeint")),
                       "194fe98d",
                   ...
                   [Grammar.production
                    ...
                    Grammar.production
                      (Grammar.r_next Grammar.r_stop
                       ...
                       "194fe98d",
                       (fun (a : string) (loc : Ploc.t) ->
                          (Qast.VaAnt ("_int64", loc, a) : 'e__136)));
                    Grammar.production
                      (Grammar.r_next Grammar.r_stop
                         (Grammar.s_token ("ANTIQUOT", "int64")),
                       "194fe98d",
                   ...
                   [Grammar.production
                    ...
                    Grammar.production
                      (Grammar.r_next Grammar.r_stop
                       ...
                       "194fe98d",
                       (fun (a : string) (loc : Ploc.t) ->
                          (Qast.VaAnt ("_int32", loc, a) : 'e__135)));
                    Grammar.production
                      (Grammar.r_next Grammar.r_stop
                         (Grammar.s_token ("ANTIQUOT", "int32")),
                       "194fe98d",
       ...
       [Grammar.production
                   ...
                   [Grammar.production
                    ...
                    Grammar.production
                      (Grammar.r_next Grammar.r_stop
                       ...
                       "194fe98d",
                       (fun (a : string) (loc : Ploc.t) ->
                          (Qast.VaAnt ("_uidopt", loc, a) : 'e__154)));
                    Grammar.production
                      (Grammar.r_next Grammar.r_stop
                         (Grammar.s_token ("ANTIQUOT", "uidopt")),
                       "194fe98d",
        ...
        Grammar.production
          (Grammar.r_next
             ...
             (Grammar.s_nterm (module_type : 'module_type Grammar.Entry.e)),
           "194fe98d",
           (fun (mt : 'module_type) _ (s : 'e__153) _ (loc : Ploc.t) ->
              (Qast.Node ("PaUnp", [Qast.Loc; s; Qast.Option (Some mt)]) :
               'paren_ipatt)));
        Grammar.production
          (Grammar.r_next
       ...
       [Grammar.production
          (Grammar.r_next
                                     ...
                                     (Grammar.s_rules
                                        [Grammar.production
                                           (Grammar.r_next Grammar.r_stop
                                            ...
                                            "194fe98d",
                                            (fun _ (loc : Ploc.t) ->
                                               (Qast.Bool false : 'e__157)));
                                         Grammar.production
                                           (Grammar.r_next Grammar.r_stop
                                              (Grammar.s_token ("", "=")),
                                            "194fe98d",
                                            (fun _ (loc : Ploc.t) ->
                                               (Qast.Bool true : 'e__157)))]),
                                   "194fe98d",
                                   (fun (a : 'e__157) (loc : Ploc.t) ->
                                      (Qast.VaVal a : 'e__158)));
                                Grammar.production
                                  (Grammar.r_next Grammar.r_stop
                                     (Grammar.s_token
             ...
             (Grammar.s_nterm
                (item_attributes : 'item_attributes Grammar.Entry.e)),
           "194fe98d",
           (fun (attrs : 'item_attributes) (cl : 'e__160) (tk : 'ctyp)
                (pf : 'e__159) (isDecl : 'e__158) (tpl : 'e__156)
                (n : 'e__155) (loc : Ploc.t) ->
              (Qast.Record
       ...
       [Grammar.production
          (Grammar.r_next
             ...
             (Grammar.s_nterm
                (item_attributes : 'item_attributes Grammar.Entry.e)),
           "194fe98d",
           (fun (attrs : 'item_attributes) _ (ecs : 'e__164) _ (pf : 'e__163)
                _ (tpl : 'e__162) (n : 'e__161) (loc : Ploc.t) ->
              (Qast.Record
                      ...
                      (Grammar.r_next Grammar.r_stop
                       ...
                       (fun (a : string) (loc : Ploc.t) ->
                          (Qast.VaVal (Qast.VaAnt ("uid", loc, a)) :
                           'e__169)))])),
           "194fe98d",
           (fun (i : 'e__169) _ _ (me1 : 'longident) (loc : Ploc.t) ->
                      ...
                      (Grammar.r_next Grammar.r_stop
                       ...
                       (fun (a : string) (loc : Ploc.t) ->
                          (Qast.VaVal (Qast.VaAnt ("uid", loc, a)) :
                           'e__171)))])),
           "194fe98d",
           (fun (i : 'e__171) _ _ (me1 : 'extended_longident)
                (loc : Ploc.t) ->
                      ...
                      (Grammar.r_next Grammar.r_stop
                       ...
                       (fun (a : string) (loc : Ploc.t) ->
                          (Qast.VaVal (Qast.VaAnt ("lid", loc, a)) :
                           'e__173)))])),
           "194fe98d",
           (fun (i : 'e__173) _ (me1 : 'extended_longident) (loc : Ploc.t) ->
      ...
      [Some "top", Some Gramext.LeftA,
       [Grammar.production
          (Grammar.r_next
             ...
             Grammar.s_self,
           "194fe98d",
           (fun (t2 : 'ctyp) (pf : 'e__175) _ (t1 : 'ctyp) (loc : Ploc.t) ->
       ...
       [Grammar.production
          (Grammar.r_next
             ...
             (Grammar.s_token ("", "]")),
           "194fe98d",
           (fun _ (attr : 'e__176) _ (t1 : 'ctyp) (loc : Ploc.t) ->
       ...
       [Grammar.production
          (Grammar.r_next
             ...
             Grammar.s_self,
           "194fe98d",
           (fun (t : 'ctyp) _ (pl : 'e__178) _ (loc : Ploc.t) ->
        ...
        Grammar.production
          (Grammar.r_next
             ...
             Grammar.s_self,
           "194fe98d",
           (fun (t : 'ctyp) _ (pl : 'e__177) _ (loc : Ploc.t) ->
                      ...
                      (Grammar.r_next Grammar.r_stop
                       ...
                       (fun (a : string) (loc : Ploc.t) ->
                          (Qast.VaVal (Qast.VaAnt ("uid", loc, a)) :
                           'e__183)))])),
           "194fe98d",
           (fun (ci : 'e__183) (loc : Ploc.t) -> (ci : 'cons_ident)))]];
    Grammar.extension
      (constructor_declaration : 'constructor_declaration Grammar.Entry.e)
      None
      [None, None,
       ...
       [Grammar.production
          (Grammar.r_next
             ...
             (Grammar.s_nterm
                (alg_attributes : 'alg_attributes Grammar.Entry.e)),
           "194fe98d",
           (fun (alg_attrs : 'alg_attributes) (rto : 'e__188)
                (loc : Ploc.t) ->
        ...
        Grammar.production
          (Grammar.r_next
                                  ...
                                  [Grammar.production
                                     (Grammar.r_next
                                      ...
                                      (fun (t : 'ctyp) _ (loc : Ploc.t) ->
                                         (t : 'e__185)))])),
                          "194fe98d",
                          (fun (a : 'e__185 option) (loc : Ploc.t) ->
             ...
             (Grammar.s_nterm
                (alg_attributes : 'alg_attributes Grammar.Entry.e)),
           "194fe98d",
           (fun (alg_attrs : 'alg_attributes) (rto : 'e__186) (cal : 'e__184)
                _ (loc : Ploc.t) ->
        ...
        Grammar.production
          (Grammar.r_next
                      ...
                      [Grammar.production
                       ...
                       Grammar.production
                         (Grammar.r_next Grammar.r_stop
                          ...
                          "194fe98d",
                          (fun (a : string) (loc : Ploc.t) ->
                             (Qast.VaAnt ("_longid", loc, a) : 'e__189)));
                       Grammar.production
                         (Grammar.r_next Grammar.r_stop
                            (Grammar.s_token ("ANTIQUOT", "longid")),
                          "194fe98d",
             ...
             (Grammar.s_nterm
                (alg_attributes : 'alg_attributes Grammar.Entry.e)),
           "194fe98d",
           (fun (alg_attrs : 'alg_attributes) (b : 'e__189) _
       ...
       [Grammar.production
          (Grammar.r_next
           ...
           (fun (attrs : 'item_attributes) (cfb : 'class_fun_binding)
                (ctp : 'class_type_parameters) (i : 'e__195) (vf : 'e__194)
                (loc : Ploc.t) ->
              (Qast.Record
      ...
      [Some "top", None,
       [Grammar.production
          (Grammar.r_next
             ...
             Grammar.s_self,
           "194fe98d",
           (fun (ce : 'class_expr) _ (i : 'extended_longident) (ovf : 'e__199)
                _ _ (loc : Ploc.t) ->
        ...
        Grammar.production
          (Grammar.r_next
             ...
             Grammar.s_self,
           "194fe98d",
           (fun (ce : 'class_expr) _ (lb : 'e__198) (rf : 'e__197) _
                (loc : Ploc.t) ->
       ...
       [Grammar.production
          (Grammar.r_next
                      ...
                      [Grammar.production
                       ...
                       Grammar.production
                         (Grammar.r_next Grammar.r_stop
                          ...
                          "194fe98d",
                          (fun (a : string) (loc : Ploc.t) ->
                             (Qast.VaAnt ("_attribute", loc, a) : 'e__200)));
                       Grammar.production
                         (Grammar.r_next Grammar.r_stop
                            (Grammar.s_token ("ANTIQUOT", "attribute")),
                          "194fe98d",
             ...
             (Grammar.s_token ("", "]")),
           "194fe98d",
           (fun _ (attr : 'e__200) _ (t1 : 'class_expr) (loc : Ploc.t) ->
       ...
       [Grammar.production
          (Grammar.r_next
                      ...
                      [Grammar.production
                       ...
                       Grammar.production
                         (Grammar.r_next Grammar.r_stop
                          ...
                          "194fe98d",
                          (fun (a : string) (loc : Ploc.t) ->
                             (Qast.VaAnt ("_attribute", loc, a) : 'e__201)));
                       Grammar.production
                         (Grammar.r_next Grammar.r_stop
                            (Grammar.s_token ("ANTIQUOT", "attribute")),
                          "194fe98d",
             ...
             (Grammar.s_token ("", "]")),
           "194fe98d",
           (fun _ (attr : 'e__201) _ (t1 : 'class_expr) (loc : Ploc.t) ->
              (Qast.Node ("CeAtt", [Qast.Loc; t1; attr]) : 'class_expr)))];
       Some "simple", None,
       [Grammar.production
          (Grammar.r_next Grammar.r_stop
                      ...
                      (Grammar.r_next Grammar.r_stop
                       ...
                       (fun (a : string) (loc : Ploc.t) ->
                          (Qast.VaVal (Qast.VaAnt ("lilongid", loc, a)) :
                           'e__205)))])),
           "194fe98d",
           (fun (cli : 'e__205) _ (ctcl : 'e__204) _ (loc : Ploc.t) ->
        ...
        Grammar.production
          (Grammar.r_next
             ...
             (Grammar.s_token ("", "end")),
           "194fe98d",
           (fun _ (cf : 'class_structure) (cspo : 'e__203) _ (loc : Ploc.t) ->
                   ...
                   [Grammar.production
                    ...
                    Grammar.production
                      (Grammar.r_next Grammar.r_stop
                       ...
                       "194fe98d",
                       (fun (a : string) (loc : Ploc.t) ->
                          (Qast.VaAnt ("_lilongid", loc, a) : 'e__202)));
                    Grammar.production
                      (Grammar.r_next Grammar.r_stop
                         (Grammar.s_token ("ANTIQUOT", "lilongid")),
                       "194fe98d",
                      ...
                      (Grammar.r_next Grammar.r_stop
                       ...
                       (fun (a : string) (loc : Ploc.t) ->
                          (Qast.VaVal (Qast.VaAnt ("list", loc, a)) :
                           'e__207)))])),
           "194fe98d",
           (fun (cf : 'e__207) (loc : Ploc.t) -> (cf : 'class_structure)))]];
        ...
        Grammar.production
          (Grammar.r_next
             ...
             (Grammar.s_nterm
                (item_attributes : 'item_attributes Grammar.Entry.e)),
           "194fe98d",
           (fun (attrs : 'item_attributes) (e : 'fun_binding) (topt : 'e__222)
                (l : 'e__221) (pf : 'e__220) (ovf : 'e__219) _
                (loc : Ploc.t) ->
        ...
        Grammar.production
          (Grammar.r_next
             ...
             (Grammar.s_nterm
                (item_attributes : 'item_attributes Grammar.Entry.e)),
           "194fe98d",
           (fun (attrs : 'item_attributes) (t : 'ctyp) _ (lab : 'e__216)
                (mf : 'e__215) _ _ (loc : Ploc.t) ->
        ...
        Grammar.production
          (Grammar.r_next
           ...
           (fun (attrs : 'item_attributes) (e : 'cvalue_binding)
                (lab : 'e__214) (mf : 'e__213) (ovf : 'e__212) _
                (loc : Ploc.t) ->
        ...
        Grammar.production
          (Grammar.r_next
             ...
             (Grammar.s_nterm
                (item_attributes : 'item_attributes Grammar.Entry.e)),
           "194fe98d",
           (fun (attrs : 'item_attributes) (pb : 'e__211) (ce : 'class_expr)
                (ovf : 'e__210) _ (loc : Ploc.t) ->
      ...
      [Some "top", Some Gramext.RightA,
       [Grammar.production
          (Grammar.r_next
             ...
             Grammar.s_self,
           "194fe98d",
           (fun (ce : 'class_type) _ (i : 'extended_longident) (ovf : 'e__223)
                _ _ (loc : Ploc.t) ->
       ...
       [Grammar.production
          (Grammar.r_next
                      ...
                      [Grammar.production
                       ...
                       Grammar.production
                         (Grammar.r_next Grammar.r_stop
                          ...
                          "194fe98d",
                          (fun (a : string) (loc : Ploc.t) ->
                             (Qast.VaAnt ("_attribute", loc, a) : 'e__224)));
                       Grammar.production
                         (Grammar.r_next Grammar.r_stop
                            (Grammar.s_token ("ANTIQUOT", "attribute")),
                          "194fe98d",
             ...
             (Grammar.s_token ("", "]")),
           "194fe98d",
           (fun _ (attr : 'e__224) _ (t1 : 'class_type) (loc : Ploc.t) ->
       ...
       [Grammar.production
          (Grammar.r_next
             ...
             (Grammar.s_token ("", "]")),
           "194fe98d",
           (fun _ (tl : 'e__228) _ (ct : 'class_type) (loc : Ploc.t) ->
        ...
        Grammar.production
          (Grammar.r_next
             ...
             (Grammar.s_token ("", "end")),
           "194fe98d",
           (fun _ (csf : 'e__227) (cst : 'e__225) _ (loc : Ploc.t) ->
                      ...
                      (Grammar.r_next Grammar.r_stop
                       ...
                       (fun (a : string) (loc : Ploc.t) ->
                          (Qast.VaVal (Qast.VaAnt ("lid", loc, a)) :
                           'e__229)))])),
           "194fe98d",
           (fun (i : 'e__229) _ (li : 'extended_longident) (loc : Ploc.t) ->
        ...
        Grammar.production
          (Grammar.r_next
             ...
             (Grammar.s_nterm
                (item_attributes : 'item_attributes Grammar.Entry.e)),
           "194fe98d",
           (fun (attrs : 'item_attributes) (t : 'ctyp) _ (l : 'e__235)
                (vf : 'e__234) (mf : 'e__233) _ (loc : Ploc.t) ->
       ...
       [Grammar.production
          (Grammar.r_next
           ...
           (fun (attrs : 'item_attributes) (ct : 'class_type) _
                (ctp : 'class_type_parameters) (n : 'e__241) (vf : 'e__240)
                (loc : Ploc.t) ->
              (Qast.Record
      ...
      [None, Some Gramext.LeftA,
       [Grammar.production
          (Grammar.r_next
                      ...
                      (Grammar.s_rules
                         [Grammar.production
                            (Grammar.r_next Grammar.r_stop
                             ...
                             (fun (a : 'class_self_patt option)
                                  (loc : Ploc.t) ->
                                (Qast.VaVal (Qast.Option a) : 'e__245)));
                          Grammar.production
                            (Grammar.r_next Grammar.r_stop
                               (Grammar.s_token ("ANTIQUOT", "_opt")),
                             "194fe98d",
             ...
             (Grammar.s_token ("", "end")),
           "194fe98d",
           (fun _ (cf : 'class_structure) (cspo : 'e__245) _ (loc : Ploc.t) ->
                   ...
                   [Grammar.production
                    ...
                    Grammar.production
                      (Grammar.r_next Grammar.r_stop
                       ...
                       "194fe98d",
                       (fun (a : string) (loc : Ploc.t) ->
                          (Qast.VaAnt ("_lilongid", loc, a) : 'e__244)));
                    Grammar.production
                      (Grammar.r_next Grammar.r_stop
                         (Grammar.s_token ("ANTIQUOT", "lilongid")),
                       "194fe98d",
                      ...
                      (Grammar.r_next Grammar.r_stop
                       ...
                       (fun (a : string) (loc : Ploc.t) ->
                          (Qast.VaVal (Qast.VaAnt ("lid", loc, a)) :
                           'e__246)))])),
           "194fe98d",
           (fun (lab : 'e__246) _ (e : 'expr) (loc : Ploc.t) ->
      ...
      [None, None,
       [Grammar.production
          (Grammar.r_next
             ...
             (Grammar.s_token ("", ">")),
           "194fe98d",
           (fun _ (v : 'e__250) (ml : 'e__249) _ (loc : Ploc.t) ->
                   ...
                   [Grammar.production
                    ...
                    Grammar.production
                      (Grammar.r_next Grammar.r_stop
                       ...
                       "194fe98d",
                       (fun (a : string) (loc : Ploc.t) ->
                          (Qast.VaAnt ("_lilongid", loc, a) : 'e__248)));
                    Grammar.production
                      (Grammar.r_next Grammar.r_stop
                         (Grammar.s_token ("ANTIQUOT", "lilongid")),
                       "194fe98d",
                   ...
                   [Grammar.production
                    ...
                    Grammar.production
                      (Grammar.r_next Grammar.r_stop
                       ...
                       "194fe98d",
                       (fun (a : string) (loc : Ploc.t) ->
                          (Qast.VaVal (Qast.VaAnt ("", loc, a)) : 'e__253)));
                    Grammar.production
                      (Grammar.r_next Grammar.r_stop
                         (Grammar.s_token ("ANTIQUOT", "_lid")),
                       "194fe98d",
                         ...
                         [Grammar.production
                          ...
                          Grammar.production
                            (Grammar.r_next Grammar.r_stop
                             ...
                             "194fe98d",
                             (fun (a : string) (loc : Ploc.t) ->
                                (Qast.VaAnt ("_longid", loc, a) : 'e__251)));
                          Grammar.production
                            (Grammar.r_next Grammar.r_stop
                               (Grammar.s_token ("ANTIQUOT", "longid")),
                             "194fe98d",
                      ...
                      (Grammar.r_next Grammar.r_stop
                       ...
                       (fun (a : string) (loc : Ploc.t) ->
                          (Qast.VaVal (Qast.VaAnt ("lid", loc, a)) :
                           'e__252)))])),
           "194fe98d",
           (fun (i : 'e__252) _ (li : 'e__251) (loc : Ploc.t) ->
      ...
      [None, Some Gramext.NonA,
       [Grammar.production
          (Grammar.r_next
             ...
             Grammar.s_self,
           "194fe98d",
           (fun (t : 'ctyp) (i : 'e__258) (loc : Ploc.t) ->
        ...
        Grammar.production
          (Grammar.r_next
             ...
             Grammar.s_self,
           "194fe98d",
           (fun (t : 'ctyp) (i : 'e__257) (loc : Ploc.t) ->
      ...
      [None, None,
       [Grammar.production
          (Grammar.r_next
             ...
             (Grammar.s_token ("", "]")),
           "194fe98d",
           (fun _ (ntl : 'e__259) _ (rfl : 'poly_variant_list) _ _
                (loc : Ploc.t) ->
              (Qast.Node
                 ("TyVrn",
                  [Qast.Loc; rfl;
        ...
        Grammar.production
          (Grammar.r_next
             ...
             (Grammar.s_nterm
                (alg_attributes : 'alg_attributes Grammar.Entry.e)),
           "194fe98d",
           (fun (alg_attrs : 'alg_attributes) (l : 'e__264) (ao : 'e__263) _
                (i : 'e__262) _ (loc : Ploc.t) ->
        ...
        Grammar.production
          (Grammar.r_next
             ...
             (Grammar.s_nterm
                (alg_attributes : 'alg_attributes Grammar.Entry.e)),
           "194fe98d",
           (fun (alg_attrs : 'alg_attributes) (i : 'e__261) _
                (loc : Ploc.t) ->
              (Qast.Node
                 ("PvTag",
       ...
       [Grammar.production
                ...
                (Grammar.s_rules
                   [Grammar.production
                      (Grammar.r_next Grammar.r_stop
                       ...
                       "194fe98d",
                       (fun (a : 'a_ti) (loc : Ploc.t) -> (a : 'e__271)));
                    Grammar.production
                      (Grammar.r_next Grammar.r_stop
        ...
        Grammar.production
          (Grammar.r_next
                      ...
                      [Grammar.production
                         (Grammar.r_next Grammar.r_stop
                            (Grammar.s_nterm
                               (a_tic : 'a_tic Grammar.Entry.e)),
                          "194fe98d",
                          (fun (a : 'a_tic) (loc : Ploc.t) -> (a : 'e__270)));
                       Grammar.production
                         (Grammar.r_next Grammar.r_stop
                            (Grammar.s_token ("TILDEIDENTCOLON", "")),
                          "194fe98d",
             ...
             Grammar.s_self,
           "194fe98d",
           (fun (p : 'patt) (i : 'e__270) (loc : Ploc.t) ->
              (let _ = warning_deprecated_since_6_00 loc in
               Qast.Node
                 ("PaLab",
                  [Qast.Loc;
        ...
        Grammar.production
          (Grammar.r_next
                                  ...
                                  [Grammar.production
                                     (Grammar.r_next
                                      ...
                                      (fun (e : 'expr) _ (loc : Ploc.t) ->
                                         (e : 'e__268)))])),
                          "194fe98d",
                          (fun (a : 'e__268 option) (loc : Ploc.t) ->
             ...
             (Grammar.s_token ("", "}")),
           "194fe98d",
           (fun _ (eo : 'e__269) (p : 'patt_tcon) _ _ (loc : Ploc.t) ->
        ...
        Grammar.production
          (Grammar.r_next
             ...
             (Grammar.s_token ("", "}")),
           "194fe98d",
           (fun _ (lppo : 'e__267) _ _ (loc : Ploc.t) ->
                   ...
                   [Grammar.production
                    ...
                    Grammar.production
                      (Grammar.r_next Grammar.r_stop
                       ...
                       "194fe98d",
                       (fun (a : string) (loc : Ploc.t) ->
                          (Qast.VaAnt ("_lilongid", loc, a) : 'e__266)));
                    Grammar.production
                      (Grammar.r_next Grammar.r_stop
                         (Grammar.s_token ("ANTIQUOT", "lilongid")),
                       "194fe98d",
                               ...
                               [Grammar.production
                                  (Grammar.r_next
                                   ...
                                   (fun (p : 'patt) _ (loc : Ploc.t) ->
                                      (p : 'e__272)))])),
                       "194fe98d",
                       (fun (a : 'e__272 option) (loc : Ploc.t) ->
                      ...
                      (Grammar.r_next Grammar.r_stop
                       ...
                       (fun (a : string) (loc : Ploc.t) ->
                          (Qast.VaVal (Qast.VaAnt ("opt", loc, a)) :
                           'e__273)))])),
           "194fe98d",
           (fun (po : 'e__273) (p : 'patt_tcon) (loc : Ploc.t) ->
       ...
       [Grammar.production
                ...
                (Grammar.s_rules
                   [Grammar.production
                      (Grammar.r_next Grammar.r_stop
                         (Grammar.s_nterm (a_ti : 'a_ti Grammar.Entry.e)),
                       "194fe98d",
                       (fun (a : 'a_ti) (loc : Ploc.t) -> (a : 'e__278)));
                    Grammar.production
                      (Grammar.r_next Grammar.r_stop
                         (Grammar.s_token ("TILDEIDENT", "")),
                       "194fe98d",
        ...
        Grammar.production
          (Grammar.r_next
                      ...
                      [Grammar.production
                         (Grammar.r_next Grammar.r_stop
                            (Grammar.s_nterm
                               (a_tic : 'a_tic Grammar.Entry.e)),
                          "194fe98d",
                          (fun (a : 'a_tic) (loc : Ploc.t) -> (a : 'e__277)));
                       Grammar.production
                         (Grammar.r_next Grammar.r_stop
                            (Grammar.s_token ("TILDEIDENTCOLON", "")),
                          "194fe98d",
             ...
             Grammar.s_self,
           "194fe98d",
           (fun (p : 'ipatt) (i : 'e__277) (loc : Ploc.t) ->
              (let _ = warning_deprecated_since_6_00 loc in
               Qast.Node
                 ("PaLab",
                  [Qast.Loc;
        ...
        Grammar.production
          (Grammar.r_next
             ...
             (Grammar.s_token ("", "}")),
           "194fe98d",
           (fun _ (eo : 'e__276) (p : 'ipatt_tcon) _ _ (loc : Ploc.t) ->
        ...
        Grammar.production
          (Grammar.r_next
             ...
             (Grammar.s_token ("", "}")),
           "194fe98d",
           (fun _ (lppo : 'e__274) _ _ (loc : Ploc.t) ->
                      ...
                      (Grammar.r_next Grammar.r_stop
                       ...
                       (fun (a : string) (loc : Ploc.t) ->
                          (Qast.VaVal (Qast.VaAnt ("opt", loc, a)) :
                           'e__280)))])),
           "194fe98d",
           (fun (po : 'e__280) (p : 'ipatt_tcon) (loc : Ploc.t) ->
       ...
       [Grammar.production
        ...
        Grammar.production
          (Grammar.r_next
             ...
             (Grammar.s_token ("", ")")),
           "194fe98d",
           (fun _ (e : 'expr) _ (i : 'e__292) _ _ (loc : Ploc.t) ->
              (Qast.Node
                 ("PaOlb",
                  [Qast.Loc; Qast.Node ("PaLid", [Qast.Loc; i]);
        ...
        Grammar.production
          (Grammar.r_next
             ...
             (Grammar.s_token ("", ")")),
           "194fe98d",
           (fun _ (t : 'ctyp) _ (i : 'e__291) _ _ (loc : Ploc.t) ->
              (Qast.Node
                 ("PaOlb",
                  [Qast.Loc;
                   Qast.Node
        ...
        Grammar.production
          (Grammar.r_next
             ...
             (Grammar.s_token ("", ")")),
           "194fe98d",
           (fun _ (e : 'expr) _ (t : 'ctyp) _ (i : 'e__290) _ _
                (loc : Ploc.t) ->
              (Qast.Node
                 ("PaOlb",
                  [Qast.Loc;
        ...
        Grammar.production
          (Grammar.r_next
             ...
             (Grammar.s_token ("", ")")),
           "194fe98d",
           (fun _ (j : 'e__288) _ (i : 'e__287) (loc : Ploc.t) ->
              (Qast.Node
                 ("PaOlb",
                  [Qast.Loc; Qast.Node ("PaLid", [Qast.Loc; i]);
                   Qast.VaVal
        ...
        Grammar.production
          (Grammar.r_next
             ...
             (Grammar.s_token ("", ")")),
           "194fe98d",
           (fun _ (e : 'expr) _ (j : 'e__286) _ (i : 'e__285)
                (loc : Ploc.t) ->
              (Qast.Node
                 ("PaOlb",
                  [Qast.Loc; Qast.Node ("PaLid", [Qast.Loc; i]);
        ...
        Grammar.production
          (Grammar.r_next
             ...
             (Grammar.s_token ("", ")")),
           "194fe98d",
           (fun _ (t : 'ctyp) _ (j : 'e__284) _ (i : 'e__283)
                (loc : Ploc.t) ->
              (Qast.Node
                 ("PaOlb",
                  [Qast.Loc;
        ...
        Grammar.production
          (Grammar.r_next
             ...
             (Grammar.s_token ("", ")")),
           "194fe98d",
           (fun _ (e : 'expr) _ (t : 'ctyp) _ (j : 'e__282) _ (i : 'e__281)
                (loc : Ploc.t) ->
              (Qast.Node
                 ("PaOlb",
                  [Qast.Loc;
       ...
       [Grammar.production
                ...
                (Grammar.s_rules
                   [Grammar.production
                      (Grammar.r_next Grammar.r_stop
                         (Grammar.s_nterm (a_qi : 'a_qi Grammar.Entry.e)),
                       "194fe98d",
                       (fun (a : 'a_qi) (loc : Ploc.t) -> (a : 'e__299)));
                    Grammar.production
                      (Grammar.r_next Grammar.r_stop
                         (Grammar.s_token ("QUESTIONIDENT", "")),
                       "194fe98d",
                      ...
                      [Grammar.production
                         (Grammar.r_next Grammar.r_stop
                            (Grammar.s_nterm
                               (a_qic : 'a_qic Grammar.Entry.e)),
                          "194fe98d",
                          (fun (a : 'a_qic) (loc : Ploc.t) -> (a : 'e__298)));
                       Grammar.production
                         (Grammar.r_next Grammar.r_stop
                            (Grammar.s_token ("QUESTIONIDENTCOLON", "")),
                          "194fe98d",
                ...
                (Grammar.s_rules
                   [Grammar.production
                      (Grammar.r_next Grammar.r_stop
                         (Grammar.s_nterm (a_ti : 'a_ti Grammar.Entry.e)),
                       "194fe98d",
                       (fun (a : 'a_ti) (loc : Ploc.t) -> (a : 'e__297)));
                    Grammar.production
                      (Grammar.r_next Grammar.r_stop
                         (Grammar.s_token ("TILDEIDENT", "")),
                       "194fe98d",
        ...
        Grammar.production
          (Grammar.r_next
                      ...
                      [Grammar.production
                         (Grammar.r_next Grammar.r_stop
                            (Grammar.s_nterm
                               (a_tic : 'a_tic Grammar.Entry.e)),
                          "194fe98d",
                          (fun (a : 'a_tic) (loc : Ploc.t) -> (a : 'e__296)));
                       Grammar.production
                         (Grammar.r_next Grammar.r_stop
                            (Grammar.s_token ("TILDEIDENTCOLON", "")),
                          "194fe98d",
             ...
             Grammar.s_self,
           "194fe98d",
           (fun (e : 'expr) (i : 'e__296) (loc : Ploc.t) ->
              (let _ = warning_deprecated_since_6_00 loc in
               Qast.Node
                 ("ExLab",
                  [Qast.Loc;
        ...
        Grammar.production
          (Grammar.r_next
                      ...
                      [Grammar.production
                         (Grammar.r_next Grammar.r_stop
                          ...
                          (fun (a : 'fun_binding option) (loc : Ploc.t) ->
                             (Qast.VaVal (Qast.Option a) : 'e__295)));
                       Grammar.production
                         (Grammar.r_next Grammar.r_stop
                            (Grammar.s_token ("ANTIQUOT", "_opt")),
                          "194fe98d",
                          (fun (a : string) (loc : Ploc.t) ->
                             (Qast.VaAnt ("_opt", loc, a) : 'e__295)));
                       Grammar.production
                         (Grammar.r_next Grammar.r_stop
                            (Grammar.s_token ("ANTIQUOT", "opt")),
                          "194fe98d",
             ...
             (Grammar.s_token ("", "}")),
           "194fe98d",
           (fun _ (eo : 'e__295) (p : 'ipatt_tcon) _ _ (loc : Ploc.t) ->
        ...
        Grammar.production
          (Grammar.r_next
                      ...
                      [Grammar.production
                         (Grammar.r_next Grammar.r_stop
                          ...
                          (fun (a : 'ipatt_tcon_fun_binding list)
                               (loc : Ploc.t) ->
                             (Qast.VaVal (Qast.List a) : 'e__294)));
                       Grammar.production
                         (Grammar.r_next Grammar.r_stop
                            (Grammar.s_token ("ANTIQUOT", "_list")),
                          "194fe98d",
                          (fun (a : string) (loc : Ploc.t) ->
                             (Qast.VaAnt ("_list", loc, a) : 'e__294)));
                       Grammar.production
                         (Grammar.r_next Grammar.r_stop
                            (Grammar.s_token ("ANTIQUOT", "list")),
                          "194fe98d",
             ...
             (Grammar.s_token ("", "}")),
           "194fe98d",
           (fun _ (lpeo : 'e__294) _ _ (loc : Ploc.t) ->
                ...
                (Grammar.s_rules
                   [Grammar.production
                      (Grammar.r_next Grammar.r_stop
                       ...
                       "194fe98d",
                       (fun (a : 'fun_binding option) (loc : Ploc.t) ->
                          (Qast.VaVal (Qast.Option a) : 'e__300)));
                    Grammar.production
                      (Grammar.r_next Grammar.r_stop
                         (Grammar.s_token ("ANTIQUOT", "_opt")),
                       "194fe98d",
                       (fun (a : string) (loc : Ploc.t) ->
                          (Qast.VaAnt ("_opt", loc, a) : 'e__300)));
                    Grammar.production
                      (Grammar.r_next Grammar.r_stop
                         (Grammar.s_token ("ANTIQUOT", "opt")),
                       "194fe98d",
                       (fun (a : string) (loc : Ploc.t) ->
                          (Qast.VaVal (Qast.VaAnt ("opt", loc, a)) :
                           'e__300)))])),
           "194fe98d",
           (fun (eo : 'e__300) (p : 'ipatt_tcon) (loc : Ploc.t) ->
