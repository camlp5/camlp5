                ...
                (Gramext.srules
                   [[Gramext.Stoken ("", "=");
                     Gramext.Snterm
                       (Grammar.Entry.obj (patt : 'patt Grammar.Entry.e))],
                    Gramext.action
                      (fun (p : 'patt) _ (loc : Ploc.t) -> (p : 'e__200))])],
             Gramext.action
    ...
    [None, None,
     [[Gramext.Stoken ("", "?"); Gramext.Stoken ("", "(");
      ...
      [Gramext.Stoken ("", "?"); Gramext.Stoken ("", "(");
       ...
       Gramext.Stoken ("", ")")],
      Gramext.action
        (fun _ (e : 'expr) _ (i : 'e__217) _ _ (loc : Ploc.t) ->
           (Qast.Node
              ("PaOlb",
               [Qast.Loc; Qast.Node ("PaLid", [Qast.Loc; i]);
      ...
      [Gramext.Stoken ("", "?"); Gramext.Stoken ("", "(");
       ...
       Gramext.Stoken ("", ")")],
      Gramext.action
        (fun _ (t : 'ctyp) _ (i : 'e__216) _ _ (loc : Ploc.t) ->
           (Qast.Node
              ("PaOlb",
               [Qast.Loc;
                Qast.Node
      ...
      [Gramext.Stoken ("", "?"); Gramext.Stoken ("", "(");
       ...
       Gramext.Stoken ("", ")")],
      Gramext.action
        (fun _ (e : 'expr) _ (t : 'ctyp) _ (i : 'e__215) _ _ (loc : Ploc.t) ->
           (Qast.Node
              ("PaOlb",
               [Qast.Loc;
                Qast.Node
      ...
      [Gramext.Sfacto
         (Gramext.srules
            [[Gramext.Snterm
             ...
             Gramext.action (fun (a : 'a_qi) (loc : Ploc.t) -> (a : 'e__214));
      ...
      [Gramext.Sfacto
       ...
       Gramext.Stoken ("", ")")],
      Gramext.action
        (fun _ (j : 'e__213) _ (i : 'e__212) (loc : Ploc.t) ->
           (Qast.Node
              ("PaOlb",
               [Qast.Loc; Qast.Node ("PaLid", [Qast.Loc; i]);
                Qast.VaVal
      ...
      [Gramext.Sfacto
       ...
       Gramext.Stoken ("", ")")],
      Gramext.action
        (fun _ (e : 'expr) _ (j : 'e__211) _ (i : 'e__210) (loc : Ploc.t) ->
           (Qast.Node
              ("PaOlb",
               [Qast.Loc; Qast.Node ("PaLid", [Qast.Loc; i]);
                Qast.VaVal
      ...
      [Gramext.Sfacto
       ...
       Gramext.Stoken ("", ")")],
      Gramext.action
        (fun _ (t : 'ctyp) _ (j : 'e__209) _ (i : 'e__208) (loc : Ploc.t) ->
           (Qast.Node
              ("PaOlb",
               [Qast.Loc;
                Qast.Node
      ...
      [Gramext.Sfacto
       ...
       Gramext.Stoken ("", ")")],
      Gramext.action
        (fun _ (e : 'expr) _ (t : 'ctyp) _ (j : 'e__207) _ (i : 'e__206)
             (loc : Ploc.t) ->
           (Qast.Node
              ("PaOlb",
               [Qast.Loc;
    ...
    [Some "label", Some Gramext.NonA,
     [[Gramext.Sfacto
      ...
      [Gramext.Stoken ("", "?"); Gramext.Stoken ("", "{");
       ...
       Gramext.Stoken ("", "}")],
      Gramext.action
        (fun _ (eo : 'e__220) (p : 'ipatt_tcon) _ _ (loc : Ploc.t) ->
       ...
       Gramext.Sfacto
         (Gramext.srules
            [[Gramext.Slist1sep
             ...
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
                  (Qast.VaVal (Qast.VaAnt ("list", loc, a)) : 'e__219))]);
       Gramext.Stoken ("", "}")],
      Gramext.action
        (fun _ (lpeo : 'e__219) _ _ (loc : Ploc.t) ->
       ...
       Gramext.Sfacto
         (Gramext.srules
            [[Gramext.Sopt
             ...
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
                  (Qast.VaVal (Qast.VaAnt ("opt", loc, a)) : 'e__225))])],
      Gramext.action
        (fun (eo : 'e__225) (p : 'ipatt_tcon) (loc : Ploc.t) ->
       ...
       Gramext.Sfacto
         (Gramext.srules
            [[Gramext.Snterm
                (Grammar.Entry.obj (ident : 'ident Grammar.Entry.e))],
             Gramext.action
               (fun (a : 'ident) (loc : Ploc.t) -> (Qast.VaVal a : 'e__226));
             [Gramext.Stoken ("ANTIQUOT", "_")],
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
