       ...
       [Grammar.production
        ...
        Grammar.production
          (Grammar.r_next
             ...
             Grammar.s_self,
           "194fe98d",
           (fun (p : 'patt) (i : 'e__275) (loc : Ploc.t) ->
              (let _ = warning_deprecated_since_6_00 loc in
               Qast.Node
                 ("PaLab",
                  [Qast.Loc; Qast.Node ("PaLid", [Qast.Loc; i]);
        ...
        Grammar.production
          (Grammar.r_next
             ...
             (Grammar.s_token ("", "}")),
           "194fe98d",
           (fun _ (eo : 'e__274) (p : 'patt_tcon) _ _ (loc : Ploc.t) ->
        ...
        Grammar.production
          (Grammar.r_next
             ...
             (Grammar.s_token ("", "}")),
           "194fe98d",
           (fun _ (po : 'e__272) (p : 'patt_tcon) _ _ (loc : Ploc.t) ->
       ...
       [Grammar.production
        ...
        Grammar.production
          (Grammar.r_next
             ...
             (Grammar.s_token ("", "}")),
           "194fe98d",
           (fun _ (po : 'e__278) (p : 'ipatt_tcon) _ _ (loc : Ploc.t) ->
       ...
       [Grammar.production
        ...
        Grammar.production
          (Grammar.r_next
                   ...
                   (Grammar.s_rules
                      [Grammar.production
                         (Grammar.r_next Grammar.r_stop
                          ...
                          "194fe98d",
                          (fun (a : 'fun_binding option) (loc : Ploc.t) ->
                             (Qast.VaVal (Qast.Option a) : 'e__296)));
                       Grammar.production
                         (Grammar.r_next Grammar.r_stop
                            (Grammar.s_token ("ANTIQUOT", "_opt")),
                          "194fe98d",
                          (fun (a : string) (loc : Ploc.t) ->
                             (Qast.VaAnt ("_opt", loc, a) : 'e__296)));
                       Grammar.production
                         (Grammar.r_next Grammar.r_stop
                            (Grammar.s_token ("ANTIQUOT", "opt")),
                          "194fe98d",
             ...
             (Grammar.s_token ("", "}")),
           "194fe98d",
           (fun _ (eo : 'e__296) (p : 'ipatt_tcon) _ _ (loc : Ploc.t) ->
