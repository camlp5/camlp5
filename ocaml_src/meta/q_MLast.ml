      ...
      Gramext.action
        (fun (b : 'rebind_exn) (ctl : 'constructor_declaration) _
           ...
           (let (_, c, tl) =
              ...
              | _ -> raise (Match_failure ("q_MLast.ml", 333, 19))
            in
      ...
      [Gramext.Stoken ("", "declare");
       Gramext.srules
         [[Gramext.Slist0
          ...
          Gramext.action
            (fun (a : 'e__2 list) (loc : Ploc.t) -> (Qast.List a : 'a_list));
          [Gramext.Snterm
             (Grammar.Entry.obj (a_list : 'a_list Grammar.Entry.e))],
          Gramext.action (fun (a : 'a_list) (loc : Ploc.t) -> (a : 'a_list))];
       Gramext.Stoken ("", "end")],
      ...
      Gramext.action
        (fun (ctl : 'constructor_declaration) _ (loc : Ploc.t) ->
           (let (_, c, tl) =
              match ctl with
                Qast.Tuple [xx1; xx2; xx3] -> xx1, xx2, xx3
              | _ -> raise (Match_failure ("q_MLast.ml", 388, 19))
            in
      ...
      [Gramext.Stoken ("", "declare");
       Gramext.srules
         [[Gramext.Slist0
          ...
          Gramext.action
            (fun (a : 'e__4 list) (loc : Ploc.t) -> (Qast.List a : 'a_list));
          [Gramext.Snterm
             (Grammar.Entry.obj (a_list : 'a_list Grammar.Entry.e))],
          Gramext.action (fun (a : 'a_list) (loc : Ploc.t) -> (a : 'a_list))];
       Gramext.Stoken ("", "end")],
