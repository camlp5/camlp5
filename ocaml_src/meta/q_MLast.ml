                      ...
                      (Grammar.r_next Grammar.r_stop
                       ...
                       (fun (a : string) (loc : Ploc.t) ->
                          (Qast.VaVal (Qast.VaAnt ("uid", loc, a)) :
                           'e__190)))])),
           "194fe98d",
           (fun (ci : 'e__190) (loc : Ploc.t) -> (ci : 'cons_ident)))]];
    Grammar.extension
      (constructor_declaration : 'constructor_declaration Grammar.Entry.e)
      None
      [None, None,
      ...
      [None, None,
       [Grammar.production
          (Grammar.r_next
           ...
           "194fe98d",
           (fun (alg_attrs : 'alg_attributes) (rto : 'e__195)
                (loc : Ploc.t) ->
        ...
        Grammar.production
          (Grammar.r_next
                                  ...
                                  [Grammar.production
                                     (Grammar.r_next
                                      ...
                                      (fun (t : 'ctyp) _ (loc : Ploc.t) ->
                                         (t : 'e__192)))])),
                          "194fe98d",
                          (fun (a : 'e__192 option) (loc : Ploc.t) ->
             ...
             (Grammar.s_nterm
                (alg_attributes : 'alg_attributes Grammar.Entry.e)),
           "194fe98d",
           (fun (alg_attrs : 'alg_attributes) (rto : 'e__193) (cal : 'e__191)
        ...
        Grammar.production
          (Grammar.r_next
                      ...
                      [Grammar.production
                       ...
                       Grammar.production
                         (Grammar.r_next Grammar.r_stop
                          ...
                          "194fe98d",
                          (fun (a : string) (loc : Ploc.t) ->
                             (Qast.VaAnt ("_longid", loc, a) : 'e__196)));
                       Grammar.production
                         (Grammar.r_next Grammar.r_stop
                            (Grammar.s_token ("ANTIQUOT", "longid")),
                          "194fe98d",
             ...
             (Grammar.s_nterm
                (alg_attributes : 'alg_attributes Grammar.Entry.e)),
           "194fe98d",
           (fun (alg_attrs : 'alg_attributes) (b : 'e__196) _
       ...
       [Grammar.production
          (Grammar.r_next
           ...
           (fun (attrs : 'item_attributes) (cfb : 'class_fun_binding)
                (ctp : 'class_type_parameters) (i : 'e__202) (vf : 'e__201)
                (loc : Ploc.t) ->
              (Qast.Record
      ...
      [Some "top", None,
       [Grammar.production
          (Grammar.r_next
             ...
             Grammar.s_self,
           "194fe98d",
           (fun (ce : 'class_expr) _ (i : 'extended_longident) (ovf : 'e__206)
                _ _ (loc : Ploc.t) ->
        ...
        Grammar.production
          (Grammar.r_next
             ...
             Grammar.s_self,
           "194fe98d",
           (fun (ce : 'class_expr) _ (lb : 'e__205) (rf : 'e__204) _
                (loc : Ploc.t) ->
       ...
       [Grammar.production
          (Grammar.r_next
             ...
             (Grammar.s_token ("", "]")),
           "194fe98d",
           (fun _ (attr : 'e__208) _ (t1 : 'class_expr) (loc : Ploc.t) ->
              (Qast.Node ("CeAtt", [Qast.Loc; t1; attr]) : 'class_expr)))];
       Some "simple", None,
       [Grammar.production
          (Grammar.r_next Grammar.r_stop
                      ...
                      (Grammar.r_next Grammar.r_stop
                       ...
                       (fun (a : string) (loc : Ploc.t) ->
                          (Qast.VaVal (Qast.VaAnt ("lilongid", loc, a)) :
                           'e__212)))])),
           "194fe98d",
           (fun (cli : 'e__212) _ (ctcl : 'e__211) _ (loc : Ploc.t) ->
                   ...
                   [Grammar.production
                    ...
                    Grammar.production
                      (Grammar.r_next Grammar.r_stop
                       ...
                       "194fe98d",
                       (fun (a : string) (loc : Ploc.t) ->
                          (Qast.VaAnt ("_lilongid", loc, a) : 'e__209)));
                    Grammar.production
                      (Grammar.r_next Grammar.r_stop
                         (Grammar.s_token ("ANTIQUOT", "lilongid")),
                       "194fe98d",
                      ...
                      (Grammar.r_next Grammar.r_stop
                       ...
                       (fun (a : string) (loc : Ploc.t) ->
                          (Qast.VaVal (Qast.VaAnt ("list", loc, a)) :
                           'e__214)))])),
           "194fe98d",
           (fun (cf : 'e__214) (loc : Ploc.t) -> (cf : 'class_structure)))]];
        ...
        Grammar.production
          (Grammar.r_next
             ...
             (Grammar.s_nterm
                (item_attributes : 'item_attributes Grammar.Entry.e)),
           "194fe98d",
           (fun (attrs : 'item_attributes) (e : 'fun_binding) (topt : 'e__229)
                (l : 'e__228) (pf : 'e__227) (ovf : 'e__226) _
                (loc : Ploc.t) ->
        ...
        Grammar.production
          (Grammar.r_next
             ...
             (Grammar.s_nterm
                (item_attributes : 'item_attributes Grammar.Entry.e)),
           "194fe98d",
           (fun (attrs : 'item_attributes) (t : 'ctyp) _ (l : 'e__225)
                (pf : 'e__224) _ _ (loc : Ploc.t) ->
        ...
        Grammar.production
          (Grammar.r_next
             ...
             (Grammar.s_nterm
                (item_attributes : 'item_attributes Grammar.Entry.e)),
           "194fe98d",
           (fun (attrs : 'item_attributes) (t : 'ctyp) _ (lab : 'e__223)
                (mf : 'e__222) _ _ (loc : Ploc.t) ->
        ...
        Grammar.production
          (Grammar.r_next
           ...
           (fun (attrs : 'item_attributes) (e : 'cvalue_binding)
                (lab : 'e__221) (mf : 'e__220) (ovf : 'e__219) _
                (loc : Ploc.t) ->
        ...
        Grammar.production
          (Grammar.r_next
             ...
             (Grammar.s_nterm
                (item_attributes : 'item_attributes Grammar.Entry.e)),
           "194fe98d",
           (fun (attrs : 'item_attributes) (pb : 'e__218) (ce : 'class_expr)
                (ovf : 'e__217) _ (loc : Ploc.t) ->
      ...
      [Some "top", Some Gramext.RightA,
       [Grammar.production
          (Grammar.r_next
             ...
             Grammar.s_self,
           "194fe98d",
           (fun (ce : 'class_type) _ (i : 'extended_longident) (ovf : 'e__230)
                _ _ (loc : Ploc.t) ->
       ...
       [Grammar.production
          (Grammar.r_next
                      ...
                      [Grammar.production
                       ...
                       Grammar.production
                         (Grammar.r_next Grammar.r_stop
                          ...
                          "194fe98d",
                          (fun (a : string) (loc : Ploc.t) ->
                             (Qast.VaAnt ("_attribute", loc, a) : 'e__231)));
                       Grammar.production
                         (Grammar.r_next Grammar.r_stop
                            (Grammar.s_token ("ANTIQUOT", "attribute")),
                          "194fe98d",
             ...
             (Grammar.s_token ("", "]")),
           "194fe98d",
           (fun _ (attr : 'e__231) _ (t1 : 'class_type) (loc : Ploc.t) ->
       ...
       [Grammar.production
          (Grammar.r_next
             ...
             (Grammar.s_token ("", "]")),
           "194fe98d",
           (fun _ (tl : 'e__235) _ (ct : 'class_type) (loc : Ploc.t) ->
        ...
        Grammar.production
          (Grammar.r_next
             ...
             (Grammar.s_token ("", "end")),
           "194fe98d",
           (fun _ (csf : 'e__234) (cst : 'e__232) _ (loc : Ploc.t) ->
                      ...
                      (Grammar.r_next Grammar.r_stop
                       ...
                       (fun (a : string) (loc : Ploc.t) ->
                          (Qast.VaVal (Qast.VaAnt ("lid", loc, a)) :
                           'e__236)))])),
           "194fe98d",
           (fun (i : 'e__236) _ (li : 'extended_longident) (loc : Ploc.t) ->
        ...
        Grammar.production
          (Grammar.r_next
           ...
           (fun (attrs : 'item_attributes) (t : 'ctyp) _ (l : 'e__242)
                (vf : 'e__241) (mf : 'e__240) _ (loc : Ploc.t) ->
       ...
       [Grammar.production
          (Grammar.r_next
           ...
           (fun (attrs : 'item_attributes) (ct : 'class_type) _
                (ctp : 'class_type_parameters) (n : 'e__248) (vf : 'e__247)
                (loc : Ploc.t) ->
              (Qast.Record
      ...
      [None, Some Gramext.LeftA,
       [Grammar.production
          (Grammar.r_next
             ...
             (Grammar.s_token ("", "end")),
           "194fe98d",
           (fun _ (cf : 'class_structure) (cspo : 'e__252) _ (loc : Ploc.t) ->
                      ...
                      (Grammar.r_next Grammar.r_stop
                       ...
                       (fun (a : string) (loc : Ploc.t) ->
                          (Qast.VaVal (Qast.VaAnt ("lid", loc, a)) :
                           'e__253)))])),
           "194fe98d",
           (fun (lab : 'e__253) _ (e : 'expr) (loc : Ploc.t) ->
      ...
      [None, None,
       [Grammar.production
          (Grammar.r_next
             ...
             (Grammar.s_token ("", ">")),
           "194fe98d",
           (fun _ (v : 'e__257) (ml : 'e__256) _ (loc : Ploc.t) ->
                   ...
                   [Grammar.production
                    ...
                    Grammar.production
                      (Grammar.r_next Grammar.r_stop
                       ...
                       "194fe98d",
                       (fun (a : string) (loc : Ploc.t) ->
                          (Qast.VaAnt ("_lilongid", loc, a) : 'e__255)));
                    Grammar.production
                      (Grammar.r_next Grammar.r_stop
                         (Grammar.s_token ("ANTIQUOT", "lilongid")),
                       "194fe98d",
                         ...
                         [Grammar.production
                          ...
                          Grammar.production
                            (Grammar.r_next Grammar.r_stop
                             ...
                             "194fe98d",
                             (fun (a : string) (loc : Ploc.t) ->
                                (Qast.VaAnt ("_longid", loc, a) : 'e__258)));
                          Grammar.production
                            (Grammar.r_next Grammar.r_stop
                               (Grammar.s_token ("ANTIQUOT", "longid")),
                             "194fe98d",
                      ...
                      (Grammar.r_next Grammar.r_stop
                       ...
                       (fun (a : string) (loc : Ploc.t) ->
                          (Qast.VaVal (Qast.VaAnt ("lid", loc, a)) :
                           'e__259)))])),
           "194fe98d",
           (fun (i : 'e__259) _ (li : 'e__258) (loc : Ploc.t) ->
      ...
      [None, Some Gramext.NonA,
       [Grammar.production
          (Grammar.r_next
             ...
             Grammar.s_self,
           "194fe98d",
           (fun (t : 'ctyp) (i : 'e__265) (loc : Ploc.t) ->
      ...
      [None, None,
       [Grammar.production
          (Grammar.r_next
             ...
             (Grammar.s_token ("", "]")),
           "194fe98d",
           (fun _ (ntl : 'e__266) _ (rfl : 'poly_variant_list) _ _
                (loc : Ploc.t) ->
              (Qast.Node
                 ("TyVrn",
                  [Qast.Loc; rfl;
        ...
        Grammar.production
          (Grammar.r_next
             ...
             (Grammar.s_nterm
                (alg_attributes : 'alg_attributes Grammar.Entry.e)),
           "194fe98d",
           (fun (alg_attrs : 'alg_attributes) (l : 'e__271) (ao : 'e__270) _
                (i : 'e__269) _ (loc : Ploc.t) ->
        ...
        Grammar.production
          (Grammar.r_next
             ...
             (Grammar.s_nterm
                (alg_attributes : 'alg_attributes Grammar.Entry.e)),
           "194fe98d",
           (fun (alg_attrs : 'alg_attributes) (i : 'e__268) _
                (loc : Ploc.t) ->
              (Qast.Node
                 ("PvTag",
       ...
       [Grammar.production
                ...
                (Grammar.s_rules
                   [Grammar.production
                      (Grammar.r_next Grammar.r_stop
                       ...
                       "194fe98d",
                       (fun (a : 'a_ti) (loc : Ploc.t) -> (a : 'e__279)));
                    Grammar.production
                      (Grammar.r_next Grammar.r_stop
        ...
        Grammar.production
          (Grammar.r_next
                      ...
                      [Grammar.production
                         (Grammar.r_next Grammar.r_stop
                            (Grammar.s_nterm
                               (a_tic : 'a_tic Grammar.Entry.e)),
                          "194fe98d",
                          (fun (a : 'a_tic) (loc : Ploc.t) -> (a : 'e__278)));
                       Grammar.production
                         (Grammar.r_next Grammar.r_stop
                            (Grammar.s_token ("TILDEIDENTCOLON", "")),
                          "194fe98d",
             ...
             Grammar.s_self,
           "194fe98d",
           (fun (p : 'patt) (i : 'e__278) (loc : Ploc.t) ->
              (let _ = warning_deprecated_since_6_00 loc in
               Qast.Node
                 ("PaLab",
                  [Qast.Loc; Qast.Node ("PaLid", [Qast.Loc; i]);
        ...
        Grammar.production
          (Grammar.r_next
             ...
             (Grammar.s_token ("", "}")),
           "194fe98d",
           (fun _ (eo : 'e__277) (p : 'patt_tcon) _ _ (loc : Ploc.t) ->
        ...
        Grammar.production
          (Grammar.r_next
             ...
             (Grammar.s_token ("", "}")),
           "194fe98d",
           (fun _ (po : 'e__275) (p : 'patt_tcon) _ _ (loc : Ploc.t) ->
                   ...
                   [Grammar.production
                    ...
                    Grammar.production
                      (Grammar.r_next Grammar.r_stop
                       ...
                       "194fe98d",
                       (fun (a : string) (loc : Ploc.t) ->
                          (Qast.VaAnt ("_lilongid", loc, a) : 'e__273)));
                    Grammar.production
                      (Grammar.r_next Grammar.r_stop
                         (Grammar.s_token ("ANTIQUOT", "lilongid")),
                       "194fe98d",
       ...
       [Grammar.production
                ...
                (Grammar.s_rules
                   [Grammar.production
                      (Grammar.r_next Grammar.r_stop
                         (Grammar.s_nterm (a_ti : 'a_ti Grammar.Entry.e)),
                       "194fe98d",
                       (fun (a : 'a_ti) (loc : Ploc.t) -> (a : 'e__285)));
                    Grammar.production
                      (Grammar.r_next Grammar.r_stop
                         (Grammar.s_token ("TILDEIDENT", "")),
                       "194fe98d",
        ...
        Grammar.production
          (Grammar.r_next
                      ...
                      [Grammar.production
                         (Grammar.r_next Grammar.r_stop
                            (Grammar.s_nterm
                               (a_tic : 'a_tic Grammar.Entry.e)),
                          "194fe98d",
                          (fun (a : 'a_tic) (loc : Ploc.t) -> (a : 'e__284)));
                       Grammar.production
                         (Grammar.r_next Grammar.r_stop
                            (Grammar.s_token ("TILDEIDENTCOLON", "")),
                          "194fe98d",
             ...
             Grammar.s_self,
           "194fe98d",
           (fun (p : 'ipatt) (i : 'e__284) (loc : Ploc.t) ->
              (let _ = warning_deprecated_since_6_00 loc in
               Qast.Node
                 ("PaLab",
                  [Qast.Loc; Qast.Node ("PaLid", [Qast.Loc; i]);
        ...
        Grammar.production
          (Grammar.r_next
             ...
             (Grammar.s_token ("", "}")),
           "194fe98d",
           (fun _ (eo : 'e__283) (p : 'ipatt_tcon) _ _ (loc : Ploc.t) ->
        ...
        Grammar.production
          (Grammar.r_next
                                  ...
                                  [Grammar.production
                                     (Grammar.r_next
                                      ...
                                      (fun (p : 'patt) _ (loc : Ploc.t) ->
                                         (p : 'e__280)))])),
                          "194fe98d",
                          (fun (a : 'e__280 option) (loc : Ploc.t) ->
             ...
             (Grammar.s_token ("", "}")),
           "194fe98d",
           (fun _ (po : 'e__281) (p : 'ipatt_tcon) _ _ (loc : Ploc.t) ->
       ...
       [Grammar.production
        ...
        Grammar.production
          (Grammar.r_next
             ...
             (Grammar.s_token ("", ")")),
           "194fe98d",
           (fun _ (e : 'expr) _ (i : 'e__297) _ _ (loc : Ploc.t) ->
              (Qast.Node
                 ("PaOlb",
                  [Qast.Loc; Qast.Node ("PaLid", [Qast.Loc; i]);
        ...
        Grammar.production
          (Grammar.r_next
             ...
             (Grammar.s_token ("", ")")),
           "194fe98d",
           (fun _ (t : 'ctyp) _ (i : 'e__296) _ _ (loc : Ploc.t) ->
              (Qast.Node
                 ("PaOlb",
                  [Qast.Loc;
                   Qast.Node
        ...
        Grammar.production
          (Grammar.r_next
             ...
             (Grammar.s_token ("", ")")),
           "194fe98d",
           (fun _ (e : 'expr) _ (t : 'ctyp) _ (i : 'e__295) _ _
                (loc : Ploc.t) ->
              (Qast.Node
                 ("PaOlb",
                  [Qast.Loc;
                ...
                (Grammar.s_rules
                   [Grammar.production
                      (Grammar.r_next Grammar.r_stop
                       ...
                       "194fe98d",
                       (fun (a : 'a_qi) (loc : Ploc.t) -> (a : 'e__294)));
                    Grammar.production
                      (Grammar.r_next Grammar.r_stop
        ...
        Grammar.production
          (Grammar.r_next
             ...
             (Grammar.s_token ("", ")")),
           "194fe98d",
           (fun _ (j : 'e__293) _ (i : 'e__292) (loc : Ploc.t) ->
              (Qast.Node
                 ("PaOlb",
                  [Qast.Loc; Qast.Node ("PaLid", [Qast.Loc; i]);
                   Qast.VaVal
        ...
        Grammar.production
          (Grammar.r_next
             ...
             (Grammar.s_token ("", ")")),
           "194fe98d",
           (fun _ (e : 'expr) _ (j : 'e__291) _ (i : 'e__290)
                (loc : Ploc.t) ->
              (Qast.Node
                 ("PaOlb",
                  [Qast.Loc; Qast.Node ("PaLid", [Qast.Loc; i]);
        ...
        Grammar.production
          (Grammar.r_next
             ...
             (Grammar.s_token ("", ")")),
           "194fe98d",
           (fun _ (t : 'ctyp) _ (j : 'e__289) _ (i : 'e__288)
                (loc : Ploc.t) ->
              (Qast.Node
                 ("PaOlb",
                  [Qast.Loc;
        ...
        Grammar.production
          (Grammar.r_next
             ...
             (Grammar.s_token ("", ")")),
           "194fe98d",
           (fun _ (e : 'expr) _ (t : 'ctyp) _ (j : 'e__287) _ (i : 'e__286)
                (loc : Ploc.t) ->
              (Qast.Node
                 ("PaOlb",
                  [Qast.Loc;
       ...
       [Grammar.production
                ...
                (Grammar.s_rules
                   [Grammar.production
                      (Grammar.r_next Grammar.r_stop
                         (Grammar.s_nterm (a_qi : 'a_qi Grammar.Entry.e)),
                       "194fe98d",
                       (fun (a : 'a_qi) (loc : Ploc.t) -> (a : 'e__304)));
                    Grammar.production
                      (Grammar.r_next Grammar.r_stop
                         (Grammar.s_token ("QUESTIONIDENT", "")),
                       "194fe98d",
                      ...
                      [Grammar.production
                         (Grammar.r_next Grammar.r_stop
                            (Grammar.s_nterm
                               (a_qic : 'a_qic Grammar.Entry.e)),
                          "194fe98d",
                          (fun (a : 'a_qic) (loc : Ploc.t) -> (a : 'e__303)));
                       Grammar.production
                         (Grammar.r_next Grammar.r_stop
                            (Grammar.s_token ("QUESTIONIDENTCOLON", "")),
                          "194fe98d",
                ...
                (Grammar.s_rules
                   [Grammar.production
                      (Grammar.r_next Grammar.r_stop
                         (Grammar.s_nterm (a_ti : 'a_ti Grammar.Entry.e)),
                       "194fe98d",
                       (fun (a : 'a_ti) (loc : Ploc.t) -> (a : 'e__302)));
                    Grammar.production
                      (Grammar.r_next Grammar.r_stop
                         (Grammar.s_token ("TILDEIDENT", "")),
                       "194fe98d",
                      ...
                      [Grammar.production
                         (Grammar.r_next Grammar.r_stop
                            (Grammar.s_nterm
                               (a_tic : 'a_tic Grammar.Entry.e)),
                          "194fe98d",
                          (fun (a : 'a_tic) (loc : Ploc.t) -> (a : 'e__301)));
                       Grammar.production
                         (Grammar.r_next Grammar.r_stop
                            (Grammar.s_token ("TILDEIDENTCOLON", "")),
                          "194fe98d",
        ...
        Grammar.production
          (Grammar.r_next
             ...
             (Grammar.s_token ("", "}")),
           "194fe98d",
           (fun _ (eo : 'e__300) (p : 'ipatt_tcon) _ _ (loc : Ploc.t) ->
