                      ...
                      (Grammar.r_next Grammar.r_stop
                       ...
                       (fun (a : string) (loc : Ploc.t) ->
                          (Qast.VaVal (Qast.VaAnt ("list", loc, a)) :
                           'e__76)))])),
           "1154dceb",
           (fun (sil : 'e__76) (s : 'e__74) _ (loc : Ploc.t) ->
                ...
                (Grammar.s_rules
                   [Grammar.production
                      (Grammar.r_next Grammar.r_stop
                       ...
                       "1154dceb",
                       (fun (a : 'expr option) (loc : Ploc.t) ->
                          (Qast.VaVal (Qast.Option a) : 'e__73)));
                    Grammar.production
                      (Grammar.r_next Grammar.r_stop
                         (Grammar.s_token ("ANTIQUOT", "_opt")),
                       "1154dceb",
                      ...
                      (Grammar.r_next Grammar.r_stop
                       ...
                       (fun (a : string) (loc : Ploc.t) ->
                          (Qast.VaVal (Qast.VaAnt ("opt", loc, a)) :
                           'e__73)))])),
           "1154dceb",
           (fun (dp : 'e__73) (n : 'e__72) _ (loc : Ploc.t) ->
        ...
        Grammar.production
          (Grammar.r_next
             ...
             (Grammar.s_nterm
                (item_attributes : 'item_attributes Grammar.Entry.e)),
           "1154dceb",
           (fun (attrs : 'item_attributes) (t : 'ctyp) _ (i : 'e__71) _
                (loc : Ploc.t) ->
                      ...
                      (Grammar.r_next Grammar.r_stop
                       ...
                       (fun (a : string) (loc : Ploc.t) ->
                          (Qast.VaVal (Qast.VaAnt ("list", loc, a)) :
                           'e__70)))])),
           "1154dceb",
           (fun (tdl : 'e__70) (nrfl : 'e__69) _ _ (loc : Ploc.t) ->
                         ...
                         [Grammar.production
                          ...
                          Grammar.production
                            (Grammar.r_next Grammar.r_stop
                             ...
                             "1154dceb",
                             (fun (a : string) (loc : Ploc.t) ->
                                (Qast.VaAnt ("_uidopt", loc, a) : 'e__77)));
                          Grammar.production
                            (Grammar.r_next Grammar.r_stop
                               (Grammar.s_token ("ANTIQUOT", "uidopt")),
                             "1154dceb",
      ...
      [None, Some Gramext.RightA,
       [Grammar.production
          (Grammar.r_next
             ...
             Grammar.s_self,
           "1154dceb",
           (fun (mt : 'module_declaration) (arg : 'e__78) (loc : Ploc.t) ->
       ...
       [Grammar.production
        ...
        Grammar.production
          (Grammar.r_next
                         ...
                         [Grammar.production
                          ...
                          Grammar.production
                            (Grammar.r_next Grammar.r_stop
                             ...
                             "1154dceb",
                             (fun (a : string) (loc : Ploc.t) ->
                                (Qast.VaAnt ("_longid", loc, a) : 'e__84)));
                          Grammar.production
                            (Grammar.r_next Grammar.r_stop
                               (Grammar.s_token ("ANTIQUOT", "longid")),
                             "1154dceb",
             ...
             (Grammar.s_nterm (module_expr : 'module_expr Grammar.Entry.e)),
           "1154dceb",
           (fun (me : 'module_expr) _ (i : 'e__84) _ (loc : Ploc.t) ->
        ...
        Grammar.production
          (Grammar.r_next
             ...
             (Grammar.s_nterm (ctyp : 'ctyp Grammar.Entry.e)),
           "1154dceb",
           (fun (t : 'ctyp) _ (tpl : 'e__83) (lili : 'e__82) _
                (loc : Ploc.t) ->
        ...
        Grammar.production
          (Grammar.r_next
             ...
             (Grammar.s_nterm (ctyp : 'ctyp Grammar.Entry.e)),
           "1154dceb",
           (fun (t : 'ctyp) (pf : 'e__81) _ (tpl : 'e__80) (lili : 'e__79) _
                (loc : Ploc.t) ->
       ...
       [Grammar.production
        ...
        Grammar.production
          (Grammar.r_next
             ...
             Grammar.s_self,
           "1154dceb",
           (fun (e : 'expr) _ (m : 'module_expr) (ovf : 'e__93) _ _ _
                (loc : Ploc.t) ->
        ...
        Grammar.production
          (Grammar.r_next
             ...
             Grammar.s_self,
           "1154dceb",
           (fun (e : 'expr) _ (mb : 'mod_fun_binding) (m : 'e__92) _ _ _
                (loc : Ploc.t) ->
        ...
        Grammar.production
          (Grammar.r_next
             ...
             Grammar.s_self,
           "1154dceb",
           (fun (x : 'expr) _ (l : 'e__91) (r : 'e__90) _ _ (loc : Ploc.t) ->
        ...
        Grammar.production
          (Grammar.r_next
             ...
             Grammar.s_self,
           "1154dceb",
           (fun (x : 'expr) _ (alg_attrs : 'alg_attributes) (id : 'e__89) _ _
                _ (loc : Ploc.t) ->
              (Qast.Node
                 ("ExLEx",
        ...
        Grammar.production
          (Grammar.r_next
             ...
             Grammar.s_self,
           "1154dceb",
           (fun (x : 'expr) _ (alg_attrs : 'alg_attributes) (tyl : 'e__88) _
                (id : 'e__87) _ _ _ (loc : Ploc.t) ->
       ...
       [Grammar.production
        ...
        Grammar.production
          (Grammar.r_next
             ...
             (Grammar.s_token ("", "}")),
           "1154dceb",
           (fun _ (el : 'e__106) _ (op : 'e__105) (e : 'expr)
                (loc : Ploc.t) ->
        ...
        Grammar.production
          (Grammar.r_next
             ...
             (Grammar.s_token ("", "}")),
           "1154dceb",
           (fun _ (el : 'e__104) _ _ (e : 'expr) (loc : Ploc.t) ->
              (Qast.Node
        ...
        Grammar.production
          (Grammar.r_next
             ...
             (Grammar.s_token ("", ")")),
           "1154dceb",
           (fun _ (el : 'e__101) _ (op : 'e__100) (e1 : 'expr)
                (loc : Ploc.t) ->
       ...
       [Grammar.production
        ...
        Grammar.production
          (Grammar.r_next
             ...
             (Grammar.s_token ("", "}")),
           "1154dceb",
           (fun _ (lel : 'e__119) _ _ (e : 'expr) _ _ (loc : Ploc.t) ->
      ...
      [None, None,
       [Grammar.production
          (Grammar.r_next
             ...
             (Grammar.s_token ("", "end")),
           "1154dceb",
           (fun _ (l : 'e__122) _ (loc : Ploc.t) -> (l : 'closed_case_list)));
        Grammar.production
          (Grammar.r_next
             (Grammar.r_next
                (Grammar.r_next Grammar.r_stop (Grammar.s_token ("", "[")))
       ...
       [Grammar.production
        ...
        Grammar.production
          (Grammar.r_next
             ...
             Grammar.s_self,
           "1154dceb",
           (fun (el : 'sequence) _ (m : 'module_expr) (ovf : 'e__126) _ _
                (loc : Ploc.t) ->
              (Qast.List
                 [Qast.Node
        ...
        Grammar.production
          (Grammar.r_next
             ...
             Grammar.s_self,
           "1154dceb",
           (fun (el : 'sequence) _ (mb : 'mod_fun_binding) (m : 'e__125) _ _
                (loc : Ploc.t) ->
              (Qast.List
                 [Qast.Node
        ...
        Grammar.production
          (Grammar.r_next
                         ...
                         (Grammar.s_rules
                            [Grammar.production
                               (Grammar.r_next Grammar.r_stop
                                ...
                                "1154dceb",
                                (fun (a : bool) (loc : Ploc.t) ->
                                   (Qast.VaVal (Qast.Bool a) : 'e__123)));
                             Grammar.production
                               (Grammar.r_next Grammar.r_stop
                                  (Grammar.s_token ("ANTIQUOT", "_opt")),
                                "1154dceb",
                                (fun (a : string) (loc : Ploc.t) ->
                                   (Qast.VaAnt ("_opt", loc, a) : 'e__123)));
                             Grammar.production
                               (Grammar.r_next Grammar.r_stop
                                  (Grammar.s_token ("ANTIQUOT", "opt")),
                                "1154dceb",
             ...
             Grammar.s_self,
           "1154dceb",
           (fun (el : 'sequence) _ (l : 'e__124) (rf : 'e__123) _
                (loc : Ploc.t) ->
              (Qast.List
                 [Qast.Node
      ...
      [None, Some Gramext.LeftA,
       ...
       [Grammar.production
          (Grammar.r_next
                      ...
                      [Grammar.production
                       ...
                       Grammar.production
                         (Grammar.r_next Grammar.r_stop
                          ...
                          "1154dceb",
                          (fun (a : string) (loc : Ploc.t) ->
                             (Qast.VaAnt ("_attribute", loc, a) : 'e__130)));
                       Grammar.production
                         (Grammar.r_next Grammar.r_stop
                            (Grammar.s_token ("ANTIQUOT", "attribute")),
                          "1154dceb",
             ...
             (Grammar.s_token ("", "]")),
           "1154dceb",
           (fun _ (attr : 'e__130) _ (p1 : 'patt) (loc : Ploc.t) ->
                   ...
                   [Grammar.production
                    ...
                    Grammar.production
                      (Grammar.r_next Grammar.r_stop
                       ...
                       "1154dceb",
                       (fun (a : string) (loc : Ploc.t) ->
                          (Qast.VaAnt ("_nativeint", loc, a) : 'e__134)));
                    Grammar.production
                      (Grammar.r_next Grammar.r_stop
                         (Grammar.s_token ("ANTIQUOT", "nativeint")),
                       "1154dceb",
                   ...
                   [Grammar.production
                    ...
                    Grammar.production
                      (Grammar.r_next Grammar.r_stop
                       ...
                       "1154dceb",
                       (fun (a : string) (loc : Ploc.t) ->
                          (Qast.VaAnt ("_int64", loc, a) : 'e__133)));
                    Grammar.production
                      (Grammar.r_next Grammar.r_stop
                         (Grammar.s_token ("ANTIQUOT", "int64")),
                       "1154dceb",
                   ...
                   [Grammar.production
                    ...
                    Grammar.production
                      (Grammar.r_next Grammar.r_stop
                       ...
                       "1154dceb",
                       (fun (a : string) (loc : Ploc.t) ->
                          (Qast.VaAnt ("_int32", loc, a) : 'e__132)));
                    Grammar.production
                      (Grammar.r_next Grammar.r_stop
                         (Grammar.s_token ("ANTIQUOT", "int32")),
                       "1154dceb",
       ...
       [Grammar.production
                   ...
                   [Grammar.production
                    ...
                    Grammar.production
                      (Grammar.r_next Grammar.r_stop
                       ...
                       "1154dceb",
                       (fun (a : string) (loc : Ploc.t) ->
                          (Qast.VaAnt ("_uidopt", loc, a) : 'e__151)));
                    Grammar.production
                      (Grammar.r_next Grammar.r_stop
                         (Grammar.s_token ("ANTIQUOT", "uidopt")),
                       "1154dceb",
        ...
        Grammar.production
          (Grammar.r_next
                         ...
                         [Grammar.production
                          ...
                          Grammar.production
                            (Grammar.r_next Grammar.r_stop
                             ...
                             "1154dceb",
                             (fun (a : string) (loc : Ploc.t) ->
                                (Qast.VaAnt ("_uidopt", loc, a) : 'e__150)));
                          Grammar.production
                            (Grammar.r_next Grammar.r_stop
                               (Grammar.s_token ("ANTIQUOT", "uidopt")),
                             "1154dceb",
             ...
             (Grammar.s_nterm (module_type : 'module_type Grammar.Entry.e)),
           "1154dceb",
           (fun (mt : 'module_type) _ (s : 'e__150) _ (loc : Ploc.t) ->
              (Qast.Node ("PaUnp", [Qast.Loc; s; Qast.Option (Some mt)]) :
               'paren_ipatt)));
        Grammar.production
          (Grammar.r_next
       ...
       [Grammar.production
          (Grammar.r_next
             ...
             (Grammar.s_nterm
                (item_attributes : 'item_attributes Grammar.Entry.e)),
           "1154dceb",
           (fun (attrs : 'item_attributes) (cl : 'e__157) (tk : 'ctyp)
                (pf : 'e__156) (isDecl : 'e__155) (tpl : 'e__153)
                (n : 'e__152) (loc : Ploc.t) ->
              (Qast.Record
       ...
       [Grammar.production
          (Grammar.r_next
             ...
             (Grammar.s_nterm
                (item_attributes : 'item_attributes Grammar.Entry.e)),
           "1154dceb",
           (fun (attrs : 'item_attributes) _ (ecs : 'e__161) _ (pf : 'e__160)
                _ (tpl : 'e__159) (n : 'e__158) (loc : Ploc.t) ->
              (Qast.Record
                      ...
                      (Grammar.r_next Grammar.r_stop
                       ...
                       (fun (a : string) (loc : Ploc.t) ->
                          (Qast.VaVal (Qast.VaAnt ("uid", loc, a)) :
                           'e__166)))])),
           "1154dceb",
           (fun (i : 'e__166) _ _ (me1 : 'longident) (loc : Ploc.t) ->
       ...
       [Grammar.production
          (Grammar.r_next
                                  ...
                                  [Grammar.production
                                     (Grammar.r_next
                                      ...
                                      (fun (t : 'ctyp) _ (loc : Ploc.t) ->
                                         (t : 'e__184)))])),
                          "1154dceb",
                          (fun (a : 'e__184 option) (loc : Ploc.t) ->
             ...
             (Grammar.s_nterm
                (alg_attributes : 'alg_attributes Grammar.Entry.e)),
           "1154dceb",
           (fun (alg_attrs : 'alg_attributes) (rto : 'e__185)
                (loc : Ploc.t) ->
        ...
        Grammar.production
          (Grammar.r_next
                                  ...
                                  [Grammar.production
                                     (Grammar.r_next
                                      ...
                                      (fun (t : 'ctyp) _ (loc : Ploc.t) ->
                                         (t : 'e__182)))])),
                          "1154dceb",
                          (fun (a : 'e__182 option) (loc : Ploc.t) ->
             ...
             (Grammar.s_nterm
                (alg_attributes : 'alg_attributes Grammar.Entry.e)),
           "1154dceb",
           (fun (alg_attrs : 'alg_attributes) (rto : 'e__183) (cal : 'e__181)
                _ (loc : Ploc.t) ->
        ...
        Grammar.production
          (Grammar.r_next
                      ...
                      [Grammar.production
                       ...
                       Grammar.production
                         (Grammar.r_next Grammar.r_stop
                          ...
                          "1154dceb",
                          (fun (a : string) (loc : Ploc.t) ->
                             (Qast.VaAnt ("_longid", loc, a) : 'e__186)));
                       Grammar.production
                         (Grammar.r_next Grammar.r_stop
                            (Grammar.s_token ("ANTIQUOT", "longid")),
                          "1154dceb",
             ...
             (Grammar.s_nterm
                (alg_attributes : 'alg_attributes Grammar.Entry.e)),
           "1154dceb",
           (fun (alg_attrs : 'alg_attributes) (b : 'e__186) _
       ...
       [Grammar.production
          (Grammar.r_next
           ...
           (fun (attrs : 'item_attributes) (cfb : 'class_fun_binding)
                (ctp : 'class_type_parameters) (i : 'e__192) (vf : 'e__191)
                (loc : Ploc.t) ->
              (Qast.Record
      ...
      [Some "top", None,
       [Grammar.production
          (Grammar.r_next
             ...
             Grammar.s_self,
           "1154dceb",
           (fun (ce : 'class_expr) _ (i : 'extended_longident) (ovf : 'e__196)
                _ _ (loc : Ploc.t) ->
        ...
        Grammar.production
          (Grammar.r_next
             ...
             Grammar.s_self,
           "1154dceb",
           (fun (ce : 'class_expr) _ (lb : 'e__195) (rf : 'e__194) _
                (loc : Ploc.t) ->
       ...
       [Grammar.production
          (Grammar.r_next
             ...
             (Grammar.s_token ("", "]")),
           "1154dceb",
           (fun _ (attr : 'e__197) _ (t1 : 'class_expr) (loc : Ploc.t) ->
       ...
       [Grammar.production
          (Grammar.r_next
             ...
             (Grammar.s_token ("", "]")),
           "1154dceb",
           (fun _ (attr : 'e__198) _ (t1 : 'class_expr) (loc : Ploc.t) ->
              (Qast.Node ("CeAtt", [Qast.Loc; t1; attr]) : 'class_expr)))];
       Some "simple", None,
       [Grammar.production
          (Grammar.r_next Grammar.r_stop
                      ...
                      (Grammar.r_next Grammar.r_stop
                       ...
                       (fun (a : string) (loc : Ploc.t) ->
                          (Qast.VaVal (Qast.VaAnt ("lilongid", loc, a)) :
                           'e__202)))])),
           "1154dceb",
           (fun (cli : 'e__202) _ (ctcl : 'e__201) _ (loc : Ploc.t) ->
                      ...
                      (Grammar.r_next Grammar.r_stop
                       ...
                       (fun (a : string) (loc : Ploc.t) ->
                          (Qast.VaVal (Qast.VaAnt ("list", loc, a)) :
                           'e__204)))])),
           "1154dceb",
           (fun (cf : 'e__204) (loc : Ploc.t) -> (cf : 'class_structure)))]];
        ...
        Grammar.production
          (Grammar.r_next
             ...
             (Grammar.s_nterm
                (item_attributes : 'item_attributes Grammar.Entry.e)),
           "1154dceb",
           (fun (attrs : 'item_attributes) (e : 'fun_binding) (topt : 'e__219)
                (l : 'e__218) (pf : 'e__217) (ovf : 'e__216) _
                (loc : Ploc.t) ->
        ...
        Grammar.production
          (Grammar.r_next
             ...
             (Grammar.s_nterm
                (item_attributes : 'item_attributes Grammar.Entry.e)),
           "1154dceb",
           (fun (attrs : 'item_attributes) (t : 'ctyp) _ (lab : 'e__213)
                (mf : 'e__212) _ _ (loc : Ploc.t) ->
        ...
        Grammar.production
          (Grammar.r_next
           ...
           (fun (attrs : 'item_attributes) (e : 'cvalue_binding)
                (lab : 'e__211) (mf : 'e__210) (ovf : 'e__209) _
                (loc : Ploc.t) ->
        ...
        Grammar.production
          (Grammar.r_next
             ...
             (Grammar.s_nterm
                (item_attributes : 'item_attributes Grammar.Entry.e)),
           "1154dceb",
           (fun (attrs : 'item_attributes) (pb : 'e__208) (ce : 'class_expr)
                (ovf : 'e__207) _ (loc : Ploc.t) ->
      ...
      [Some "top", Some Gramext.RightA,
       [Grammar.production
          (Grammar.r_next
             ...
             Grammar.s_self,
           "1154dceb",
           (fun (ce : 'class_type) _ (i : 'extended_longident) (ovf : 'e__220)
                _ _ (loc : Ploc.t) ->
       ...
       [Grammar.production
          (Grammar.r_next
                      ...
                      [Grammar.production
                       ...
                       Grammar.production
                         (Grammar.r_next Grammar.r_stop
                          ...
                          "1154dceb",
                          (fun (a : string) (loc : Ploc.t) ->
                             (Qast.VaAnt ("_attribute", loc, a) : 'e__221)));
                       Grammar.production
                         (Grammar.r_next Grammar.r_stop
                            (Grammar.s_token ("ANTIQUOT", "attribute")),
                          "1154dceb",
             ...
             (Grammar.s_token ("", "]")),
           "1154dceb",
           (fun _ (attr : 'e__221) _ (t1 : 'class_type) (loc : Ploc.t) ->
       ...
       [Grammar.production
          (Grammar.r_next
             ...
             (Grammar.s_token ("", "]")),
           "1154dceb",
           (fun _ (tl : 'e__225) _ (ct : 'class_type) (loc : Ploc.t) ->
        ...
        Grammar.production
          (Grammar.r_next
             ...
             (Grammar.s_token ("", "end")),
           "1154dceb",
           (fun _ (csf : 'e__224) (cst : 'e__222) _ (loc : Ploc.t) ->
                      ...
                      (Grammar.r_next Grammar.r_stop
                       ...
                       (fun (a : string) (loc : Ploc.t) ->
                          (Qast.VaVal (Qast.VaAnt ("lid", loc, a)) :
                           'e__226)))])),
           "1154dceb",
           (fun (i : 'e__226) _ (li : 'extended_longident) (loc : Ploc.t) ->
        ...
        Grammar.production
          (Grammar.r_next
             ...
             (Grammar.s_nterm
                (item_attributes : 'item_attributes Grammar.Entry.e)),
           "1154dceb",
           (fun (attrs : 'item_attributes) (t : 'ctyp) _ (l : 'e__236)
                (pf : 'e__235) _ (loc : Ploc.t) ->
        ...
        Grammar.production
          (Grammar.r_next
             ...
             (Grammar.s_nterm
                (item_attributes : 'item_attributes Grammar.Entry.e)),
           "1154dceb",
           (fun (attrs : 'item_attributes) (t : 'ctyp) _ (l : 'e__234)
                (pf : 'e__233) _ _ (loc : Ploc.t) ->
        ...
        Grammar.production
          (Grammar.r_next
             ...
             (Grammar.s_nterm
                (item_attributes : 'item_attributes Grammar.Entry.e)),
           "1154dceb",
           (fun (attrs : 'item_attributes) (t : 'ctyp) _ (l : 'e__232)
                (vf : 'e__231) (mf : 'e__230) _ (loc : Ploc.t) ->
       ...
       [Grammar.production
          (Grammar.r_next
           ...
           (fun (attrs : 'item_attributes) (ct : 'class_type) _
                (ctp : 'class_type_parameters) (n : 'e__238) (vf : 'e__237)
                (loc : Ploc.t) ->
              (Qast.Record
      ...
      [None, None,
       [Grammar.production
          (Grammar.r_next
           ...
           "1154dceb",
           (fun (attrs : 'item_attributes) (cs : 'class_type) _
                (ctp : 'class_type_parameters) (n : 'e__240) (vf : 'e__239)
                (loc : Ploc.t) ->
              (Qast.Record
                 ["ciLoc", Qast.Loc; "ciVir", vf; "ciPrm", ctp; "ciNam", n;
      ...
      [None, Some Gramext.LeftA,
       [Grammar.production
          (Grammar.r_next
             ...
             (Grammar.s_token ("", "end")),
           "1154dceb",
           (fun _ (cf : 'class_structure) (cspo : 'e__242) _ (loc : Ploc.t) ->
                   ...
                   [Grammar.production
                    ...
                    Grammar.production
                      (Grammar.r_next Grammar.r_stop
                       ...
                       "1154dceb",
                       (fun (a : string) (loc : Ploc.t) ->
                          (Qast.VaAnt ("_lilongid", loc, a) : 'e__241)));
                    Grammar.production
                      (Grammar.r_next Grammar.r_stop
                         (Grammar.s_token ("ANTIQUOT", "lilongid")),
                       "1154dceb",
                      ...
                      (Grammar.r_next Grammar.r_stop
                       ...
                       (fun (a : string) (loc : Ploc.t) ->
                          (Qast.VaVal (Qast.VaAnt ("lid", loc, a)) :
                           'e__243)))])),
           "1154dceb",
           (fun (lab : 'e__243) _ (e : 'expr) (loc : Ploc.t) ->
      ...
      [None, None,
       [Grammar.production
          (Grammar.r_next
             ...
             (Grammar.s_token ("", ">")),
           "1154dceb",
           (fun _ (v : 'e__247) (ml : 'e__246) _ (loc : Ploc.t) ->
                   ...
                   [Grammar.production
                    ...
                    Grammar.production
                      (Grammar.r_next Grammar.r_stop
                       ...
                       "1154dceb",
                       (fun (a : string) (loc : Ploc.t) ->
                          (Qast.VaAnt ("_lilongid", loc, a) : 'e__245)));
                    Grammar.production
                      (Grammar.r_next Grammar.r_stop
                         (Grammar.s_token ("ANTIQUOT", "lilongid")),
                       "1154dceb",
                   ...
                   [Grammar.production
                    ...
                    Grammar.production
                      (Grammar.r_next Grammar.r_stop
                       ...
                       "1154dceb",
                       (fun (a : string) (loc : Ploc.t) ->
                          (Qast.VaVal (Qast.VaAnt ("", loc, a)) : 'e__250)));
                    Grammar.production
                      (Grammar.r_next Grammar.r_stop
                         (Grammar.s_token ("ANTIQUOT", "_lid")),
                       "1154dceb",
                         ...
                         [Grammar.production
                          ...
                          Grammar.production
                            (Grammar.r_next Grammar.r_stop
                             ...
                             "1154dceb",
                             (fun (a : string) (loc : Ploc.t) ->
                                (Qast.VaAnt ("_longid", loc, a) : 'e__248)));
                          Grammar.production
                            (Grammar.r_next Grammar.r_stop
                               (Grammar.s_token ("ANTIQUOT", "longid")),
                             "1154dceb",
                      ...
                      (Grammar.r_next Grammar.r_stop
                       ...
                       (fun (a : string) (loc : Ploc.t) ->
                          (Qast.VaVal (Qast.VaAnt ("lid", loc, a)) :
                           'e__249)))])),
           "1154dceb",
           (fun (i : 'e__249) _ (li : 'e__248) (loc : Ploc.t) ->
      ...
      [None, Some Gramext.NonA,
       [Grammar.production
          (Grammar.r_next
                   ...
                   (Grammar.s_rules
                      [Grammar.production
                         (Grammar.r_next Grammar.r_stop
                          ...
                          "1154dceb",
                          (fun (a : 'a_qic) (loc : Ploc.t) -> (a : 'e__252)));
                       Grammar.production
                         (Grammar.r_next Grammar.r_stop
             ...
             Grammar.s_self,
           "1154dceb",
           (fun (t : 'ctyp) (i : 'e__252) (loc : Ploc.t) ->
        ...
        Grammar.production
          (Grammar.r_next
                   ...
                   (Grammar.s_rules
                      [Grammar.production
                         (Grammar.r_next Grammar.r_stop
                          ...
                          "1154dceb",
                          (fun (a : 'a_tic) (loc : Ploc.t) -> (a : 'e__251)));
                       Grammar.production
                         (Grammar.r_next Grammar.r_stop
             ...
             Grammar.s_self,
           "1154dceb",
           (fun (t : 'ctyp) (i : 'e__251) (loc : Ploc.t) ->
      ...
      [None, None,
       [Grammar.production
          (Grammar.r_next
             ...
             (Grammar.s_token ("", "]")),
           "1154dceb",
           (fun _ (ntl : 'e__253) _ (rfl : 'poly_variant_list) _ _
                (loc : Ploc.t) ->
              (Qast.Node
                 ("TyVrn",
                  [Qast.Loc; rfl;
        ...
        Grammar.production
          (Grammar.r_next
             ...
             (Grammar.s_nterm
                (alg_attributes : 'alg_attributes Grammar.Entry.e)),
           "1154dceb",
           (fun (alg_attrs : 'alg_attributes) (l : 'e__258) (ao : 'e__257) _
                (i : 'e__256) _ (loc : Ploc.t) ->
        ...
        Grammar.production
          (Grammar.r_next
             ...
             (Grammar.s_nterm
                (alg_attributes : 'alg_attributes Grammar.Entry.e)),
           "1154dceb",
           (fun (alg_attrs : 'alg_attributes) (i : 'e__255) _
                (loc : Ploc.t) ->
              (Qast.Node
                 ("PvTag",
       ...
       [Grammar.production
        ...
        Grammar.production
          (Grammar.r_next
             ...
             Grammar.s_self,
           "1154dceb",
           (fun (p : 'patt) (i : 'e__264) (loc : Ploc.t) ->
              (let _ = warning_deprecated_since_6_00 loc in
               Qast.Node
                 ("PaLab",
                  [Qast.Loc;
        ...
        Grammar.production
          (Grammar.r_next
             ...
             (Grammar.s_token ("", "}")),
           "1154dceb",
           (fun _ (eo : 'e__263) (p : 'patt_tcon) _ _ (loc : Ploc.t) ->
        ...
        Grammar.production
          (Grammar.r_next
             ...
             (Grammar.s_token ("", "}")),
           "1154dceb",
           (fun _ (lppo : 'e__261) _ _ (loc : Ploc.t) ->
                   ...
                   [Grammar.production
                    ...
                    Grammar.production
                      (Grammar.r_next Grammar.r_stop
                       ...
                       "1154dceb",
                       (fun (a : string) (loc : Ploc.t) ->
                          (Qast.VaAnt ("_lilongid", loc, a) : 'e__260)));
                    Grammar.production
                      (Grammar.r_next Grammar.r_stop
                         (Grammar.s_token ("ANTIQUOT", "lilongid")),
                       "1154dceb",
                               ...
                               [Grammar.production
                                  (Grammar.r_next
                                   ...
                                   (fun (p : 'patt) _ (loc : Ploc.t) ->
                                      (p : 'e__266)))])),
                       "1154dceb",
                       (fun (a : 'e__266 option) (loc : Ploc.t) ->
                      ...
                      (Grammar.r_next Grammar.r_stop
                       ...
                       (fun (a : string) (loc : Ploc.t) ->
                          (Qast.VaVal (Qast.VaAnt ("opt", loc, a)) :
                           'e__267)))])),
           "1154dceb",
           (fun (po : 'e__267) (p : 'patt_tcon) (loc : Ploc.t) ->
       ...
       [Grammar.production
                ...
                (Grammar.s_rules
                   [Grammar.production
                      (Grammar.r_next Grammar.r_stop
                         (Grammar.s_nterm (a_ti : 'a_ti Grammar.Entry.e)),
                       "1154dceb",
                       (fun (a : 'a_ti) (loc : Ploc.t) -> (a : 'e__272)));
                    Grammar.production
                      (Grammar.r_next Grammar.r_stop
                         (Grammar.s_token ("TILDEIDENT", "")),
                       "1154dceb",
        ...
        Grammar.production
          (Grammar.r_next
                      ...
                      [Grammar.production
                         (Grammar.r_next Grammar.r_stop
                            (Grammar.s_nterm
                               (a_tic : 'a_tic Grammar.Entry.e)),
                          "1154dceb",
                          (fun (a : 'a_tic) (loc : Ploc.t) -> (a : 'e__271)));
                       Grammar.production
                         (Grammar.r_next Grammar.r_stop
                            (Grammar.s_token ("TILDEIDENTCOLON", "")),
                          "1154dceb",
             ...
             Grammar.s_self,
           "1154dceb",
           (fun (p : 'ipatt) (i : 'e__271) (loc : Ploc.t) ->
              (let _ = warning_deprecated_since_6_00 loc in
               Qast.Node
                 ("PaLab",
                  [Qast.Loc;
        ...
        Grammar.production
          (Grammar.r_next
             ...
             (Grammar.s_token ("", "}")),
           "1154dceb",
           (fun _ (eo : 'e__270) (p : 'ipatt_tcon) _ _ (loc : Ploc.t) ->
        ...
        Grammar.production
          (Grammar.r_next
             ...
             (Grammar.s_token ("", "}")),
           "1154dceb",
           (fun _ (lppo : 'e__268) _ _ (loc : Ploc.t) ->
                               ...
                               [Grammar.production
                                  (Grammar.r_next
                                   ...
                                   (fun (p : 'patt) _ (loc : Ploc.t) ->
                                      (p : 'e__273)))])),
                       "1154dceb",
                       (fun (a : 'e__273 option) (loc : Ploc.t) ->
                      ...
                      (Grammar.r_next Grammar.r_stop
                       ...
                       (fun (a : string) (loc : Ploc.t) ->
                          (Qast.VaVal (Qast.VaAnt ("opt", loc, a)) :
                           'e__274)))])),
           "1154dceb",
           (fun (po : 'e__274) (p : 'ipatt_tcon) (loc : Ploc.t) ->
       ...
       [Grammar.production
        ...
        Grammar.production
          (Grammar.r_next
             ...
             (Grammar.s_token ("", ")")),
           "1154dceb",
           (fun _ (e : 'expr) _ (i : 'e__286) _ _ (loc : Ploc.t) ->
              (Qast.Node
                 ("PaOlb",
                  [Qast.Loc; Qast.Node ("PaLid", [Qast.Loc; i]);
        ...
        Grammar.production
          (Grammar.r_next
             ...
             (Grammar.s_token ("", ")")),
           "1154dceb",
           (fun _ (t : 'ctyp) _ (i : 'e__285) _ _ (loc : Ploc.t) ->
              (Qast.Node
                 ("PaOlb",
                  [Qast.Loc;
                   Qast.Node
        ...
        Grammar.production
          (Grammar.r_next
             ...
             (Grammar.s_token ("", ")")),
           "1154dceb",
           (fun _ (e : 'expr) _ (t : 'ctyp) _ (i : 'e__284) _ _
                (loc : Ploc.t) ->
              (Qast.Node
                 ("PaOlb",
                  [Qast.Loc;
                ...
                (Grammar.s_rules
                   [Grammar.production
                      (Grammar.r_next Grammar.r_stop
                       ...
                       "1154dceb",
                       (fun (a : 'a_qi) (loc : Ploc.t) -> (a : 'e__283)));
                    Grammar.production
                      (Grammar.r_next Grammar.r_stop
        ...
        Grammar.production
          (Grammar.r_next
             ...
             (Grammar.s_token ("", ")")),
           "1154dceb",
           (fun _ (j : 'e__282) _ (i : 'e__281) (loc : Ploc.t) ->
              (Qast.Node
                 ("PaOlb",
                  [Qast.Loc; Qast.Node ("PaLid", [Qast.Loc; i]);
                   Qast.VaVal
        ...
        Grammar.production
          (Grammar.r_next
             ...
             (Grammar.s_token ("", ")")),
           "1154dceb",
           (fun _ (e : 'expr) _ (j : 'e__280) _ (i : 'e__279)
                (loc : Ploc.t) ->
              (Qast.Node
                 ("PaOlb",
                  [Qast.Loc; Qast.Node ("PaLid", [Qast.Loc; i]);
        ...
        Grammar.production
          (Grammar.r_next
             ...
             (Grammar.s_token ("", ")")),
           "1154dceb",
           (fun _ (t : 'ctyp) _ (j : 'e__278) _ (i : 'e__277)
                (loc : Ploc.t) ->
              (Qast.Node
                 ("PaOlb",
                  [Qast.Loc;
        ...
        Grammar.production
          (Grammar.r_next
             ...
             (Grammar.s_token ("", ")")),
           "1154dceb",
           (fun _ (e : 'expr) _ (t : 'ctyp) _ (j : 'e__276) _ (i : 'e__275)
                (loc : Ploc.t) ->
              (Qast.Node
                 ("PaOlb",
                  [Qast.Loc;
       ...
       [Grammar.production
                ...
                (Grammar.s_rules
                   [Grammar.production
                      (Grammar.r_next Grammar.r_stop
                         (Grammar.s_nterm (a_qi : 'a_qi Grammar.Entry.e)),
                       "1154dceb",
                       (fun (a : 'a_qi) (loc : Ploc.t) -> (a : 'e__293)));
                    Grammar.production
                      (Grammar.r_next Grammar.r_stop
                         (Grammar.s_token ("QUESTIONIDENT", "")),
                       "1154dceb",
        ...
        Grammar.production
          (Grammar.r_next
                      ...
                      [Grammar.production
                         (Grammar.r_next Grammar.r_stop
                            (Grammar.s_nterm
                               (a_qic : 'a_qic Grammar.Entry.e)),
                          "1154dceb",
                          (fun (a : 'a_qic) (loc : Ploc.t) -> (a : 'e__292)));
                       Grammar.production
                         (Grammar.r_next Grammar.r_stop
                            (Grammar.s_token ("QUESTIONIDENTCOLON", "")),
                          "1154dceb",
             ...
             Grammar.s_self,
           "1154dceb",
           (fun (e : 'expr) (i : 'e__292) (loc : Ploc.t) ->
              (let _ = warning_deprecated_since_6_00 loc in
               Qast.Node
                 ("ExOlb",
                  [Qast.Loc; Qast.Node ("PaLid", [Qast.Loc; i]);
                ...
                (Grammar.s_rules
                   [Grammar.production
                      (Grammar.r_next Grammar.r_stop
                         (Grammar.s_nterm (a_ti : 'a_ti Grammar.Entry.e)),
                       "1154dceb",
                       (fun (a : 'a_ti) (loc : Ploc.t) -> (a : 'e__291)));
                    Grammar.production
                      (Grammar.r_next Grammar.r_stop
                         (Grammar.s_token ("TILDEIDENT", "")),
                       "1154dceb",
        ...
        Grammar.production
          (Grammar.r_next
                      ...
                      [Grammar.production
                         (Grammar.r_next Grammar.r_stop
                            (Grammar.s_nterm
                               (a_tic : 'a_tic Grammar.Entry.e)),
                          "1154dceb",
                          (fun (a : 'a_tic) (loc : Ploc.t) -> (a : 'e__290)));
                       Grammar.production
                         (Grammar.r_next Grammar.r_stop
                            (Grammar.s_token ("TILDEIDENTCOLON", "")),
                          "1154dceb",
             ...
             Grammar.s_self,
           "1154dceb",
           (fun (e : 'expr) (i : 'e__290) (loc : Ploc.t) ->
              (let _ = warning_deprecated_since_6_00 loc in
               Qast.Node
                 ("ExLab",
                  [Qast.Loc;
        ...
        Grammar.production
          (Grammar.r_next
                      ...
                      [Grammar.production
                         (Grammar.r_next Grammar.r_stop
                          ...
                          (fun (a : 'fun_binding option) (loc : Ploc.t) ->
                             (Qast.VaVal (Qast.Option a) : 'e__289)));
                       Grammar.production
                         (Grammar.r_next Grammar.r_stop
                            (Grammar.s_token ("ANTIQUOT", "_opt")),
                          "1154dceb",
                          (fun (a : string) (loc : Ploc.t) ->
                             (Qast.VaAnt ("_opt", loc, a) : 'e__289)));
                       Grammar.production
                         (Grammar.r_next Grammar.r_stop
                            (Grammar.s_token ("ANTIQUOT", "opt")),
                          "1154dceb",
             ...
             (Grammar.s_token ("", "}")),
           "1154dceb",
           (fun _ (eo : 'e__289) (p : 'ipatt_tcon) _ _ (loc : Ploc.t) ->
        ...
        Grammar.production
          (Grammar.r_next
                      ...
                      [Grammar.production
                         (Grammar.r_next Grammar.r_stop
                          ...
                          (fun (a : 'ipatt_tcon_fun_binding list)
                               (loc : Ploc.t) ->
                             (Qast.VaVal (Qast.List a) : 'e__288)));
                       Grammar.production
                         (Grammar.r_next Grammar.r_stop
                            (Grammar.s_token ("ANTIQUOT", "_list")),
                          "1154dceb",
                          (fun (a : string) (loc : Ploc.t) ->
                             (Qast.VaAnt ("_list", loc, a) : 'e__288)));
                       Grammar.production
                         (Grammar.r_next Grammar.r_stop
                            (Grammar.s_token ("ANTIQUOT", "list")),
                          "1154dceb",
             ...
             (Grammar.s_token ("", "}")),
           "1154dceb",
           (fun _ (lpeo : 'e__288) _ _ (loc : Ploc.t) ->
                ...
                (Grammar.s_rules
                   [Grammar.production
                      (Grammar.r_next Grammar.r_stop
                       ...
                       "1154dceb",
                       (fun (a : 'fun_binding option) (loc : Ploc.t) ->
                          (Qast.VaVal (Qast.Option a) : 'e__294)));
                    Grammar.production
                      (Grammar.r_next Grammar.r_stop
                         (Grammar.s_token ("ANTIQUOT", "_opt")),
                       "1154dceb",
                       (fun (a : string) (loc : Ploc.t) ->
                          (Qast.VaAnt ("_opt", loc, a) : 'e__294)));
                    Grammar.production
                      (Grammar.r_next Grammar.r_stop
                         (Grammar.s_token ("ANTIQUOT", "opt")),
                       "1154dceb",
                       (fun (a : string) (loc : Ploc.t) ->
                          (Qast.VaVal (Qast.VaAnt ("opt", loc, a)) :
                           'e__294)))])),
           "1154dceb",
           (fun (eo : 'e__294) (p : 'ipatt_tcon) (loc : Ploc.t) ->
