   ...
   [Grammar.Entry.obj (module_expr : 'module_expr Grammar.Entry.e), None,
       ...
       Gramext.srules
         [[Gramext.Slist1sep
             (Gramext.Snterm
              ...
              Gramext.Stoken ("", "and"))],
          Gramext.action
            (fun (a : 'mod_binding list) (loc : int * int) ->
               (Qast.List a : 'a_list));
          [Gramext.Snterm
             (Grammar.Entry.obj (a_list : 'a_list Grammar.Entry.e))],
          Gramext.action
    ...
    [None, None,
     [[Gramext.Snterm
      ...
      Gramext.action
        (fun (me : 'mod_fun_binding) (i : 'a_UIDENT) (loc : int * int) ->
       ...
       Gramext.srules
         [[Gramext.Slist1sep
             (Gramext.Snterm
              ...
              Gramext.Stoken ("", "and"))],
          Gramext.action
            (fun (a : 'mod_decl_binding list) (loc : int * int) ->
               (Qast.List a : 'a_list));
          [Gramext.Snterm
             (Grammar.Entry.obj (a_list : 'a_list Grammar.Entry.e))],
          Gramext.action
            (fun (a : 'a_list) (loc : int * int) -> (a : 'a_list))]],
      Gramext.action
        (fun (l : 'a_list) (rf : 'a_opt) _ (loc : int * int) ->
    ...
    [None, None,
     [[Gramext.Snterm
      ...
      Gramext.action
        (fun (mt : 'module_declaration) (i : 'a_UIDENT) (loc : int * int) ->
                ...
                [[Gramext.Stoken ("", "virtual")],
                 Gramext.action
                   (fun (x : string) (loc : int * int) ->
                      (Qast.Str x : 'e__13))])],
          Gramext.action
            (fun (a : 'e__13 option) (loc : int * int) ->
               (Qast.Option a : 'a_opt));
          [Gramext.Snterm
             (Grammar.Entry.obj (a_opt : 'a_opt Grammar.Entry.e))],
          Gramext.action
                ...
                [[Gramext.Stoken ("", "rec")],
                 Gramext.action
                   (fun (x : string) (loc : int * int) ->
                      (Qast.Str x : 'e__14))])],
          Gramext.action
            (fun (a : 'e__14 option) (loc : int * int) ->
               (Qast.Option a : 'a_opt));
          [Gramext.Snterm
             (Grammar.Entry.obj (a_opt : 'a_opt Grammar.Entry.e))],
          Gramext.action
                ...
                [[Gramext.Stoken ("", "private")],
                 Gramext.action
                   (fun (x : string) (loc : int * int) ->
                      (Qast.Str x : 'e__19))])],
          Gramext.action
            (fun (a : 'e__19 option) (loc : int * int) ->
               (Qast.Option a : 'a_opt));
          [Gramext.Snterm
             (Grammar.Entry.obj (a_opt : 'a_opt Grammar.Entry.e))],
          Gramext.action
                ...
                [[Gramext.Stoken ("", "private")],
                 Gramext.action
                   (fun (x : string) (loc : int * int) ->
                      (Qast.Str x : 'e__18))])],
          Gramext.action
            (fun (a : 'e__18 option) (loc : int * int) ->
               (Qast.Option a : 'a_opt));
          [Gramext.Snterm
             (Grammar.Entry.obj (a_opt : 'a_opt Grammar.Entry.e))],
          Gramext.action
                ...
                [[Gramext.Stoken ("", "..")],
                 Gramext.action
                   (fun (x : string) (loc : int * int) ->
                      (Qast.Str x : 'e__27))])],
          Gramext.action
            (fun (a : 'e__27 option) (loc : int * int) ->
               (Qast.Option a : 'a_opt));
          [Gramext.Snterm
             (Grammar.Entry.obj (a_opt : 'a_opt Grammar.Entry.e))],
          Gramext.action
                ...
                [[Gramext.Stoken ("", "&")],
                 Gramext.action
                   (fun (x : string) (loc : int * int) ->
                      (Qast.Str x : 'e__28))])],
          Gramext.action
            (fun (a : 'e__28 option) (loc : int * int) ->
               (Qast.Option a : 'a_opt));
          [Gramext.Snterm
             (Grammar.Entry.obj (a_opt : 'a_opt Grammar.Entry.e))],
          Gramext.action
         ...
         [[Gramext.Slist0
             (Gramext.srules
                [[Gramext.Snterm
                  ...
                  Gramext.Stoken ("", ";")],
                 Gramext.action
                   (fun _ (e : 'expr) (loc : int * int) -> (e : 'e__31))])],
          Gramext.action
         ...
         [[Gramext.Slist0
             (Gramext.srules
                [[Gramext.Snterm
                  ...
                  Gramext.Stoken ("", ";")],
                 Gramext.action
                   (fun _ (e : 'expr) (loc : int * int) -> (e : 'e__30))])],
          Gramext.action
