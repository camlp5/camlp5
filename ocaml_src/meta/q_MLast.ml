   ...
   [Grammar.Entry.obj (module_expr : 'module_expr Grammar.Entry.e), None,
    ...
    [None, None,
     [[Gramext.Stoken ("", "functor"); Gramext.Stoken ("", "(");
       ...
       Gramext.Stoken ("", "->"); Gramext.Sself],
      Gramext.action
        (fun (mt : 'module_type) _ _ (t : 'module_type) _ (i : 'e__22) _ _
             (loc : Ploc.t) ->
     ...
     [[Gramext.Sself; Gramext.Stoken ("", "with");
      ...
      Gramext.action
        (fun (wcl : 'e__23) _ (mt : 'module_type) (loc : Ploc.t) ->
       ...
       Gramext.Sfacto
         (Gramext.srules
            [[Gramext.Snterm
             ...
             Gramext.action
               (fun (a : 'ident) (loc : Ploc.t) -> (Qast.VaVal a : 'e__26));
             [Gramext.Stoken ("ANTIQUOT", "_")],
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
      ...
      [Gramext.Sfacto
         (Gramext.srules
            [[Gramext.Stoken ("LIDENT", "")],
             ...
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
                  (Qast.VaAnt ("_lid", loc, a) : 'e__25));
             [Gramext.Stoken ("ANTIQUOT", "lid")],
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
                  (Qast.VaVal (Qast.VaAnt ("lid", loc, a)) : 'e__25))])],
      Gramext.action
     ...
     [[Gramext.Sfacto
         (Gramext.srules
            [[Gramext.Slist0
             ...
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
                  (Qast.VaVal (Qast.VaAnt ("list", loc, a)) : 'e__28))])],
      Gramext.action
        (fun (st : 'e__28) (loc : Ploc.t) -> (st : 'signature))]];
    ...
    [Some "top", None,
     [[Gramext.Stoken ("", "#");
       Gramext.Sfacto
         (Gramext.srules
            [[Gramext.Stoken ("LIDENT", "")],
             ...
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
                  (Qast.VaVal (Qast.VaAnt ("lid", loc, a)) : 'e__39))]);
       Gramext.Sfacto
         (Gramext.srules
            [[Gramext.Sopt
                (Gramext.Snterm
             ...
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
                  (Qast.VaVal (Qast.VaAnt ("opt", loc, a)) : 'e__40))])],
      Gramext.action
      ...
      [Gramext.Stoken ("", "value");
       ...
       Gramext.Snterm (Grammar.Entry.obj (ctyp : 'ctyp Grammar.Entry.e))],
      Gramext.action
        (fun (t : 'ctyp) _ (i : 'e__38) _ (loc : Ploc.t) ->
       ...
       Gramext.Sfacto
         (Gramext.srules
            [[Gramext.Snterm
             ...
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
                  (Qast.VaVal (Qast.VaAnt ("", loc, a)) : 'e__36));
             [Gramext.Stoken ("ANTIQUOT", "_list")],
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
       ...
       Gramext.Sfacto
         (Gramext.srules
            [[Gramext.Stoken ("UIDENT", "")],
             ...
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
                  (Qast.VaAnt ("_uid", loc, a) : 'e__35));
             [Gramext.Stoken ("ANTIQUOT", "uid")],
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
                  (Qast.VaVal (Qast.VaAnt ("uid", loc, a)) : 'e__35))]);
       Gramext.Stoken ("", "=");
       Gramext.Snterm
         (Grammar.Entry.obj (module_type : 'module_type Grammar.Entry.e))],
      Gramext.action
        (fun (mt : 'module_type) _ (i : 'e__35) _ _ (loc : Ploc.t) ->
       ...
       Gramext.Sfacto
         (Gramext.srules
            [[Gramext.Sflag (Gramext.Stoken ("", "rec"))],
             ...
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
                  (Qast.VaVal (Qast.VaAnt ("opt", loc, a)) : 'e__33));
             [Gramext.Stoken ("ANTIQUOT", "_flag")],
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
             ...
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
                  (Qast.VaVal (Qast.VaAnt ("flag", loc, a)) : 'e__33))]);
       Gramext.Sfacto
         (Gramext.srules
            [[Gramext.Slist1sep
                (Gramext.Snterm
      ...
      Gramext.action
        (fun (l : 'e__34) (rf : 'e__33) _ (loc : Ploc.t) ->
       ...
       Gramext.Sfacto
         (Gramext.srules
            [[Gramext.Stoken ("LIDENT", "")],
             ...
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
                  (Qast.VaAnt ("_lid", loc, a) : 'e__31));
             [Gramext.Stoken ("ANTIQUOT", "lid")],
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
                  (Qast.VaVal (Qast.VaAnt ("lid", loc, a)) : 'e__31))]);
       Gramext.Stoken ("", ":");
       Gramext.Snterm (Grammar.Entry.obj (ctyp : 'ctyp Grammar.Entry.e));
       Gramext.Stoken ("", "=");
       Gramext.Sfacto
      ...
      Gramext.action
        (fun (pd : 'e__32) _ (t : 'ctyp) _ (i : 'e__31) _ (loc : Ploc.t) ->
      ...
      Gramext.action
        (fun (ctl : 'constructor_declaration) _ (loc : Ploc.t) ->
           (let (_, c, tl) =
              match ctl with
                Qast.Tuple [xx1; xx2; xx3] -> xx1, xx2, xx3
              | _ -> raise (Match_failure ("q_MLast.ml", 383, 19))
            in
       ...
       Gramext.Sfacto
         (Gramext.srules
            [[Gramext.Slist0
             ...
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
                  (Qast.VaVal (Qast.VaAnt ("list", loc, a)) : 'e__30))]);
       Gramext.Stoken ("", "end")],
      Gramext.action
        (fun _ (st : 'e__30) _ (loc : Ploc.t) ->
    ...
    [None, None,
     [[Gramext.Sfacto
      ...
      Gramext.action
        (fun (mt : 'module_declaration) (i : 'e__41) (loc : Ploc.t) ->
       ...
       Gramext.Sfacto
         (Gramext.srules
            [[Gramext.Stoken ("UIDENT", "")],
             ...
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
                  (Qast.VaAnt ("_uid", loc, a) : 'e__42));
             [Gramext.Stoken ("ANTIQUOT", "uid")],
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
                  (Qast.VaVal (Qast.VaAnt ("uid", loc, a)) : 'e__42))]);
       Gramext.Stoken ("", ":");
       Gramext.Snterm
         (Grammar.Entry.obj (module_type : 'module_type Grammar.Entry.e));
       Gramext.Stoken ("", ")"); Gramext.Sself],
      Gramext.action
        (fun (mt : 'module_declaration) _ (t : 'module_type) _ (i : 'e__42) _
             (loc : Ploc.t) ->
    ...
    [None, None,
     [[Gramext.Stoken ("", "module");
       ...
       Gramext.Snterm
         (Grammar.Entry.obj (module_expr : 'module_expr Grammar.Entry.e))],
      Gramext.action
        (fun (me : 'module_expr) _ (i : 'e__46) _ (loc : Ploc.t) ->
      ...
      [Gramext.Stoken ("", "type");
       ...
       Gramext.Snterm (Grammar.Entry.obj (ctyp : 'ctyp Grammar.Entry.e))],
      Gramext.action
        (fun (t : 'ctyp) (pf : 'e__45) _ (tpl : 'e__44) (i : 'e__43) _
             (loc : Ploc.t) ->
    ...
    [Some "top", Some Gramext.RightA,
     [[Gramext.Stoken ("", "while"); Gramext.Sself; Gramext.Stoken ("", "do");
       ...
       Gramext.Stoken ("", "}")],
      Gramext.action
        (fun _ (seq : 'e__57) _ _ (e : 'expr) _ (loc : Ploc.t) ->
      ...
      [Gramext.Stoken ("", "for");
       Gramext.Sfacto
         (Gramext.srules
            [[Gramext.Stoken ("LIDENT", "")],
             ...
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
                  (Qast.VaVal (Qast.VaAnt ("lid", loc, a)) : 'e__54))]);
       Gramext.Stoken ("", "="); Gramext.Sself;
       Gramext.Sfacto
         (Gramext.srules
            [[Gramext.Snterm
             ...
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
                  (Qast.VaAnt ("_to", loc, a) : 'e__55));
             [Gramext.Stoken ("ANTIQUOT", "to")],
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
                  (Qast.VaVal (Qast.VaAnt ("to", loc, a)) : 'e__55))]);
       ...
       Gramext.Stoken ("", "}")],
      Gramext.action
        (fun _ (seq : 'e__56) _ _ (e2 : 'expr) (df : 'e__55) (e1 : 'expr) _
             (i : 'e__54) _ (loc : Ploc.t) ->
      ...
      [Gramext.Stoken ("", "do"); Gramext.Stoken ("", "{");
       ...
       Gramext.Stoken ("", "}")],
      Gramext.action
        (fun _ (seq : 'e__53) _ _ (loc : Ploc.t) ->
      ...
      [Gramext.Stoken ("", "try"); Gramext.Sself; Gramext.Stoken ("", "with");
       ...
       Gramext.Stoken ("", "]")],
      Gramext.action
        (fun _ (l : 'e__52) _ _ (e : 'expr) _ (loc : Ploc.t) ->
       ...
       Gramext.Sfacto
         (Gramext.srules
            [[Gramext.Stoken ("UIDENT", "")],
             ...
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
                  (Qast.VaVal (Qast.VaAnt ("uid", loc, a)) : 'e__49))]);
       Gramext.Snterm
         (Grammar.Entry.obj
            (mod_fun_binding : 'mod_fun_binding Grammar.Entry.e));
       Gramext.Stoken ("", "in"); Gramext.Sself],
      Gramext.action
        (fun (e : 'expr) _ (mb : 'mod_fun_binding) (m : 'e__49) _ _
             (loc : Ploc.t) ->
      ...
      [Gramext.Stoken ("", "let");
       Gramext.Sfacto
         (Gramext.srules
            [[Gramext.Sflag (Gramext.Stoken ("", "rec"))],
             ...
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
                  (Qast.VaAnt ("_flag", loc, a) : 'e__47));
             [Gramext.Stoken ("ANTIQUOT", "flag")],
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
                  (Qast.VaVal (Qast.VaAnt ("flag", loc, a)) : 'e__47))]);
       Gramext.Sfacto
         (Gramext.srules
            [[Gramext.Slist1sep
                (Gramext.Snterm
       ...
       Gramext.Stoken ("", "in"); Gramext.Sself],
      Gramext.action
        (fun (x : 'expr) _ (l : 'e__48) (r : 'e__47) _ (loc : Ploc.t) ->
       ...
       Gramext.Sfacto
         (Gramext.srules
            [[Gramext.Sflag (Gramext.Stoken ("", "rec"))],
             ...
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
                  (Qast.VaVal (Qast.VaAnt ("opt", loc, a)) : 'e__58));
             [Gramext.Stoken ("ANTIQUOT", "_flag")],
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
             ...
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
                  (Qast.VaVal (Qast.VaAnt ("flag", loc, a)) : 'e__58))]);
       Gramext.Snterm
         (Grammar.Entry.obj (let_binding : 'let_binding Grammar.Entry.e))],
      Gramext.action
        (fun (lb : 'let_binding) (rf : 'e__58) _ (e : 'expr) (loc : Ploc.t) ->
           (Qast.Node
     ...
     [[Gramext.Sself; Gramext.Stoken ("", "."); Gramext.Sself],
      ...
      [Gramext.Sself; Gramext.Stoken ("", "."); Gramext.Stoken ("", "{");
       ...
       Gramext.Stoken ("", "}")],
      Gramext.action
        (fun _ (el : 'e__59) _ _ (e : 'expr) (loc : Ploc.t) ->
     ...
     [[Gramext.Stoken ("", "(");
      ...
      [Gramext.Stoken ("", "{"); Gramext.Stoken ("", "("); Gramext.Sself;
       ...
       Gramext.Stoken ("", "}")],
      Gramext.action
        (fun _ (lel : 'e__71) _ _ (e : 'expr) _ _ (loc : Ploc.t) ->
      ...
      [Gramext.Sfacto
         (Gramext.srules
            [[Gramext.Stoken ("UIDENT", "")],
             ...
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
                  (Qast.VaVal (Qast.VaAnt ("uid", loc, a)) : 'e__68))])],
      Gramext.action
        (fun (i : 'e__68) (loc : Ploc.t) ->
      ...
      [Gramext.Sfacto
         (Gramext.srules
            [[Gramext.Stoken ("LIDENT", "")],
             ...
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
                  (Qast.VaVal (Qast.VaAnt ("lid", loc, a)) : 'e__67))])],
      Gramext.action
      ...
      [Gramext.Sfacto
         (Gramext.srules
            [[Gramext.Stoken ("CHAR", "")],
             ...
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
                  (Qast.VaAnt ("_chr", loc, a) : 'e__66));
             [Gramext.Stoken ("ANTIQUOT", "chr")],
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
                  (Qast.VaVal (Qast.VaAnt ("chr", loc, a)) : 'e__66))])],
      Gramext.action
      ...
      [Gramext.Sfacto
         (Gramext.srules
            [[Gramext.Stoken ("STRING", "")],
             ...
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
                  (Qast.VaAnt ("_str", loc, a) : 'e__65));
             [Gramext.Stoken ("ANTIQUOT", "str")],
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
                  (Qast.VaVal (Qast.VaAnt ("str", loc, a)) : 'e__65))])],
      Gramext.action
      ...
      [Gramext.Sfacto
         (Gramext.srules
            [[Gramext.Stoken ("FLOAT", "")],
             ...
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
                  (Qast.VaAnt ("_flo", loc, a) : 'e__64));
             [Gramext.Stoken ("ANTIQUOT", "flo")],
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
                  (Qast.VaVal (Qast.VaAnt ("flo", loc, a)) : 'e__64))])],
      Gramext.action
      ...
      [Gramext.Sfacto
         (Gramext.srules
            [[Gramext.Stoken ("INT_n", "")],
             ...
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
                  (Qast.VaAnt ("_nativeint", loc, a) : 'e__63));
      ...
      [Gramext.Sfacto
         (Gramext.srules
            [[Gramext.Stoken ("INT_L", "")],
             ...
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
                  (Qast.VaAnt ("_int64", loc, a) : 'e__62));
             [Gramext.Stoken ("ANTIQUOT", "int64")],
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
                  (Qast.VaVal (Qast.VaAnt ("int64", loc, a)) : 'e__62))])],
      Gramext.action
      ...
      [Gramext.Sfacto
         (Gramext.srules
            [[Gramext.Stoken ("INT_l", "")],
             ...
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
                  (Qast.VaAnt ("_int32", loc, a) : 'e__61));
             [Gramext.Stoken ("ANTIQUOT", "int32")],
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
                  (Qast.VaVal (Qast.VaAnt ("int32", loc, a)) : 'e__61))])],
      Gramext.action
      ...
      [Gramext.Sfacto
         (Gramext.srules
            [[Gramext.Stoken ("INT", "")],
             ...
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
                  (Qast.VaAnt ("_int", loc, a) : 'e__60));
             [Gramext.Stoken ("ANTIQUOT", "int")],
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
                  (Qast.VaVal (Qast.VaAnt ("int", loc, a)) : 'e__60))])],
      Gramext.action
    ...
    [None, Some Gramext.RightA,
     [[Gramext.Snterm (Grammar.Entry.obj (expr : 'expr Grammar.Entry.e))],
      ...
      [Gramext.Stoken ("", "let");
       Gramext.Sfacto
         (Gramext.srules
            [[Gramext.Sflag (Gramext.Stoken ("", "rec"))],
             ...
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
                  (Qast.VaVal (Qast.VaAnt ("opt", loc, a)) : 'e__73));
             [Gramext.Stoken ("ANTIQUOT", "_flag")],
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
             ...
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
                  (Qast.VaVal (Qast.VaAnt ("flag", loc, a)) : 'e__73))]);
       Gramext.Sfacto
         (Gramext.srules
            [[Gramext.Slist1sep
                (Gramext.Snterm
       ...
       Gramext.Stoken ("", "in"); Gramext.Sself],
      Gramext.action
        (fun (el : 'sequence) _ (l : 'e__74) (rf : 'e__73) _ (loc : Ploc.t) ->
           (Qast.List
              [Qast.Node
       ...
       Gramext.Sfacto
         (Gramext.srules
            [[Gramext.Sopt
             ...
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
                  (Qast.VaVal (Qast.VaAnt ("opt", loc, a)) : 'e__75))]);
       Gramext.Stoken ("", "->");
       Gramext.Snterm (Grammar.Entry.obj (expr : 'expr Grammar.Entry.e))],
      Gramext.action
        (fun (e : 'expr) _ (w : 'e__75) (aso : 'as_patt_opt) (p : 'patt)
             (loc : Ploc.t) ->
      ...
      [Gramext.Sfacto
         (Gramext.srules
            [[Gramext.Stoken ("CHAR", "")],
             ...
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
                  (Qast.VaAnt ("_chr", loc, a) : 'e__84));
             [Gramext.Stoken ("ANTIQUOT", "chr")],
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
                  (Qast.VaVal (Qast.VaAnt ("chr", loc, a)) : 'e__84))])],
      Gramext.action
      ...
      [Gramext.Sfacto
         (Gramext.srules
            [[Gramext.Stoken ("STRING", "")],
             ...
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
                  (Qast.VaAnt ("_str", loc, a) : 'e__83));
             [Gramext.Stoken ("ANTIQUOT", "str")],
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
                  (Qast.VaVal (Qast.VaAnt ("str", loc, a)) : 'e__83))])],
      Gramext.action
      ...
      [Gramext.Sfacto
         (Gramext.srules
            [[Gramext.Stoken ("FLOAT", "")],
             ...
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
                  (Qast.VaAnt ("_flo", loc, a) : 'e__82));
             [Gramext.Stoken ("ANTIQUOT", "flo")],
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
                  (Qast.VaVal (Qast.VaAnt ("flo", loc, a)) : 'e__82))])],
      Gramext.action
      ...
      [Gramext.Sfacto
         (Gramext.srules
            [[Gramext.Stoken ("INT_n", "")],
             ...
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
                  (Qast.VaAnt ("_nativeint", loc, a) : 'e__81));
             [Gramext.Stoken ("ANTIQUOT", "nativeint")],
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
                  (Qast.VaVal (Qast.VaAnt ("nativeint", loc, a)) :
      ...
      [Gramext.Sfacto
         (Gramext.srules
            [[Gramext.Stoken ("INT_L", "")],
             ...
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
                  (Qast.VaAnt ("_int64", loc, a) : 'e__80));
             [Gramext.Stoken ("ANTIQUOT", "int64")],
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
                  (Qast.VaVal (Qast.VaAnt ("int64", loc, a)) : 'e__80))])],
      Gramext.action
      ...
      [Gramext.Sfacto
         (Gramext.srules
            [[Gramext.Stoken ("INT_l", "")],
             ...
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
                  (Qast.VaAnt ("_int32", loc, a) : 'e__79));
             [Gramext.Stoken ("ANTIQUOT", "int32")],
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
                  (Qast.VaVal (Qast.VaAnt ("int32", loc, a)) : 'e__79))])],
      Gramext.action
      ...
      [Gramext.Sfacto
         (Gramext.srules
            [[Gramext.Stoken ("INT", "")],
             ...
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
                  (Qast.VaAnt ("_int", loc, a) : 'e__78));
             [Gramext.Stoken ("ANTIQUOT", "int")],
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
                  (Qast.VaVal (Qast.VaAnt ("int", loc, a)) : 'e__78))])],
      Gramext.action
      ...
      [Gramext.Sfacto
         (Gramext.srules
            [[Gramext.Stoken ("UIDENT", "")],
             ...
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
                  (Qast.VaVal (Qast.VaAnt ("uid", loc, a)) : 'e__77))])],
      Gramext.action
      ...
      [Gramext.Sfacto
         (Gramext.srules
            [[Gramext.Stoken ("LIDENT", "")],
             ...
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
                  (Qast.VaVal (Qast.VaAnt ("lid", loc, a)) : 'e__76))])],
      Gramext.action
      ...
      [Gramext.Sfacto
         (Gramext.srules
            [[Gramext.Slist1sep
             ...
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
                  (Qast.VaVal (Qast.VaAnt ("list", loc, a)) : 'e__87))])],
      Gramext.action
        (fun (pl : 'e__87) (loc : Ploc.t) ->
     ...
     [[Gramext.Sfacto
         (Gramext.srules
            [[Gramext.Stoken ("LIDENT", "")],
             ...
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
                  (Qast.VaAnt ("_lid", loc, a) : 'e__89));
             [Gramext.Stoken ("ANTIQUOT", "lid")],
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
                  (Qast.VaVal (Qast.VaAnt ("lid", loc, a)) : 'e__89))])],
      Gramext.action
        (fun (i : 'e__89) (loc : Ploc.t) ->
      ...
      [Gramext.Sfacto
         (Gramext.srules
            [[Gramext.Stoken ("LIDENT", "")],
             ...
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
                  (Qast.VaVal (Qast.VaAnt ("lid", loc, a)) : 'e__91))])],
      Gramext.action
     ...
     [[Gramext.Sfacto
         (Gramext.srules
            [[Gramext.Snterm
             ...
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
                  (Qast.VaAnt ("_tp", loc, a) : 'e__93));
             [Gramext.Stoken ("ANTIQUOT", "tp")],
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
                  (Qast.VaVal (Qast.VaAnt ("tp", loc, a)) : 'e__93))]);
       Gramext.Sfacto
         (Gramext.srules
            [[Gramext.Slist0
                (Gramext.Snterm
       ...
       Gramext.Sfacto
         (Gramext.srules
            [[Gramext.Sflag (Gramext.Stoken ("", "private"))],
             ...
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
                  (Qast.VaAnt ("_priv", loc, a) : 'e__95));
             [Gramext.Stoken ("ANTIQUOT", "priv")],
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
                  (Qast.VaVal (Qast.VaAnt ("priv", loc, a)) : 'e__95))]);
       Gramext.Snterm (Grammar.Entry.obj (ctyp : 'ctyp Grammar.Entry.e));
       Gramext.Sfacto
         (Gramext.srules
            [[Gramext.Slist0
      ...
      Gramext.action
        (fun (cl : 'e__96) (tk : 'ctyp) (pf : 'e__95) _ (tpl : 'e__94)
             (n : 'e__93) (loc : Ploc.t) ->
           (Qast.Record
       ...
       Gramext.Sfacto
         (Gramext.srules
            [[Gramext.Snterm
                (Grammar.Entry.obj (ident : 'ident Grammar.Entry.e))],
             Gramext.action
               (fun (a : 'ident) (loc : Ploc.t) -> (Qast.VaVal a : 'e__99));
             [Gramext.Stoken ("ANTIQUOT", "_")],
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
       ...
       Gramext.Sfacto
         (Gramext.srules
            [[Gramext.Slist1
             ...
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
                  (Qast.VaVal (Qast.VaAnt ("list", loc, a)) : 'e__101))]);
       Gramext.Stoken ("", "."); Gramext.Sself],
      Gramext.action
        (fun (t : 'ctyp) _ (pl : 'e__101) _ (loc : Ploc.t) ->
       ...
       Gramext.Sfacto
         (Gramext.srules
            [[Gramext.Snterm
                (Grammar.Entry.obj (ident : 'ident Grammar.Entry.e))],
             Gramext.action
               (fun (a : 'ident) (loc : Ploc.t) -> (Qast.VaVal a : 'e__102));
             [Gramext.Stoken ("ANTIQUOT", "_")],
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
    ...
    [None, None,
     [[Gramext.Sfacto
      ...
      Gramext.action
        (fun (cal : 'e__109) _ (ci : 'e__108) (loc : Ploc.t) ->
     ...
     [[Gramext.Sfacto
         (Gramext.srules
            [[Gramext.Sflag (Gramext.Stoken ("", "virtual"))],
             ...
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
                  (Qast.VaVal (Qast.VaAnt ("opt", loc, a)) : 'e__115));
             [Gramext.Stoken ("ANTIQUOT", "_flag")],
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
             ...
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
                  (Qast.VaVal (Qast.VaAnt ("flag", loc, a)) : 'e__115))]);
       Gramext.Sfacto
         (Gramext.srules
            [[Gramext.Stoken ("LIDENT", "")],
             Gramext.action
             ...
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
                  (Qast.VaVal (Qast.VaAnt ("lid", loc, a)) : 'e__116))]);
       Gramext.Snterm
         (Grammar.Entry.obj
    ...
    [Some "top", None,
     [[Gramext.Stoken ("", "let");
       Gramext.Sfacto
         (Gramext.srules
            [[Gramext.Sflag (Gramext.Stoken ("", "rec"))],
             ...
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
                  (Qast.VaVal (Qast.VaAnt ("opt", loc, a)) : 'e__118));
             [Gramext.Stoken ("ANTIQUOT", "_flag")],
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
             ...
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
                  (Qast.VaVal (Qast.VaAnt ("flag", loc, a)) : 'e__118))]);
       Gramext.Sfacto
         (Gramext.srules
            [[Gramext.Slist1sep
                (Gramext.Snterm
       ...
       Gramext.Stoken ("", "in"); Gramext.Sself],
      Gramext.action
        (fun (ce : 'class_expr) _ (lb : 'e__119) (rf : 'e__118) _
             (loc : Ploc.t) ->
     ...
     [[Gramext.Stoken ("", "("); Gramext.Sself; Gramext.Stoken ("", ")")],
      ...
      Gramext.action
        (fun (ci : 'e__123) _ (ctcl : 'e__122) _ (loc : Ploc.t) ->
    ...
    [None, None,
     [[Gramext.Sfacto
      ...
      Gramext.action
        (fun (cf : 'e__125) (loc : Ploc.t) -> (cf : 'class_structure))]];
     ...
     [[Gramext.Stoken ("", "initializer");
      ...
      [Gramext.Stoken ("", "method");
       ...
       Gramext.Sfacto
         (Gramext.srules
            [[Gramext.Sflag (Gramext.Stoken ("", "private"))],
             ...
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
                  (Qast.VaAnt ("_priv", loc, a) : 'e__135));
             [Gramext.Stoken ("ANTIQUOT", "priv")],
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
                  (Qast.VaVal (Qast.VaAnt ("priv", loc, a)) : 'e__135))]);
       Gramext.Sfacto
         (Gramext.srules
            [[Gramext.Snterm
                (Grammar.Entry.obj (label : 'label Grammar.Entry.e))],
             Gramext.action
               (fun (a : 'label) (loc : Ploc.t) -> (Qast.VaVal a : 'e__136));
             [Gramext.Stoken ("ANTIQUOT", "_")],
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
             ...
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
                  (Qast.VaVal (Qast.VaAnt ("lid", loc, a)) : 'e__136))]);
       Gramext.Sfacto
         (Gramext.srules
            [[Gramext.Sopt
                (Gramext.Snterm
       ...
       Gramext.Snterm
         (Grammar.Entry.obj (fun_binding : 'fun_binding Grammar.Entry.e))],
      Gramext.action
        (fun (e : 'fun_binding) (topt : 'e__137) (l : 'e__136) (pf : 'e__135)
             (ovf : 'e__134) _ (loc : Ploc.t) ->
       ...
       Gramext.Sfacto
         (Gramext.srules
            [[Gramext.Sflag (Gramext.Stoken ("", "private"))],
             ...
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
                  (Qast.VaVal (Qast.VaAnt ("opt", loc, a)) : 'e__132));
             [Gramext.Stoken ("ANTIQUOT", "_flag")],
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
                  (Qast.VaAnt ("_flag", loc, a) : 'e__132));
             [Gramext.Stoken ("ANTIQUOT", "flag")],
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
                  (Qast.VaVal (Qast.VaAnt ("flag", loc, a)) : 'e__132))]);
       Gramext.Sfacto
         (Gramext.srules
            [[Gramext.Snterm
                (Grammar.Entry.obj (label : 'label Grammar.Entry.e))],
             Gramext.action
               (fun (a : 'label) (loc : Ploc.t) -> (Qast.VaVal a : 'e__133));
             [Gramext.Stoken ("ANTIQUOT", "_")],
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
             ...
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
                  (Qast.VaVal (Qast.VaAnt ("lid", loc, a)) : 'e__133))]);
       Gramext.Stoken ("", ":");
       Gramext.Snterm (Grammar.Entry.obj (ctyp : 'ctyp Grammar.Entry.e))],
      Gramext.action
       ...
       Gramext.Sfacto
         (Gramext.srules
            [[Gramext.Sflag (Gramext.Stoken ("", "mutable"))],
             ...
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
                  (Qast.VaVal (Qast.VaAnt ("opt", loc, a)) : 'e__130));
             [Gramext.Stoken ("ANTIQUOT", "_flag")],
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
                  (Qast.VaAnt ("_flag", loc, a) : 'e__130));
             [Gramext.Stoken ("ANTIQUOT", "flag")],
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
                  (Qast.VaVal (Qast.VaAnt ("flag", loc, a)) : 'e__130))]);
       Gramext.Sfacto
         (Gramext.srules
            [[Gramext.Snterm
                (Grammar.Entry.obj (label : 'label Grammar.Entry.e))],
             Gramext.action
               (fun (a : 'label) (loc : Ploc.t) -> (Qast.VaVal a : 'e__131));
             [Gramext.Stoken ("ANTIQUOT", "_")],
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
             ...
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
                  (Qast.VaVal (Qast.VaAnt ("lid", loc, a)) : 'e__131))]);
       Gramext.Snterm
         (Grammar.Entry.obj
            (cvalue_binding : 'cvalue_binding Grammar.Entry.e))],
      Gramext.action
        (fun (e : 'cvalue_binding) (lab : 'e__131) (mf : 'e__130)
             (ovf : 'e__129) _ (loc : Ploc.t) ->
       ...
       Gramext.Sfacto
         (Gramext.srules
            [[Gramext.Sopt
             ...
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
                  (Qast.VaVal (Qast.VaAnt ("opt", loc, a)) : 'e__128))])],
      Gramext.action
        (fun (pb : 'e__128) (ce : 'class_expr) _ (loc : Ploc.t) ->
    ...
    [Some "top", None,
     [[Gramext.Sself; Gramext.Stoken ("", "[");
       ...
       Gramext.Stoken ("", "]")],
      Gramext.action
        (fun _ (tl : 'e__141) _ (ct : 'class_type) (loc : Ploc.t) ->
      ...
      [Gramext.Stoken ("", "object");
            ...
            [[Gramext.Sopt
             ...
             Gramext.action
               (fun (a : 'class_self_type option) (loc : Ploc.t) ->
                  (Qast.VaVal (Qast.Option a) : 'e__138));
             [Gramext.Stoken ("ANTIQUOT", "_opt")],
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
       ...
       Gramext.Stoken ("", "end")],
      Gramext.action
        (fun _ (csf : 'e__140) (cst : 'e__138) _ (loc : Ploc.t) ->
     ...
     [[Gramext.Sfacto
         (Gramext.srules
            [[Gramext.Stoken ("UIDENT", "")],
             ...
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
                  (Qast.VaAnt ("_id", loc, a) : 'e__143));
             [Gramext.Stoken ("ANTIQUOT", "id")],
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
                  (Qast.VaVal (Qast.VaAnt ("id", loc, a)) : 'e__143))])],
      Gramext.action
      ...
      [Gramext.Sfacto
         (Gramext.srules
            [[Gramext.Stoken ("LIDENT", "")],
             ...
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
                  (Qast.VaAnt ("_id", loc, a) : 'e__142));
             [Gramext.Stoken ("ANTIQUOT", "id")],
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
                  (Qast.VaVal (Qast.VaAnt ("id", loc, a)) : 'e__142))])],
      Gramext.action
       ...
       Gramext.Sfacto
         (Gramext.srules
            [[Gramext.Snterm
                (Grammar.Entry.obj (label : 'label Grammar.Entry.e))],
             Gramext.action
               (fun (a : 'label) (loc : Ploc.t) -> (Qast.VaVal a : 'e__151));
             [Gramext.Stoken ("ANTIQUOT", "_")],
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
       ...
       Gramext.Sfacto
         (Gramext.srules
            [[Gramext.Snterm
                (Grammar.Entry.obj (label : 'label Grammar.Entry.e))],
             Gramext.action
               (fun (a : 'label) (loc : Ploc.t) -> (Qast.VaVal a : 'e__149));
             [Gramext.Stoken ("ANTIQUOT", "_")],
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
     ...
     [[Gramext.Sfacto
         (Gramext.srules
            [[Gramext.Sflag (Gramext.Stoken ("", "virtual"))],
             ...
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
                  (Qast.VaVal (Qast.VaAnt ("opt", loc, a)) : 'e__152));
             [Gramext.Stoken ("ANTIQUOT", "_flag")],
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
             ...
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
                  (Qast.VaVal (Qast.VaAnt ("flag", loc, a)) : 'e__152))]);
       Gramext.Sfacto
         (Gramext.srules
            [[Gramext.Stoken ("LIDENT", "")],
             Gramext.action
             ...
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
                  (Qast.VaVal (Qast.VaAnt ("lid", loc, a)) : 'e__153))]);
       Gramext.Snterm
         (Grammar.Entry.obj
            (class_type_parameters : 'class_type_parameters Grammar.Entry.e));
       Gramext.Stoken ("", ":");
       Gramext.Snterm
         (Grammar.Entry.obj (class_type : 'class_type Grammar.Entry.e))],
      Gramext.action
        (fun (ct : 'class_type) _ (ctp : 'class_type_parameters) (n : 'e__153)
             (vf : 'e__152) (loc : Ploc.t) ->
           (Qast.Record
    ...
    [None, None,
     [[Gramext.Sfacto
       ...
       Gramext.Snterm
         (Grammar.Entry.obj (class_type : 'class_type Grammar.Entry.e))],
      Gramext.action
        (fun (cs : 'class_type) _ (ctp : 'class_type_parameters) (n : 'e__155)
             (vf : 'e__154) (loc : Ploc.t) ->
           (Qast.Record
              ["ciLoc", Qast.Loc; "ciVir", vf; "ciPrm", ctp; "ciNam", n;
               "ciExp", cs] :
            'class_type_declaration))]];
    ...
    [None, Some Gramext.LeftA,
     [[Gramext.Stoken ("", "object");
       Gramext.Sfacto
         (Gramext.srules
            [[Gramext.Sopt
             ...
             Gramext.action
               (fun (a : 'class_self_patt option) (loc : Ploc.t) ->
                  (Qast.VaVal (Qast.Option a) : 'e__157));
             [Gramext.Stoken ("ANTIQUOT", "_opt")],
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
       ...
       Gramext.Stoken ("", "end")],
      Gramext.action
        (fun _ (cf : 'class_structure) (cspo : 'e__157) _ (loc : Ploc.t) ->
    ...
    [None, None,
     [[Gramext.Sself; Gramext.Stoken ("", "#");
       Gramext.Sfacto
         (Gramext.srules
            [[Gramext.Snterm
                (Grammar.Entry.obj (label : 'label Grammar.Entry.e))],
             Gramext.action
               (fun (a : 'label) (loc : Ploc.t) -> (Qast.VaVal a : 'e__158));
             [Gramext.Stoken ("ANTIQUOT", "_")],
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
      ...
      Gramext.action
        (fun (lab : 'e__158) _ (e : 'expr) (loc : Ploc.t) ->
       ...
       Gramext.Sfacto
         (Gramext.srules
            [[Gramext.Slist0sep
             ...
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
                  (Qast.VaVal (Qast.VaAnt ("list", loc, a)) : 'e__159))]);
       Gramext.Stoken ("", ">}")],
      Gramext.action
        (fun _ (fel : 'e__159) _ (loc : Ploc.t) ->
    ...
    [None, None,
     [[Gramext.Stoken ("", "<");
       ...
       Gramext.Stoken ("", ">")],
      Gramext.action
        (fun _ (v : 'e__162) (ml : 'e__161) _ (loc : Ploc.t) ->
       ...
       Gramext.Sfacto
         (Gramext.srules
            [[Gramext.Snterm
             ...
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
                  (Qast.VaVal (Qast.VaAnt ("list", loc, a)) : 'e__160))])],
      Gramext.action
        (fun (id : 'e__160) _ (loc : Ploc.t) ->
     ...
     [[Gramext.Sfacto
         (Gramext.srules
            [[Gramext.Snterm
             ...
             Gramext.action
               (fun (a : 'a_qic) (loc : Ploc.t) -> (a : 'e__164));
       ...
       Gramext.Sself],
      Gramext.action
        (fun (t : 'ctyp) (i : 'e__164) (loc : Ploc.t) ->
      ...
      [Gramext.Sfacto
         (Gramext.srules
            [[Gramext.Snterm
             ...
             Gramext.action
               (fun (a : 'a_tic) (loc : Ploc.t) -> (a : 'e__163));
       ...
       Gramext.Sself],
      Gramext.action
        (fun (t : 'ctyp) (i : 'e__163) (loc : Ploc.t) ->
    ...
    [None, None,
     [[Gramext.Stoken ("", "["); Gramext.Stoken ("", "<");
       ...
       Gramext.Stoken ("", "]")],
      Gramext.action
        (fun _ (ntl : 'e__165) _ (rfl : 'poly_variant_list) _ _
             (loc : Ploc.t) ->
           (Qast.Node
              ("TyVrn",
    ...
    [None, None,
     [[Gramext.Sfacto
      ...
      Gramext.action
        (fun (rfl : 'e__166) (loc : Ploc.t) -> (rfl : 'poly_variant_list))]];
    ...
    [None, None,
     [[Gramext.Snterm (Grammar.Entry.obj (ctyp : 'ctyp Grammar.Entry.e))],
       ...
       Gramext.Sfacto
         (Gramext.srules
            [[Gramext.Snterm
                (Grammar.Entry.obj (ident : 'ident Grammar.Entry.e))],
             Gramext.action
               (fun (a : 'ident) (loc : Ploc.t) -> (Qast.VaVal a : 'e__168));
             [Gramext.Stoken ("ANTIQUOT", "_")],
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
      ...
      Gramext.action
        (fun (l : 'e__170) (ao : 'e__169) _ (i : 'e__168) _ (loc : Ploc.t) ->
    ...
    [None, None,
     [[Gramext.Snterm
      ...
      [Gramext.Sfacto
         (Gramext.srules
            [[Gramext.Snterm
             ...
             Gramext.action (fun (a : 'a_ti) (loc : Ploc.t) -> (a : 'e__178));
      ...
      [Gramext.Sfacto
         (Gramext.srules
            [[Gramext.Snterm
                (Grammar.Entry.obj (a_tic : 'a_tic Grammar.Entry.e))],
             Gramext.action
               (fun (a : 'a_tic) (loc : Ploc.t) -> (a : 'e__177));
             [Gramext.Stoken ("TILDEIDENTCOLON", "")],
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
       ...
       Gramext.Sself],
      Gramext.action
        (fun (p : 'patt) (i : 'e__177) (loc : Ploc.t) ->
           (let _ = warning_deprecated_since_6_00 loc in
            Qast.Node
              ("PaLab",
               [Qast.Loc; Qast.Node ("PaLid", [Qast.Loc; i]);
       ...
       Gramext.Sfacto
         (Gramext.srules
            [[Gramext.Sopt
                (Gramext.srules
                   [[Gramext.Stoken ("", "=");
                     Gramext.Snterm
                       (Grammar.Entry.obj (expr : 'expr Grammar.Entry.e))],
                    Gramext.action
                      (fun (e : 'expr) _ (loc : Ploc.t) -> (e : 'e__175))])],
             Gramext.action
               (fun (a : 'e__175 option) (loc : Ploc.t) ->
             ...
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
                  (Qast.VaVal (Qast.VaAnt ("opt", loc, a)) : 'e__176))]);
       Gramext.Stoken ("", "}")],
      Gramext.action
        (fun _ (eo : 'e__176) (p : 'patt_tcon) _ _ (loc : Ploc.t) ->
      ...
      [Gramext.Stoken ("", "~"); Gramext.Stoken ("", "{");
                ...
                (Gramext.srules
                   [[Gramext.Stoken ("", "=");
                     Gramext.Snterm
                       (Grammar.Entry.obj (patt : 'patt Grammar.Entry.e))],
                    Gramext.action
                      (fun (p : 'patt) _ (loc : Ploc.t) -> (p : 'e__173))])],
             Gramext.action
               (fun (a : 'e__173 option) (loc : Ploc.t) ->
       ...
       Gramext.Stoken ("", "}")],
      Gramext.action
        (fun _ (po : 'e__174) (p : 'patt_tcon) _ _ (loc : Ploc.t) ->
       ...
       Gramext.Sfacto
         (Gramext.srules
            [[Gramext.Snterm
             ...
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
                  (Qast.VaVal (Qast.VaAnt ("list", loc, a)) : 'e__172))])],
      Gramext.action
        (fun (sl : 'e__172) _ (loc : Ploc.t) ->
       ...
       Gramext.Sfacto
         (Gramext.srules
            [[Gramext.Snterm
                (Grammar.Entry.obj (ident : 'ident Grammar.Entry.e))],
             Gramext.action
               (fun (a : 'ident) (loc : Ploc.t) -> (Qast.VaVal a : 'e__171));
             [Gramext.Stoken ("ANTIQUOT", "_")],
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
     ...
     [[Gramext.Snterm
      ...
      [Gramext.Sfacto
         (Gramext.srules
            [[Gramext.Snterm
                (Grammar.Entry.obj (a_ti : 'a_ti Grammar.Entry.e))],
             Gramext.action (fun (a : 'a_ti) (loc : Ploc.t) -> (a : 'e__184));
             [Gramext.Stoken ("TILDEIDENT", "")],
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
      ...
      [Gramext.Sfacto
         (Gramext.srules
            [[Gramext.Snterm
                (Grammar.Entry.obj (a_tic : 'a_tic Grammar.Entry.e))],
             Gramext.action
               (fun (a : 'a_tic) (loc : Ploc.t) -> (a : 'e__183));
             [Gramext.Stoken ("TILDEIDENTCOLON", "")],
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
       ...
       Gramext.Sself],
      Gramext.action
        (fun (p : 'ipatt) (i : 'e__183) (loc : Ploc.t) ->
           (let _ = warning_deprecated_since_6_00 loc in
            Qast.Node
              ("PaLab",
               [Qast.Loc; Qast.Node ("PaLid", [Qast.Loc; i]);
      ...
      [Gramext.Stoken ("", "?"); Gramext.Stoken ("", "{");
                ...
                (Gramext.srules
                   [[Gramext.Stoken ("", "=");
                     Gramext.Snterm
                       (Grammar.Entry.obj (expr : 'expr Grammar.Entry.e))],
                    Gramext.action
                      (fun (e : 'expr) _ (loc : Ploc.t) -> (e : 'e__181))])],
             Gramext.action
       ...
       Gramext.Stoken ("", "}")],
      Gramext.action
        (fun _ (eo : 'e__182) (p : 'ipatt_tcon) _ _ (loc : Ploc.t) ->
      ...
      [Gramext.Stoken ("", "~"); Gramext.Stoken ("", "{");
                ...
                (Gramext.srules
                   [[Gramext.Stoken ("", "=");
                     Gramext.Snterm
                       (Grammar.Entry.obj (patt : 'patt Grammar.Entry.e))],
                    Gramext.action
                      (fun (p : 'patt) _ (loc : Ploc.t) -> (p : 'e__179))])],
             Gramext.action
               (fun (a : 'e__179 option) (loc : Ploc.t) ->
       ...
       Gramext.Stoken ("", "}")],
      Gramext.action
        (fun _ (po : 'e__180) (p : 'ipatt_tcon) _ _ (loc : Ploc.t) ->
    ...
    [None, None,
     [[Gramext.Stoken ("", "?"); Gramext.Stoken ("", "(");
       Gramext.Sfacto
         (Gramext.srules
            [[Gramext.Stoken ("LIDENT", "")],
             ...
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
                  (Qast.VaVal (Qast.VaAnt ("lid", loc, a)) : 'e__197))]);
       Gramext.Stoken ("", ")")],
      Gramext.action
        (fun _ (i : 'e__197) _ _ (loc : Ploc.t) ->
           (Qast.Node
              ("PaOlb",
               [Qast.Loc; Qast.Node ("PaLid", [Qast.Loc; i]);
                Qast.VaVal (Qast.Option None)]) :
      ...
      [Gramext.Stoken ("", "?"); Gramext.Stoken ("", "(");
       ...
       Gramext.Stoken ("", ")")],
      Gramext.action
        (fun _ (e : 'expr) _ (i : 'e__196) _ _ (loc : Ploc.t) ->
           (Qast.Node
              ("PaOlb",
               [Qast.Loc; Qast.Node ("PaLid", [Qast.Loc; i]);
       ...
       Gramext.Sfacto
         (Gramext.srules
            [[Gramext.Stoken ("LIDENT", "")],
             ...
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
                  (Qast.VaVal (Qast.VaAnt ("lid", loc, a)) : 'e__195))]);
       Gramext.Stoken ("", ":");
       Gramext.Snterm (Grammar.Entry.obj (ctyp : 'ctyp Grammar.Entry.e));
       Gramext.Stoken ("", ")")],
      Gramext.action
        (fun _ (t : 'ctyp) _ (i : 'e__195) _ _ (loc : Ploc.t) ->
           (Qast.Node
              ("PaOlb",
               [Qast.Loc;
                Qast.Node
      ...
      [Gramext.Stoken ("", "?"); Gramext.Stoken ("", "(");
       ...
       Gramext.Stoken ("", ")")],
      Gramext.action
        (fun _ (e : 'expr) _ (t : 'ctyp) _ (i : 'e__194) _ _ (loc : Ploc.t) ->
           (Qast.Node
              ("PaOlb",
               [Qast.Loc;
                Qast.Node
      ...
      [Gramext.Sfacto
         (Gramext.srules
            [[Gramext.Snterm
             ...
             Gramext.action (fun (a : 'a_qi) (loc : Ploc.t) -> (a : 'e__193));
       ...
       Gramext.Sfacto
         (Gramext.srules
            [[Gramext.Stoken ("LIDENT", "")],
             ...
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
                  (Qast.VaVal (Qast.VaAnt ("lid", loc, a)) : 'e__192))]);
       Gramext.Stoken ("", ")")],
      Gramext.action
        (fun _ (j : 'e__192) _ (i : 'e__191) (loc : Ploc.t) ->
           (Qast.Node
              ("PaOlb",
               [Qast.Loc; Qast.Node ("PaLid", [Qast.Loc; i]);
                Qast.VaVal
       ...
       Gramext.Sfacto
         (Gramext.srules
            [[Gramext.Stoken ("LIDENT", "")],
             ...
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
                  (Qast.VaVal (Qast.VaAnt ("lid", loc, a)) : 'e__190))]);
       Gramext.Stoken ("", "=");
       Gramext.Snterm (Grammar.Entry.obj (expr : 'expr Grammar.Entry.e));
       Gramext.Stoken ("", ")")],
      Gramext.action
        (fun _ (e : 'expr) _ (j : 'e__190) _ (i : 'e__189) (loc : Ploc.t) ->
           (Qast.Node
              ("PaOlb",
               [Qast.Loc; Qast.Node ("PaLid", [Qast.Loc; i]);
                Qast.VaVal
       ...
       Gramext.Sfacto
         (Gramext.srules
            [[Gramext.Stoken ("LIDENT", "")],
             ...
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
                  (Qast.VaVal (Qast.VaAnt ("lid", loc, a)) : 'e__188))]);
       Gramext.Stoken ("", ":");
       Gramext.Snterm (Grammar.Entry.obj (ctyp : 'ctyp Grammar.Entry.e));
       Gramext.Stoken ("", ")")],
      Gramext.action
        (fun _ (t : 'ctyp) _ (j : 'e__188) _ (i : 'e__187) (loc : Ploc.t) ->
           (Qast.Node
              ("PaOlb",
               [Qast.Loc;
                Qast.Node
      ...
      [Gramext.Sfacto
       ...
       Gramext.Sfacto
         (Gramext.srules
            [[Gramext.Stoken ("LIDENT", "")],
             ...
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
                  (Qast.VaVal (Qast.VaAnt ("lid", loc, a)) : 'e__186))]);
       Gramext.Stoken ("", ":");
       Gramext.Snterm (Grammar.Entry.obj (ctyp : 'ctyp Grammar.Entry.e));
       Gramext.Stoken ("", "=");
       Gramext.Snterm (Grammar.Entry.obj (expr : 'expr Grammar.Entry.e));
       Gramext.Stoken ("", ")")],
      Gramext.action
        (fun _ (e : 'expr) _ (t : 'ctyp) _ (j : 'e__186) _ (i : 'e__185)
             (loc : Ploc.t) ->
           (Qast.Node
              ("PaOlb",
               [Qast.Loc;
    ...
    [Some "label", Some Gramext.NonA,
     [[Gramext.Sfacto
         (Gramext.srules
            [[Gramext.Snterm
                (Grammar.Entry.obj (a_qi : 'a_qi Grammar.Entry.e))],
             Gramext.action (fun (a : 'a_qi) (loc : Ploc.t) -> (a : 'e__205));
             [Gramext.Stoken ("QUESTIONIDENT", "")],
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
      ...
      [Gramext.Sfacto
         (Gramext.srules
            [[Gramext.Snterm
                (Grammar.Entry.obj (a_qic : 'a_qic Grammar.Entry.e))],
             Gramext.action
               (fun (a : 'a_qic) (loc : Ploc.t) -> (a : 'e__204));
             [Gramext.Stoken ("QUESTIONIDENTCOLON", "")],
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
      ...
      [Gramext.Sfacto
         (Gramext.srules
            [[Gramext.Snterm
                (Grammar.Entry.obj (a_ti : 'a_ti Grammar.Entry.e))],
             Gramext.action (fun (a : 'a_ti) (loc : Ploc.t) -> (a : 'e__203));
             [Gramext.Stoken ("TILDEIDENT", "")],
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
       ...
       Gramext.Sfacto
         (Gramext.srules
            [[Gramext.Sopt
                (Gramext.srules
                   [[Gramext.Stoken ("", "=");
                     Gramext.Snterm
                       (Grammar.Entry.obj (expr : 'expr Grammar.Entry.e))],
                    Gramext.action
                      (fun (e : 'expr) _ (loc : Ploc.t) -> (e : 'e__200))])],
             Gramext.action
             ...
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
                  (Qast.VaVal (Qast.VaAnt ("opt", loc, a)) : 'e__201))]);
       Gramext.Stoken ("", "}")],
      Gramext.action
       ...
       Gramext.Sfacto
         (Gramext.srules
            [[Gramext.Sopt
                (Gramext.srules
                   [[Gramext.Stoken ("", "=");
                     Gramext.Snterm
                       (Grammar.Entry.obj (expr : 'expr Grammar.Entry.e))],
                    Gramext.action
                      (fun (e : 'expr) _ (loc : Ploc.t) -> (e : 'e__198))])],
             Gramext.action
             ...
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
                  (Qast.VaVal (Qast.VaAnt ("opt", loc, a)) : 'e__199))]);
       Gramext.Stoken ("", "}")],
      Gramext.action
       ...
       Gramext.Sfacto
         (Gramext.srules
            [[Gramext.Snterm
                (Grammar.Entry.obj (ident : 'ident Grammar.Entry.e))],
             Gramext.action
               (fun (a : 'ident) (loc : Ploc.t) -> (Qast.VaVal a : 'e__206));
             [Gramext.Stoken ("ANTIQUOT", "_")],
             Gramext.action
               (fun (a : string) (loc : Ploc.t) ->
