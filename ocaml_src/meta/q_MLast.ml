   ...
   [Grammar.Entry.obj (module_expr : 'module_expr Grammar.Entry.e), None,
    ...
    [None, None,
     [[Gramext.Stoken ("", "module");
      ...
      [Gramext.Stoken ("", "type");
       ...
       Gramext.Snterm (Grammar.Entry.obj (ctyp : 'ctyp Grammar.Entry.e))],
      Gramext.action
        (fun (t : 'ctyp) (pf : Qast.t) _ (tpl : Qast.t) (i : 'mod_ident2) _
             (loc : Ploc.t) ->
     ...
     [[Gramext.Stoken ("", "while"); Gramext.Sself; Gramext.Stoken ("", "do");
       ...
       Gramext.srules
         [[Gramext.Snterm
          ...
          Gramext.action
            (fun (a : 'sequence) (loc : Ploc.t) -> (Qast.VaVal a : 'e__7));
          [Gramext.Stoken ("ANTIQUOT", "alist")],
          Gramext.action
            (fun (a : string) (loc : Ploc.t) ->
               (Qast.VaAnt ("alist", loc, a) : 'e__7));
       ...
       Gramext.Stoken ("", "}")],
      Gramext.action
        (fun _ (seq : 'e__7) _ _ (e : 'expr) _ (loc : Ploc.t) ->
      ...
      [Gramext.Stoken ("", "for");
       ...
       Gramext.srules
         [[Gramext.Snterm
             (Grammar.Entry.obj (sequence : 'sequence Grammar.Entry.e))],
          Gramext.action
            (fun (a : 'sequence) (loc : Ploc.t) -> (Qast.VaVal a : 'e__6));
          [Gramext.Stoken ("ANTIQUOT", "alist")],
          Gramext.action
            (fun (a : string) (loc : Ploc.t) ->
               (Qast.VaAnt ("alist", loc, a) : 'e__6));
          [Gramext.Stoken ("ANTIQUOT", "list")],
          Gramext.action
            (fun (a : string) (loc : Ploc.t) ->
       ...
       Gramext.Stoken ("", "}")],
      Gramext.action
        (fun _ (seq : 'e__6) _ _ (e2 : 'expr) (df : 'direction_flag2)
      ...
      [Gramext.Stoken ("", "do"); Gramext.Stoken ("", "{");
       Gramext.srules
         [[Gramext.Snterm
             (Grammar.Entry.obj (sequence : 'sequence Grammar.Entry.e))],
          Gramext.action
            (fun (a : 'sequence) (loc : Ploc.t) -> (Qast.VaVal a : 'e__5));
          [Gramext.Stoken ("ANTIQUOT", "alist")],
          Gramext.action
            (fun (a : string) (loc : Ploc.t) ->
               (Qast.VaAnt ("alist", loc, a) : 'e__5));
          [Gramext.Stoken ("ANTIQUOT", "list")],
          Gramext.action
            (fun (a : string) (loc : Ploc.t) ->
     ...
     [[Gramext.Snterm (Grammar.Entry.obj (ident : 'ident Grammar.Entry.e))],
      ...
      Gramext.action
        (fun (s : string) (loc : Ploc.t) ->
           (Qast.VaAnt ("a", loc, s) : 'ident2));
      [Gramext.Stoken ("ANTIQUOT", "")],
      Gramext.action
        (fun (s : string) (loc : Ploc.t) ->
           (Qast.VaVal (Qast.VaAnt ("", loc, s)) : 'ident2))]];
    ...
    [None, None,
     [[Gramext.Stoken ("ANTIQUOT", "a")],
      Gramext.action
        (fun (s : string) (loc : Ploc.t) ->
           (Qast.VaAnt ("a", loc, s) : 'mod_ident2));
      [Gramext.Stoken ("ANTIQUOT", "")],
      Gramext.action
        (fun (s : string) (loc : Ploc.t) ->
           (Qast.VaVal (Qast.VaAnt ("", loc, s)) : 'mod_ident2));
      [Gramext.Stoken ("ANTIQUOT", "alist")],
      Gramext.action
        (fun (s : string) (loc : Ploc.t) ->
           (Qast.VaAnt ("alist", loc, s) : 'mod_ident2));
      [Gramext.Stoken ("ANTIQUOT", "list")],
      Gramext.action
        (fun (s : string) (loc : Ploc.t) ->
           (Qast.VaVal (Qast.VaAnt ("list", loc, s)) : 'mod_ident2));
      [Gramext.Snterm
    ...
    [Some "top", None,
     ...
     [[Gramext.Stoken ("", "("); Gramext.Sself; Gramext.Stoken ("", ")")],
      ...
      [Gramext.Snterm
       ...
       Gramext.Stoken ("", "]")],
      Gramext.action
        (fun _ (ctcl : Qast.t) _ (ci : 'class_longident2) (loc : Ploc.t) ->
     ...
     [[Gramext.Stoken ("", "initializer");
      ...
      [Gramext.Stoken ("", "method");
       ...
       Gramext.Snterm
         (Grammar.Entry.obj (fun_binding : 'fun_binding Grammar.Entry.e))],
      Gramext.action
        (fun (e : 'fun_binding) (topt : Qast.t) (l : 'label2) (pf : Qast.t) _
             (loc : Ploc.t) ->
      ...
      [Gramext.Stoken ("", "method"); Gramext.Stoken ("", "virtual");
       ...
       Gramext.Snterm (Grammar.Entry.obj (ctyp : 'ctyp Grammar.Entry.e))],
      Gramext.action
        (fun (t : 'ctyp) _ (l : 'label2) (pf : Qast.t) _ _ (loc : Ploc.t) ->
      ...
      Gramext.action
        (fun (e : 'cvalue_binding) (lab : 'label2) (mf : Qast.t) _
             (loc : Ploc.t) ->
    ...
    [None, None,
     [[Gramext.Stoken ("", "object");
      ...
      [Gramext.Snterm
       ...
       Gramext.Stoken ("", "]")],
      Gramext.action
        (fun _ (tl : Qast.t) _ (id : 'clty_longident2) (loc : Ploc.t) ->
    ...
    [None, None,
     [[Gramext.Stoken ("", "type");
      ...
      [Gramext.Stoken ("", "method");
       ...
       Gramext.Snterm (Grammar.Entry.obj (ctyp : 'ctyp Grammar.Entry.e))],
      Gramext.action
        (fun (t : 'ctyp) _ (l : 'label2) (pf : Qast.t) _ (loc : Ploc.t) ->
      ...
      [Gramext.Stoken ("", "value");
       ...
       Gramext.Snterm (Grammar.Entry.obj (ctyp : 'ctyp Grammar.Entry.e))],
      Gramext.action
        (fun (t : 'ctyp) _ (l : 'label2) (mf : Qast.t) _ (loc : Ploc.t) ->
    ...
    [None, None,
     [[Gramext.Stoken ("ANTIQUOT", "alist")],
      Gramext.action
        (fun (s : string) (loc : Ploc.t) ->
           (Qast.VaAnt ("alist", loc, s) : 'clty_longident2));
      [Gramext.Stoken ("ANTIQUOT", "list")],
      Gramext.action
        (fun (s : string) (loc : Ploc.t) ->
           (Qast.VaVal (Qast.VaAnt ("list", loc, s)) : 'clty_longident2));
      [Gramext.Snterm
         (Grammar.Entry.obj
    ...
    [None, None,
     [[Gramext.Stoken ("ANTIQUOT", "alist")],
      Gramext.action
        (fun (s : string) (loc : Ploc.t) ->
           (Qast.VaAnt ("alist", loc, s) : 'class_longident2));
      [Gramext.Stoken ("ANTIQUOT", "list")],
      Gramext.action
        (fun (s : string) (loc : Ploc.t) ->
           (Qast.VaVal (Qast.VaAnt ("list", loc, s)) : 'class_longident2));
      [Gramext.Snterm
         (Grammar.Entry.obj
    ...
    [None, None,
     [[Gramext.Stoken ("TILDEANTIQUOTCOLON", "")],
      ...
      Gramext.action
        (fun (a : string) (loc : Ploc.t) ->
           (Qast.VaAnt ("a", loc, a) : 'tildeidentcolon));
      [Gramext.Snterm
         (Grammar.Entry.obj
    ...
    [None, None,
     [[Gramext.Stoken ("QUESTIONANTIQUOT", "")],
      ...
      Gramext.action
        (fun (a : string) (loc : Ploc.t) ->
           (Qast.VaAnt ("a", loc, a) : 'questionident));
      [Gramext.Snterm
         (Grammar.Entry.obj
    ...
    [None, None,
     [[Gramext.Stoken ("QUESTIONANTIQUOTCOLON", "")],
      ...
      Gramext.action
        (fun (a : string) (loc : Ploc.t) ->
           (Qast.VaAnt ("a", loc, a) : 'questionidentcolon));
      [Gramext.Snterm
         (Grammar.Entry.obj
       ...
       Gramext.srules
         [[Gramext.Slist1sep
          ...
          Gramext.action
            (fun (a : 'a_list2) (loc : Ploc.t) -> (a : 'a_list2))]],
      Gramext.action
        (fun (l : Qast.t) (ao : Qast.t) _ (i : 'ident2) _ (loc : Ploc.t) ->
    ...
    [None, None,
     [[Gramext.Stoken ("ANTIQUOT", "ato")],
      Gramext.action
        (fun (s : string) (loc : Ploc.t) ->
           (Qast.VaAnt ("ato", loc, s) : 'direction_flag2));
      [Gramext.Stoken ("ANTIQUOT", "to")],
      Gramext.action
        (fun (s : string) (loc : Ploc.t) ->
           (Qast.VaVal (Qast.VaAnt ("to", loc, s)) : 'direction_flag2));
      [Gramext.Snterm
         (Grammar.Entry.obj
     ...
     [[Gramext.Stoken ("", "'"); Gramext.Stoken ("ANTIQUOT", "a")],
      Gramext.action
        (fun (a : string) _ (loc : Ploc.t) ->
           (Qast.VaAnt ("a", loc, a) : 'typevar2));
      [Gramext.Stoken ("", "'"); Gramext.Stoken ("ANTIQUOT", "")],
      Gramext.action
        (fun (a : string) _ (loc : Ploc.t) ->
           (Qast.VaVal (Qast.VaAnt ("", loc, a)) : 'typevar2))]]]);;
  ...
  [Grammar.Entry.obj (module_expr : 'module_expr Grammar.Entry.e),
   ...
   [None, None,
    [[Gramext.Stoken ("ANTIQUOT", "alist")],
     Gramext.action
       (fun (a : string) (loc : Ploc.t) ->
          (Qast.VaAnt ("alist", loc, a) : 'a_list2));
     [Gramext.Stoken ("ANTIQUOT", "list")],
     Gramext.action
       (fun (a : string) (loc : Ploc.t) ->
   ...
   [None, None,
    [[Gramext.Stoken ("ANTIQUOT", "aflag")],
     Gramext.action
       (fun (a : string) (loc : Ploc.t) ->
          (Qast.VaAnt ("aflag", loc, a) : 'a_flag2));
     [Gramext.Stoken ("ANTIQUOT", "flag")],
     Gramext.action
       (fun (a : string) (loc : Ploc.t) ->
   ...
   [None, None,
    [[Gramext.Stoken ("INT_l", "")],
     ...
     Gramext.action
       (fun (a : string) (loc : Ploc.t) ->
          (Qast.VaAnt ("int32", loc, a) : 'a_INT_l2));
     [Gramext.Stoken ("ANTIQUOT", "int32")],
     Gramext.action
       (fun (a : string) (loc : Ploc.t) ->
   ...
   [None, None,
    [[Gramext.Stoken ("INT_L", "")],
     ...
     Gramext.action
       (fun (a : string) (loc : Ploc.t) ->
          (Qast.VaAnt ("int64", loc, a) : 'a_INT_L2));
     [Gramext.Stoken ("ANTIQUOT", "int64")],
     Gramext.action
       (fun (a : string) (loc : Ploc.t) ->
   ...
   [None, None,
    [[Gramext.Stoken ("INT_n", "")],
     ...
     Gramext.action
       (fun (a : string) (loc : Ploc.t) ->
          (Qast.VaAnt ("nativeint", loc, a) : 'a_INT_n2));
     [Gramext.Stoken ("ANTIQUOT", "nativeint")],
     Gramext.action
       (fun (a : string) (loc : Ploc.t) ->
   ...
   [None, None,
    [[Gramext.Stoken ("STRING", "")],
     ...
     Gramext.action
       (fun (a : string) (loc : Ploc.t) ->
          (Qast.VaAnt ("str", loc, a) : 'a_STRING2));
     [Gramext.Stoken ("ANTIQUOT", "str")],
     Gramext.action
       (fun (a : string) (loc : Ploc.t) ->
