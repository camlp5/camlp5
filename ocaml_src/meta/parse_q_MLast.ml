...
module PA (Base : Mlsyntax.PARSEBASESIG) :
  ...
  struct
    module Base = Base;;
    let gram = Grammar.gcreate (Base.Lexer.gmake ());;
    let antiquot k loc s f =
      ...
      let loc =
        Ploc.make_loc (Ploc.file_name loc) (Ploc.line_nb loc)
          (Ploc.bol_pos loc)
    ...
    let mktupexp _ e el =
      Qast.Node
        ("ExTup", [Qast.Loc; Qast.VaVal (Qast.Cons (e, Qast.List el))])
    ;;
    ...
    let mktuptyp _ t tl =
      Qast.Node
        ("TyTup", [Qast.Loc; Qast.VaVal (Qast.Cons (t, Qast.List tl))])
    ;;
    ...
    ;;
    let greek_ascii_equiv s = Qast.Str (greek_ascii_equiv s);;
    let warned = ref false;;
    let warning_deprecated_since_6_00 loc =
      if not !warned then
        begin
          !(Pcamlbase.warning) loc "syntax deprecated since version 6.00";
          warned := true
        end
    ;;
    ...
    let word_keywordp s =
      ...
      let check (strm__ : _ Stream.t) =
        ...
        | _ -> false
      in
      try check (Stream.of_string s) with
    ...
    ;;
    let stream_npeek n (strm : (string * string) Stream.t) =
      Stream.npeek n strm
    ;;
    let check_sv_uident_colon_f strm =
    ...
    ;;
    let (pa_fails : 'a Stream.t -> Qast.t) =
    ...
    Grammar.safe_extend
      (let _ = (sig_item : 'sig_item Grammar.Entry.e)
       ...
       and _ =
         (extension_constructor : 'extension_constructor Grammar.Entry.e)
       and _ =
       ...
       [Grammar.extension (attribute_id : 'attribute_id Grammar.Entry.e) None
        ...
        Grammar.extension (attribute_body : 'attribute_body Grammar.Entry.e)
          None
          [None, None,
           [Grammar.production
              (Grammar.r_next
                          ...
                          (Grammar.r_next Grammar.r_stop
                           ...
                           (fun (a : string) (loc : Ploc.t) ->
                              (Qast.VaVal (Qast.VaAnt ("expr", loc, a)) :
                               'e__15)))])),
               "194fe98d",
               (fun (e : 'e__15) _ (p : 'e__14) _ (id : 'e__13)
                    (loc : Ploc.t) ->
                  (Qast.Tuple
                     [id;
                      Qast.Node
                        ("PaAttr", [Qast.Loc; p; Qast.Option (Some e)])] :
                   'attribute_body)));
            Grammar.production
              (Grammar.r_next
                 (Grammar.r_next
               ...
               (fun (p : 'e__12) _ (id : 'e__11) (loc : Ploc.t) ->
                  (Qast.Tuple
                     [id;
                      Qast.Node ("PaAttr", [Qast.Loc; p; Qast.Option None])] :
                   'attribute_body)));
            Grammar.production
              (Grammar.r_next
                 (Grammar.r_next
            ...
            Grammar.production
              (Grammar.r_next
                 ...
                 (Grammar.s_nterm
                    (attribute_signature :
                     'attribute_signature Grammar.Entry.e)),
               "194fe98d",
               (fun (si : 'attribute_signature) _ (id : 'e__8)
                    (loc : Ploc.t) ->
            ...
            Grammar.production
              (Grammar.r_next
                 ...
                 (Grammar.s_nterm
                    (attribute_structure :
                     'attribute_structure Grammar.Entry.e)),
               "194fe98d",
                          ...
                          [Grammar.production
                           ...
                           Grammar.production
                             (Grammar.r_next Grammar.r_stop
                              ...
                              (fun (a : string) (loc : Ploc.t) ->
                                 (Qast.VaVal
                                    (Qast.VaAnt ("attribute", loc, a)) :
                                  'e__16)))])))
                 (Grammar.s_token ("", "]")),
               "194fe98d",
               (fun _ (attr : 'e__16) _ (loc : Ploc.t) ->
                  (attr : 'floating_attribute)))]];
        Grammar.extension (item_attribute : 'item_attribute Grammar.Entry.e)
          None
          [None, None,
           [Grammar.production
              (Grammar.r_next
               ...
               (fun _ (attr : 'e__17) _ (loc : Ploc.t) ->
                  (attr : 'item_attribute)))]];
        Grammar.extension (alg_attribute : 'alg_attribute Grammar.Entry.e)
          None
          [None, None,
           [Grammar.production
              (Grammar.r_next
        ...
        Grammar.extension (alg_attributes : 'alg_attributes Grammar.Entry.e)
          None
          [None, None,
           [Grammar.production
              (Grammar.r_next Grammar.r_stop
        ...
        Grammar.extension (item_extension : 'item_extension Grammar.Entry.e)
          None
          [None, None,
           [Grammar.production
              (Grammar.r_next
                          ...
                          [Grammar.production
                           ...
                           Grammar.production
                             (Grammar.r_next Grammar.r_stop
                              ...
                              (fun (a : string) (loc : Ploc.t) ->
                                 (Qast.VaVal
                                    (Qast.VaAnt ("extension", loc, a)) :
                                  'e__21)))])))
                 (Grammar.s_token ("", "]")),
               "194fe98d",
               (fun _ (e : 'e__21) _ (loc : Ploc.t) ->
                  (e : 'item_extension)))]];
        Grammar.extension (alg_extension : 'alg_extension Grammar.Entry.e)
          None
          [None, None,
           [Grammar.production
              (Grammar.r_next
                 ...
                 (Grammar.s_token ("", "]")),
               "194fe98d",
               (fun _ (e : 'e__22) _ (loc : Ploc.t) ->
                  (e : 'alg_extension)))]];
        Grammar.extension
          (functor_parameter : 'functor_parameter Grammar.Entry.e) None
          [None, None,
           [Grammar.production
              (Grammar.r_next
            ...
            Grammar.production
              (Grammar.r_next
               ...
               (fun _ (mt : 'module_type) _ (e : 'expr) _ _ (loc : Ploc.t) ->
                  (Qast.Node
                     ("MeUnp",
                      [Qast.Loc; e; Qast.Option (Some mt);
                       Qast.Option None]) :
                   'module_expr)));
            Grammar.production
              (Grammar.r_next
                 ...
                 (Grammar.s_token ("", ")")),
               "194fe98d",
               (fun _ (mt2 : 'module_type) _ (mt1 : 'module_type) _
                    (e : 'expr) _ _ (loc : Ploc.t) ->
                  (Qast.Node
                     ("MeUnp",
           ...
           [Grammar.production
              ...
              (Grammar.r_next
                 (Grammar.r_next
                    (Grammar.r_next
                       ...
                       (Grammar.s_nterm
                          (check_type_decl :
                           'check_type_decl Grammar.Entry.e)))
                    (Grammar.s_facto
                       (Grammar.s_rules
                          [Grammar.production
                             (Grammar.r_next Grammar.r_stop
                                (Grammar.s_flag
                                   (Grammar.s_token ("", "nonrec"))),
                              "194fe98d",
                          ...
                          (Grammar.r_next Grammar.r_stop
                           ...
                           (fun (a : string) (loc : Ploc.t) ->
                              (Qast.VaVal (Qast.VaAnt ("list", loc, a)) :
                               'e__36)))])),
               "194fe98d",
               (fun (tdl : 'e__36) (nrfl : 'e__35) _ _ (loc : Ploc.t) ->
            ...
            Grammar.production
              (Grammar.r_next
               ...
               "194fe98d",
               (fun (attrs : 'item_attributes) (me : 'module_expr)
                    (ovf : 'e__34) _ (loc : Ploc.t) ->
                       ...
                       (Grammar.s_rules
                          [Grammar.production
                             (Grammar.r_next Grammar.r_stop
                              ...
                              "194fe98d",
                              (fun (a : bool) (loc : Ploc.t) ->
                                 (Qast.VaVal (Qast.Bool a) : 'e__31)));
                           Grammar.production
                             (Grammar.r_next Grammar.r_stop
                                (Grammar.s_token ("ANTIQUOT", "_opt")),
                              "194fe98d",
                              (fun (a : string) (loc : Ploc.t) ->
                                 (Qast.VaAnt ("_opt", loc, a) : 'e__31)));
                           Grammar.production
                             (Grammar.r_next Grammar.r_stop
                                (Grammar.s_token ("ANTIQUOT", "opt")),
                              "194fe98d",
                          ...
                          (Grammar.r_next Grammar.r_stop
                           ...
                           (fun (a : string) (loc : Ploc.t) ->
                              (Qast.VaVal (Qast.VaAnt ("list", loc, a)) :
                               'e__32)))])),
               "194fe98d",
               (fun (l : 'e__32) (r : 'e__31) _ (loc : Ploc.t) ->
            ...
            Grammar.production
              (Grammar.r_next
                 ...
                 (Grammar.s_nterm
                    (item_attributes : 'item_attributes Grammar.Entry.e)),
               "194fe98d",
               (fun (item_attrs : 'item_attributes) (ec : 'e__30) _
                    (loc : Ploc.t) ->
          ...
          [Some "top", Some Gramext.LeftA,
           [Grammar.production
              (Grammar.r_next
                 ...
                 (Grammar.s_token ("", "]")),
               "194fe98d",
               (fun _ (attr : 'e__37) _ (si : 'str_item) (loc : Ploc.t) ->
           ...
           [Grammar.production
            ...
            Grammar.production
              (Grammar.r_next Grammar.r_stop
               ...
               "194fe98d",
               (fun (si : 'shared_str_item) (loc : Ploc.t) ->
                  (si : 'str_item)));
            Grammar.production
              (Grammar.r_next
                 (Grammar.r_next
            ...
            Grammar.production
              (Grammar.r_next
                 ...
                 (Grammar.s_nterm
                    (item_attributes : 'item_attributes Grammar.Entry.e)),
               "194fe98d",
               (fun (attrs : 'item_attributes) (pd : 'e__41) _ (t : 'ctyp)
                    (ls : 'type_binder_opt) _ (i : 'e__40) _ (loc : Ploc.t) ->
                                      ...
                                      [Grammar.production
                                         (Grammar.r_next
                                          ...
                                          (fun _ (s : 'str_item)
                                             ...
                                             (s : 'e__38)))])),
                              "194fe98d",
                              (fun (a : 'e__38 list) (loc : Ploc.t) ->
                                 (Qast.VaVal (Qast.List a) : 'e__39)));
                           Grammar.production
                             (Grammar.r_next Grammar.r_stop
                                (Grammar.s_token ("ANTIQUOT", "_list")),
                              "194fe98d",
                          ...
                          (Grammar.r_next Grammar.r_stop
                           ...
                           (fun (a : string) (loc : Ploc.t) ->
                              (Qast.VaVal (Qast.VaAnt ("lid", loc, a)) :
                               'e__54)))])),
               "194fe98d",
               (fun (i : 'e__54) _ (li : 'extended_longident)
                    (loc : Ploc.t) ->
                  (Qast.Node ("MtLongLid", [Qast.Loc; li; i]) :
                   'module_type)))]];
            ...
            Grammar.production
              (Grammar.r_next
                 ...
                 (Grammar.s_nterm
                    (item_attributes : 'item_attributes Grammar.Entry.e)),
               "194fe98d",
               (fun (attrs : 'item_attributes) (li : 'e__67) _ (i : 'e__66) _
                    _ (loc : Ploc.t) ->
        ...
        Grammar.extension
          (mod_decl_binding : 'mod_decl_binding Grammar.Entry.e) None
          [None, None,
           [Grammar.production
              (Grammar.r_next
                 (Grammar.r_next
          ...
          [None, Some Gramext.RightA,
           [Grammar.production
              (Grammar.r_next
                 ...
                 Grammar.s_self,
               "194fe98d",
               (fun (mt : 'module_declaration) (arg : 'e__80)
                    (loc : Ploc.t) ->
                  (Qast.Node ("MtFun", [Qast.Loc; arg; mt]) :
                   'module_declaration)));
            Grammar.production
           ...
           [Grammar.production
            ...
            Grammar.production
              (Grammar.r_next
                 ...
                 (Grammar.s_nterm (ctyp : 'ctyp Grammar.Entry.e)),
               "194fe98d",
               (fun (t : 'ctyp) (pf : 'e__83) _ (tpl : 'e__82) (lili : 'e__81)
                    _ (loc : Ploc.t) ->
           ...
           [Grammar.production
            ...
            Grammar.production
              (Grammar.r_next
                 ...
                 (Grammar.s_token ("", "}")),
               "194fe98d",
               (fun _ (seq : 'e__96) _ _ (e2 : 'expr) (df : 'e__95)
                          ...
                          (Grammar.s_rules
                             [Grammar.production
                                (Grammar.r_next Grammar.r_stop
                                   (Grammar.s_nterm
                                      (shared_str_item :
                                       'shared_str_item Grammar.Entry.e)),
                                 "194fe98d",
                                 (fun (a : 'shared_str_item) (loc : Ploc.t) ->
                                    (Qast.VaVal a : 'e__93)));
                              Grammar.production
                                (Grammar.r_next Grammar.r_stop
                                   (Grammar.s_token ("ANTIQUOT", "_stri")),
                                 "194fe98d",
                                 (fun (a : string) (loc : Ploc.t) ->
                                    (Qast.VaAnt ("_stri", loc, a) : 'e__93)));
                              Grammar.production
                                (Grammar.r_next Grammar.r_stop
                                 ...
                                 (fun (a : string) (loc : Ploc.t) ->
                                    (Qast.VaVal
                                       (Qast.VaAnt ("stri", loc, a)) :
                                     'e__93)))])))
                    (Grammar.s_token ("", "in")))
                 Grammar.s_self,
               "194fe98d",
               (fun (e : 'expr) _ (si : 'e__93) _ (loc : Ploc.t) ->
                  (Qast.Node ("ExLSI", [Qast.Loc; si; e]) : 'expr)));
            Grammar.production
              (Grammar.r_next
                 (Grammar.r_next
                    (Grammar.r_next
                 ...
                 Grammar.s_self,
               "194fe98d",
               (fun (x : 'expr) _ (l : 'e__92) (r : 'e__91) _
                    (loc : Ploc.t) ->
           ...
           [Grammar.production
              (Grammar.r_next
               ...
               (fun (lb : 'let_binding) (rf : 'e__98) _ (e : 'expr)
                  ...
                  (Qast.Node
                     ("ExLet",
                      [Qast.Loc; rf; Qast.VaVal (Qast.List [lb]); e]) :
                   'expr)))];
                       ...
                       Qast.Node
                         ("ExApp",
                          [Qast.Loc;
                           Qast.Node
                             ("ExLid",
                              [Qast.Loc; Qast.VaVal (Qast.Str "mod")]);
                           e1]);
                       e2]) :
                   'expr)));
            Grammar.production
                       ...
                       Qast.Node
                         ("ExApp",
                          [Qast.Loc;
                           Qast.Node
                             ("ExLid",
                              [Qast.Loc; Qast.VaVal (Qast.Str "lxor")]);
                           e1]);
                       e2]) :
                   'expr)));
            Grammar.production
                       ...
                       Qast.Node
                         ("ExApp",
                          [Qast.Loc;
                           Qast.Node
                             ("ExLid",
                              [Qast.Loc; Qast.VaVal (Qast.Str "lor")]);
                           e1]);
                       e2]) :
                   'expr)));
            Grammar.production
                       ...
                       Qast.Node
                         ("ExApp",
                          [Qast.Loc;
                           Qast.Node
                             ("ExLid",
                              [Qast.Loc; Qast.VaVal (Qast.Str "land")]);
                           e1]);
                       e2]) :
                   'expr)));
            Grammar.production
                       ...
                       Qast.Node
                         ("ExApp",
                          [Qast.Loc;
                           Qast.Node
                             ("ExLid",
                              [Qast.Loc; Qast.VaVal (Qast.Str "lsr")]);
                           e1]);
                       e2]) :
                   'expr)));
            Grammar.production
                       ...
                       Qast.Node
                         ("ExApp",
                          [Qast.Loc;
                           Qast.Node
                             ("ExLid",
                              [Qast.Loc; Qast.VaVal (Qast.Str "lsl")]);
                           e1]);
                       e2]) :
                   'expr)));
            Grammar.production
                       ...
                       Qast.Node
                         ("ExApp",
                          [Qast.Loc;
                           Qast.Node
                             ("ExLid",
                              [Qast.Loc; Qast.VaVal (Qast.Str "asr")]);
                           e1]);
                       e2]) :
                   'expr)));
            Grammar.production
                       ...
                       [Grammar.production
                        ...
                        Grammar.production
                          (Grammar.r_next Grammar.r_stop
                           ...
                           "194fe98d",
                           (fun (a : string) (loc : Ploc.t) ->
                              (Qast.VaAnt ("_lilongid", loc, a) : 'e__100)));
                        Grammar.production
                          (Grammar.r_next Grammar.r_stop
                           ...
                           (fun (a : string) (loc : Ploc.t) ->
                              (Qast.VaVal (Qast.VaAnt ("lilongid", loc, a)) :
                               'e__100)))])),
               "194fe98d",
               (fun (lili : 'e__100) _ (e1 : 'expr) (loc : Ploc.t) ->
            ...
            Grammar.production
              (Grammar.r_next
               ...
               (fun _ (mt : 'module_type) _ (me : 'module_expr) _ _
                    (loc : Ploc.t) ->
                  (Qast.Node
                     ("ExPck", [Qast.Loc; me; Qast.Option (Some mt)]) :
                   'expr)));
            Grammar.production
              (Grammar.r_next
                 (Grammar.r_next Grammar.r_stop (Grammar.s_token ("", "(")))
            ...
            Grammar.production
              (Grammar.r_next
               ...
               (fun _ (lel : 'e__120) _ _ (e : 'expr) _ _ (loc : Ploc.t) ->
                  (Qast.Node
                     ("ExRec", [Qast.Loc; lel; Qast.Option (Some e)]) :
                   'expr)));
            Grammar.production
              (Grammar.r_next
                 (Grammar.r_next
                       ...
                       [Grammar.production
                        ...
                        Grammar.production
                          (Grammar.r_next Grammar.r_stop
                           ...
                           "194fe98d",
                           (fun (a : string) (loc : Ploc.t) ->
                              (Qast.VaAnt ("_locstr", loc, a) : 'e__114)));
                        Grammar.production
                          (Grammar.r_next Grammar.r_stop
                       ...
                       Qast.Node
                         ("ExStr",
                          [Qast.Loc;
                           Qast.VaVal
                             (Qast.Tuple
                                [Qast.Loc; Qast.VaVal (Qast.Str s)])])
                   | VaVal (VaAnt (_, _, _)) ->
            ...
            Grammar.production
              (Grammar.r_next Grammar.r_stop
               ...
               (fun (s : 'e__111) (loc : Ploc.t) ->
                  (Qast.Node ("ExInt", [Qast.Loc; s; Qast.Str "n"]) :
                   'expr)));
            Grammar.production
              (Grammar.r_next Grammar.r_stop
                 (Grammar.s_facto
               ...
               (fun (s : 'e__110) (loc : Ploc.t) ->
                  (Qast.Node ("ExInt", [Qast.Loc; s; Qast.Str "L"]) :
                   'expr)));
            Grammar.production
              (Grammar.r_next Grammar.r_stop
                 (Grammar.s_facto
            ...
            Grammar.production
              (Grammar.r_next Grammar.r_stop
               ...
               (fun (s : 'e__108) (loc : Ploc.t) ->
                  (Qast.Node ("ExInt", [Qast.Loc; s; Qast.Str ""]) :
                   'expr)))]];
        Grammar.extension
          (closed_case_list : 'closed_case_list Grammar.Entry.e) None
          [None, None,
           [Grammar.production
              (Grammar.r_next
                 (Grammar.r_next
            ...
            Grammar.production
              (Grammar.r_next
               ...
               (fun _ (l : 'e__122) _ (loc : Ploc.t) ->
                  (l : 'closed_case_list)))]];
        Grammar.extension (cons_expr_opt : 'cons_expr_opt Grammar.Entry.e)
          None
          [None, None,
           [Grammar.production
              (Grammar.r_stop, "194fe98d",
           ...
           [Grammar.production
              ...
              (Grammar.r_next
                 (Grammar.r_next
                    (Grammar.r_next
                       ...
                       (Grammar.s_nterm
                          (item_attributes :
                           'item_attributes Grammar.Entry.e)))
                    (Grammar.s_token ("", "in")))
                 Grammar.s_self,
               "194fe98d",
               (fun (el : 'sequence) _ (attrs : 'item_attributes)
                    (m : 'module_expr) (ovf : 'e__126) _ _ (loc : Ploc.t) ->
            ...
            Grammar.production
              (Grammar.r_next
                 ...
                 Grammar.s_self,
               "194fe98d",
               (fun (el : 'sequence) _ (mb : 'mod_binding) _ _
                    (loc : Ploc.t) ->
                  (let si =
                     Qast.Node
                       ("StMod",
              ...
              (Grammar.r_next
               ...
               (fun (el : 'sequence) _ (l : 'e__125) (rf : 'e__124) _
                  ...
                  (Qast.List
                     [Qast.Node
                        ("ExLet",
                         [Qast.Loc; rf; l; mksequence Qast.Loc el])] :
                   'sequence)))]];
          ...
          [None, None,
           [Grammar.production
              (Grammar.r_next
                 ...
                 (Grammar.s_nterm (expr : 'expr Grammar.Entry.e)),
               "194fe98d",
               (fun (e : 'expr) _ (w : 'e__127) (aso : 'as_patt_opt)
                    (p : 'patt) (loc : Ploc.t) ->
           ...
           [Grammar.production
              (Grammar.r_next
                 (Grammar.r_next Grammar.r_stop
                    (Grammar.s_nterm
                       (patt_label_ident :
                        'patt_label_ident Grammar.Entry.e)))
                 (Grammar.s_nterm
                    (fun_binding : 'fun_binding Grammar.Entry.e)),
               "194fe98d",
           ...
           [Grammar.production
            ...
            Grammar.production
              (Grammar.r_next
                 ...
                 (Grammar.s_token ("", ")")),
               "194fe98d",
               (fun _ (loc_ids : 'e__131) _ _ _ (li : 'longident)
                    (loc : Ploc.t) ->
              ...
              (Grammar.r_next
                 (Grammar.r_next
                    (Grammar.r_next Grammar.r_stop
                       (Grammar.s_token ("", "(")))
                    (Grammar.s_nterm
                       (paren_patt : 'paren_patt Grammar.Entry.e)))
                 (Grammar.s_token ("", ")")),
               "194fe98d",
            ...
            Grammar.production
              (Grammar.r_next
               ...
               (fun (s : string) _ (loc : Ploc.t) ->
                  (Qast.Node
                     ("PaFlo", [Qast.Loc; Qast.VaVal (neg_string s)]) :
                   'patt)));
            Grammar.production
              (Grammar.r_next
                 (Grammar.r_next Grammar.r_stop (Grammar.s_token ("", "-")))
            ...
            Grammar.production
              (Grammar.r_next Grammar.r_stop
               ...
               (fun (s : 'e__136) (loc : Ploc.t) ->
                  (Qast.Node ("PaInt", [Qast.Loc; s; Qast.Str "n"]) :
                   'patt)));
            Grammar.production
              (Grammar.r_next Grammar.r_stop
                 (Grammar.s_facto
               ...
               (fun (s : 'e__135) (loc : Ploc.t) ->
                  (Qast.Node ("PaInt", [Qast.Loc; s; Qast.Str "L"]) :
                   'patt)));
            Grammar.production
              (Grammar.r_next Grammar.r_stop
                 (Grammar.s_facto
        ...
        Grammar.extension
          (tuple_patt_body1 : 'tuple_patt_body1 Grammar.Entry.e) None
          [None, None,
           [Grammar.production
              (Grammar.r_stop, "194fe98d",
          ...
          [None, None,
           [Grammar.production
              (Grammar.r_next
               ...
               "194fe98d",
               (fun (pl, clflag : 'tuple_patt_body1) (p : 'patt)
                    (loc : Ploc.t) ->
            ...
            Grammar.production
              (Grammar.r_next
                 ...
                 (Grammar.s_nterm
                    (module_type : 'module_type Grammar.Entry.e)),
               "194fe98d",
               (fun (mt : 'module_type) _ (s : 'e__147) _ (loc : Ploc.t) ->
                          ...
                          (Grammar.r_next Grammar.r_stop
                             (Grammar.s_rules
                                [Grammar.production
                                   (Grammar.r_stop, "194fe98d",
                                    (fun (loc : Ploc.t) ->
                                       (Qast.Bool true : 'e__143)));
                                 Grammar.production
                                   (Grammar.r_next Grammar.r_stop
                                      (Grammar.s_token ("", "..")),
                                    "194fe98d",
                                    (fun _ (loc : Ploc.t) ->
                                       (Qast.Bool false : 'e__143)))]),
                           "194fe98d",
                           (fun (a : 'e__143) (loc : Ploc.t) ->
                              (Qast.VaVal a : 'e__144)));
                        Grammar.production
                          (Grammar.r_next Grammar.r_stop
                           ...
                           "194fe98d",
                           (fun (a : string) (loc : Ploc.t) ->
                              (Qast.VaAnt ("_closed", loc, a) : 'e__144)));
                        Grammar.production
                          (Grammar.r_next Grammar.r_stop
                           ...
                           (fun (a : string) (loc : Ploc.t) ->
                              (Qast.VaVal (Qast.VaAnt ("closed", loc, a)) :
                               'e__144)))])),
               "194fe98d",
               (fun (clflag : 'e__144) _ (pl : 'e__142) (loc : Ploc.t) ->
                  (Qast.Node ("PaTup", [Qast.Loc; pl; clflag]) :
                   'paren_patt)));
            Grammar.production
              (Grammar.r_next Grammar.r_stop
                 (Grammar.s_nterm (patt : 'patt Grammar.Entry.e)),
        ...
        Grammar.extension (cons_patt_opt : 'cons_patt_opt Grammar.Entry.e)
          None
          [None, None,
           [Grammar.production
              (Grammar.r_stop, "194fe98d",
        ...
        Grammar.extension
          (patt_label_ident : 'patt_label_ident Grammar.Entry.e) None
          [None, Some Gramext.LeftA,
           [Grammar.production
              (Grammar.r_next Grammar.r_stop (Grammar.s_token ("", "_")),
               "194fe98d",
            ...
            Grammar.production
              (Grammar.r_next
                 ...
                 Grammar.s_self,
               "194fe98d",
               (fun (p2 : 'patt_label_ident) _ (p1 : 'longident)
                    (loc : Ploc.t) ->
           ...
           [Grammar.production
            ...
            Grammar.production
              (Grammar.r_next
                 ...
                 (Grammar.s_token ("", "}")),
               "194fe98d",
               (fun _ (lpl : 'e__150) _ (loc : Ploc.t) ->
                  (Qast.Node ("PaRec", [Qast.Loc; lpl]) : 'ipatt)))]];
        Grammar.extension
          (tuple_ipatt_body1 : 'tuple_ipatt_body1 Grammar.Entry.e) None
          [None, None,
           [Grammar.production
              (Grammar.r_stop, "194fe98d",
            ...
            Grammar.production
              (Grammar.r_next
               ...
               "194fe98d",
               (fun _ _ (loc : Ploc.t) ->
                  ([], false : 'tuple_ipatt_body1)))]];
        Grammar.extension
          (tuple_ipatt_body : 'tuple_ipatt_body Grammar.Entry.e) None
          [None, None,
           [Grammar.production
              (Grammar.r_next
                 (Grammar.r_next Grammar.r_stop
                       ...
                       [Grammar.production
                        ...
                        Grammar.production
                          (Grammar.r_next Grammar.r_stop
                           ...
                           "194fe98d",
                           (fun (a : string) (loc : Ploc.t) ->
                              (Qast.VaAnt ("_uidopt", loc, a) : 'e__159)));
                        Grammar.production
                          (Grammar.r_next Grammar.r_stop
                             (Grammar.s_token ("ANTIQUOT", "uidopt")),
                           "194fe98d",
            ...
            Grammar.production
              (Grammar.r_next
                 ...
                 (Grammar.s_nterm
                    (module_type : 'module_type Grammar.Entry.e)),
               "194fe98d",
               (fun (mt : 'module_type) _ (s : 'e__158) _ (loc : Ploc.t) ->
                  (Qast.Node ("PaUnp", [Qast.Loc; s; Qast.Option (Some mt)]) :
                   'paren_ipatt)));
            Grammar.production
              (Grammar.r_next
                          ...
                          (Grammar.r_next Grammar.r_stop
                             (Grammar.s_rules
                                [Grammar.production
                                   (Grammar.r_stop, "194fe98d",
                                    (fun (loc : Ploc.t) ->
                                       (Qast.Bool true : 'e__154)));
                                 Grammar.production
                                   (Grammar.r_next Grammar.r_stop
                                      (Grammar.s_token ("", "..")),
                                    "194fe98d",
                                    (fun _ (loc : Ploc.t) ->
                                       (Qast.Bool false : 'e__154)))]),
                           "194fe98d",
                           (fun (a : 'e__154) (loc : Ploc.t) ->
                              (Qast.VaVal a : 'e__155)));
                        Grammar.production
                          (Grammar.r_next Grammar.r_stop
                             (Grammar.s_token ("ANTIQUOT", "_closed")),
                           "194fe98d",
                           (fun (a : string) (loc : Ploc.t) ->
                              (Qast.VaAnt ("_closed", loc, a) : 'e__155)));
                        Grammar.production
                          (Grammar.r_next Grammar.r_stop
                             (Grammar.s_token ("ANTIQUOT", "closed")),
                           "194fe98d",
                           (fun (a : string) (loc : Ploc.t) ->
                              (Qast.VaVal (Qast.VaAnt ("closed", loc, a)) :
                               'e__155)))])),
               "194fe98d",
               (fun (clflag : 'e__155) _ (pl : 'e__153) (loc : Ploc.t) ->
                  (Qast.Node ("PaTup", [Qast.Loc; pl; clflag]) :
                   'paren_ipatt)));
            Grammar.production
              (Grammar.r_next Grammar.r_stop
           ...
           [Grammar.production
              (Grammar.r_next
                 ...
                 (Grammar.s_nterm
                    (item_attributes : 'item_attributes Grammar.Entry.e)),
               "194fe98d",
               (fun (attrs : 'item_attributes) (cl : 'e__165) (tk : 'ctyp)
                    (pf : 'e__164) (isDecl : 'e__163) (tpl : 'e__161)
                    (n : 'e__160) (loc : Ploc.t) ->
                  (Qast.Record
                     ["tdIsDecl", isDecl; "tdNam", n; "tdPrm", tpl;
                      "tdPrv", pf; "tdDef", tk; "tdCon", cl;
                      "tdAttributes", attrs] :
                   'type_decl)))]];
        (* TODO FIX: this should be a longident+lid, to match ocaml's grammar *)
        Grammar.extension (type_extension : 'type_extension Grammar.Entry.e)
          None
          [None, None,
           [Grammar.production
              (Grammar.r_next
                 ...
                 (Grammar.s_nterm
                    (item_attributes : 'item_attributes Grammar.Entry.e)),
               "194fe98d",
               (fun (attrs : 'item_attributes) _ (ecs : 'e__169) _
                    (pf : 'e__168) _ (tpl : 'e__167) (n : 'e__166)
                    (loc : Ploc.t) ->
                  (Qast.Record
        ...
        Grammar.extension (type_variance : 'type_variance Grammar.Entry.e)
          None
          [None, None,
           [Grammar.production
              (Grammar.r_stop, "194fe98d",
            ...
            Grammar.production
              (Grammar.r_next Grammar.r_stop (Grammar.s_token ("", "+")),
               "194fe98d",
               (fun _ (loc : Ploc.t) -> (Qast.Str "+" : 'type_variance)))]];
        Grammar.extension (type_parameter : 'type_parameter Grammar.Entry.e)
          None
          [None, None,
           [Grammar.production
              (Grammar.r_next
                          ...
                          (Grammar.r_next Grammar.r_stop
                           ...
                           (fun (a : string) (loc : Ploc.t) ->
                              (Qast.VaVal (Qast.VaAnt ("var", loc, a)) :
                               'e__172)))])),
               "194fe98d",
               (fun (p : 'e__172) (tv : 'e__171) (loc : Ploc.t) ->
                          ...
                          (Grammar.r_next Grammar.r_stop
                           ...
                           (fun (a : string) (loc : Ploc.t) ->
                              (Qast.VaVal (Qast.VaAnt ("uid", loc, a)) :
                               'e__173)))])),
               "194fe98d",
               (fun (i : 'e__173) _ _ (me1 : 'longident) (loc : Ploc.t) ->
           ...
           [Grammar.production
                          ...
                          (Grammar.r_next Grammar.r_stop
                           ...
                           (fun (a : string) (loc : Ploc.t) ->
                              (Qast.VaVal (Qast.VaAnt ("uid", loc, a)) :
                               'e__175)))])),
               "194fe98d",
               (fun (i : 'e__175) _ _ (me1 : 'extended_longident)
                    (loc : Ploc.t) ->
            ...
            Grammar.production
              (Grammar.r_next
                 ...
                 (Grammar.s_token ("", ")")),
               "194fe98d",
               (fun _ (me2 : 'extended_longident) _
                    (me1 : 'extended_longident) (loc : Ploc.t) ->
          ...
          [None, Some Gramext.LeftA,
           [Grammar.production
              (Grammar.r_next
                 ...
                 (Grammar.s_nterm (ctyp : 'ctyp Grammar.Entry.e)),
               "194fe98d",
               (fun (ty : 'ctyp) _ _ (mty : 'module_type) _ (id : 'e__180)
                    (alg_attrs : 'alg_attributes) _ _ _ (i : 'e__179)
                    (loc : Ploc.t) ->
                  (Qast.Node
                     ("TyFun",
                      [Qast.Loc; Qast.VaVal (Qast.Option (Some i)); id; mty;
                       ty]) :
                   'ctyp_ident)));
            Grammar.production
              (Grammar.r_next Grammar.r_stop
                          ...
                          (Grammar.r_next Grammar.r_stop
                           ...
                           (fun (a : string) (loc : Ploc.t) ->
                              (Qast.VaVal (Qast.VaAnt ("lid", loc, a)) :
                               'e__177)))])),
               "194fe98d",
               (fun (i : 'e__177) _ (me1 : 'extended_longident)
                    (loc : Ploc.t) ->
          ...
          [Some "top", Some Gramext.LeftA,
           [Grammar.production
              (Grammar.r_next
                 ...
                 Grammar.s_self,
               "194fe98d",
               (fun (t2 : 'ctyp) (pf : 'e__181) _ (t1 : 'ctyp)
                    (loc : Ploc.t) ->
           ...
           [Grammar.production
              (Grammar.r_next
                 ...
                 (Grammar.s_token ("", "]")),
               "194fe98d",
               (fun _ (attr : 'e__182) _ (t1 : 'ctyp) (loc : Ploc.t) ->
           ...
           [Grammar.production
              (Grammar.r_next
                 ...
                 Grammar.s_self,
               "194fe98d",
               (fun (t : 'ctyp) _ (pl : 'e__184) _ (loc : Ploc.t) ->
            ...
            Grammar.production
              (Grammar.r_next
                 ...
                 Grammar.s_self,
               "194fe98d",
               (fun (t : 'ctyp) _ (pl : 'e__183) _ (loc : Ploc.t) ->
           ...
           [Grammar.production
            ...
            Grammar.production
              (Grammar.r_next
                 ...
                 Grammar.s_self,
               "194fe98d",
               (fun (ct : 'ctyp) _ _ (mt : 'module_type) _ (id : 'e__189) _ _
                    _ (loc : Ploc.t) ->
                  (Qast.Node
                     ("TyFun",
                      [Qast.Loc; Qast.VaVal (Qast.Option None); id; mt; ct]) :
                   'ctyp)));
            Grammar.production
              (Grammar.r_next
                 (Grammar.r_next
                 ...
                 Grammar.s_self,
               "194fe98d",
               (fun (ct : 'ctyp) _ _ (mt : 'module_type) _ (id : 'e__188) _ _
                    _ _ (lab : 'e__187) (loc : Ploc.t) ->
                  (Qast.Node ("TyFun", [Qast.Loc; lab; id; mt; ct]) :
                   'ctyp)));
            Grammar.production
              (Grammar.r_next Grammar.r_stop
                 (Grammar.s_nterm
                          ...
                          (Grammar.r_next Grammar.r_stop
                           ...
                           (fun (a : string) (loc : Ploc.t) ->
                              (Qast.VaVal (Qast.VaAnt ("str", loc, a)) :
                               'e__186)))])),
               "194fe98d",
               (fun (s : 'e__186) _ (loc : Ploc.t) ->
                  (Qast.Node ("TyExt", [Qast.Loc; s]) : 'ctyp)));
            Grammar.production
              (Grammar.r_next Grammar.r_stop (Grammar.s_token ("", "_")),
               "194fe98d",
               (fun _ (loc : Ploc.t) ->
            ...
            Grammar.production
              (Grammar.r_next
               ...
               (fun (t : 'ctyp) _ (li : string) _ (loc : Ploc.t) ->
                  (Qast.Tuple
                     [Qast.VaVal
                        (Qast.Option (Some (Qast.VaVal (Qast.Str li))));
                      t] :
                   'maybe_labeled_ctyp)))]];
                          ...
                          (Grammar.r_next Grammar.r_stop
                           ...
                           (fun (a : string) (loc : Ploc.t) ->
                              (Qast.VaVal (Qast.VaAnt ("uid", loc, a)) :
                               'e__193)))])),
               "194fe98d",
               (fun (ci : 'e__193) (loc : Ploc.t) -> (ci : 'cons_ident)))]];
        Grammar.extension
          (constructor_declaration : 'constructor_declaration Grammar.Entry.e)
          None
          [None, None,
          ...
          [None, None,
           [Grammar.production
              (Grammar.r_next
                                   ...
                                   (Grammar.s_rules
                                      [Grammar.production
                                         (Grammar.r_next
                                            ...
                                            (Grammar.s_nterm
                                               (ctyp :
                                                'ctyp Grammar.Entry.e)),
                                          "194fe98d",
                                          (fun (t : 'ctyp) _ (loc : Ploc.t) ->
                                             (t : 'e__197)))])),
                              "194fe98d",
                              (fun (a : 'e__197 option) (loc : Ploc.t) ->
               ...
               "194fe98d",
               (fun (alg_attrs : 'alg_attributes) (rto : 'e__198)
                    (loc : Ploc.t) ->
            ...
            Grammar.production
              (Grammar.r_next
                                      ...
                                      [Grammar.production
                                         (Grammar.r_next
                                          ...
                                          (fun (t : 'ctyp) _ (loc : Ploc.t) ->
                                             (t : 'e__195)))])),
                              "194fe98d",
                              (fun (a : 'e__195 option) (loc : Ploc.t) ->
                 ...
                 (Grammar.s_nterm
                    (alg_attributes : 'alg_attributes Grammar.Entry.e)),
               "194fe98d",
               (fun (alg_attrs : 'alg_attributes) (rto : 'e__196)
                    (cal : 'e__194) (ls : 'type_binder_opt) _
                    (loc : Ploc.t) ->
           ...
           [Grammar.production
              (Grammar.r_next
               ...
               (fun (l : 'rest_constructor_declaration) (ci : 'cons_ident)
                  ...
                  (Qast.Node
                     ("EcTuple",
                      [Qast.Loc; Qast.Tuple (Qast.Loc :: ci :: l)]) :
                   'extension_constructor)));
            Grammar.production
              (Grammar.r_next
                 (Grammar.r_next
                          ...
                          [Grammar.production
                           ...
                           Grammar.production
                             (Grammar.r_next Grammar.r_stop
                              ...
                              "194fe98d",
                              (fun (a : string) (loc : Ploc.t) ->
                                 (Qast.VaAnt ("_longid", loc, a) : 'e__199)));
                           Grammar.production
                             (Grammar.r_next Grammar.r_stop
                                (Grammar.s_token ("ANTIQUOT", "longid")),
                              "194fe98d",
                 ...
                 (Grammar.s_nterm
                    (alg_attributes : 'alg_attributes Grammar.Entry.e)),
               "194fe98d",
               (fun (alg_attrs : 'alg_attributes) (b : 'e__199) _
                    (ci : 'cons_ident) (loc : Ploc.t) ->
                  (Qast.Node ("EcRebind", [Qast.Loc; ci; b; alg_attrs]) :
                   'extension_constructor)))]];
        Grammar.extension
          (label_declaration : 'label_declaration Grammar.Entry.e) None
          [None, None,
           [Grammar.production
              (Grammar.r_next
                 (Grammar.r_next
           ...
           [Grammar.production
            ...
            Grammar.production
              (Grammar.r_next Grammar.r_stop (Grammar.s_token ("LIDENT", "")),
               "194fe98d",
               (fun (i : string) (loc : Ploc.t) -> (mkident i : 'ident)))]];
        Grammar.extension (direction_flag : 'direction_flag Grammar.Entry.e)
          None
          [None, None,
           [Grammar.production
                          ...
                          (Grammar.r_next Grammar.r_stop
                           ...
                           (fun (a : string) (loc : Ploc.t) ->
                              (Qast.VaVal (Qast.VaAnt ("list", loc, a)) :
                               'e__202)))])),
               "194fe98d",
               (fun (cd : 'e__202) _ (loc : Ploc.t) ->
                  (Qast.Node ("SgCls", [Qast.Loc; cd]) : 'sig_item)))]];
        Grammar.extension
          (class_declaration : 'class_declaration Grammar.Entry.e) None
          [None, None,
           [Grammar.production
              (Grammar.r_next
                 (Grammar.r_next
                             ...
                             (Grammar.s_rules
                                [Grammar.production
                                   (Grammar.r_next Grammar.r_stop
                                    ...
                                    "194fe98d",
                                    (fun (a : string) (loc : Ploc.t) ->
                                       (Qast.VaVal (Qast.Str a) : 'e__205)));
                                 Grammar.production
                                   (Grammar.r_next Grammar.r_stop
                                      (Grammar.s_token ("ANTIQUOT", "_")),
                                    "194fe98d",
                                    (fun (a : string) (loc : Ploc.t) ->
                                       (Qast.VaAnt ("_", loc, a) : 'e__205)));
                                 Grammar.production
                                   (Grammar.r_next Grammar.r_stop
                                      (Grammar.s_token ("ANTIQUOT", "")),
                                    "194fe98d",
                    ...
                    (Grammar.s_nterm
                       (class_fun_binding :
                        'class_fun_binding Grammar.Entry.e)))
                 (Grammar.s_nterm
                    (item_attributes : 'item_attributes Grammar.Entry.e)),
               "194fe98d",
               (fun (attrs : 'item_attributes) (cfb : 'class_fun_binding)
                    (ctp : 'class_type_parameters) (i : 'e__205)
                    (vf : 'e__204) (loc : Ploc.t) ->
                  (Qast.Record
                     ["ciLoc", Qast.Loc; "ciVir", vf; "ciPrm", ctp;
                      "ciNam", i; "ciExp", cfb; "ciAttributes", attrs] :
                   'class_declaration)))]];
        Grammar.extension
          (class_fun_binding : 'class_fun_binding Grammar.Entry.e) None
          [None, None,
           [Grammar.production
              (Grammar.r_next
                 (Grammar.r_next Grammar.r_stop
                       ...
                       (Grammar.s_rules
                          [Grammar.production
                             (Grammar.r_next Grammar.r_stop
                              ...
                              (fun (a : 'type_parameter list)
                                   (loc : Ploc.t) ->
                                 (Qast.VaVal (Qast.List a) : 'e__206)));
                           Grammar.production
                             (Grammar.r_next Grammar.r_stop
                                (Grammar.s_token ("ANTIQUOT", "_list")),
                              "194fe98d",
                              (fun (a : string) (loc : Ploc.t) ->
                                 (Qast.VaAnt ("_list", loc, a) : 'e__206)));
                           Grammar.production
                             (Grammar.r_next Grammar.r_stop
                                (Grammar.s_token ("ANTIQUOT", "list")),
                              "194fe98d",
              ...
              (Grammar.r_stop, "194fe98d",
               (fun (loc : Ploc.t) ->
                  (Qast.Tuple [Qast.Loc; Qast.VaVal (Qast.List [])] :
                   'class_type_parameters)))]];
        Grammar.extension (class_fun_def : 'class_fun_def Grammar.Entry.e)
          None
          [None, None,
           [Grammar.production
              (Grammar.r_next
          ...
          [Some "top", None,
           [Grammar.production
              (Grammar.r_next
                 ...
                 Grammar.s_self,
               "194fe98d",
               (fun (ce : 'class_expr) _ (i : 'extended_longident)
                    (ovf : 'e__209) _ _ (loc : Ploc.t) ->
            ...
            Grammar.production
              (Grammar.r_next
                 ...
                 Grammar.s_self,
               "194fe98d",
               (fun (ce : 'class_expr) _ (lb : 'e__208) (rf : 'e__207) _
                    (loc : Ploc.t) ->
           ...
           [Grammar.production
              (Grammar.r_next
                 ...
                 (Grammar.s_token ("", "]")),
               "194fe98d",
               (fun _ (attr : 'e__211) _ (t1 : 'class_expr) (loc : Ploc.t) ->
                  (Qast.Node ("CeAtt", [Qast.Loc; t1; attr]) :
                   'class_expr)))];
           Some "simple", None,
           [Grammar.production
                       ...
                       [Grammar.production
                        ...
                        Grammar.production
                          (Grammar.r_next Grammar.r_stop
                           ...
                           "194fe98d",
                           (fun (a : string) (loc : Ploc.t) ->
                              (Qast.VaAnt ("_lilongid", loc, a) : 'e__215)));
                        Grammar.production
                          (Grammar.r_next Grammar.r_stop
                             (Grammar.s_token ("ANTIQUOT", "lilongid")),
                           "194fe98d",
                           (fun (a : string) (loc : Ploc.t) ->
                              (Qast.VaVal (Qast.VaAnt ("lilongid", loc, a)) :
                               'e__215)))])),
               "194fe98d",
               (fun (cli : 'e__215) _ (ctcl : 'e__214) _ (loc : Ploc.t) ->
            ...
            Grammar.production
              (Grammar.r_next
                             ...
                             [Grammar.production
                                (Grammar.r_next Grammar.r_stop
                                 ...
                                 (fun (a : 'class_self_patt option)
                                      (loc : Ploc.t) ->
                                    (Qast.VaVal (Qast.Option a) : 'e__213)));
                              Grammar.production
                                (Grammar.r_next Grammar.r_stop
                                   (Grammar.s_token ("ANTIQUOT", "_opt")),
                                 "194fe98d",
                                 (fun (a : string) (loc : Ploc.t) ->
                                    (Qast.VaAnt ("_opt", loc, a) : 'e__213)));
                              Grammar.production
                                (Grammar.r_next Grammar.r_stop
                                   (Grammar.s_token ("ANTIQUOT", "opt")),
                                 "194fe98d",
                 ...
                 (Grammar.s_token ("", "end")),
               "194fe98d",
               (fun _ (cf : 'class_structure) (cspo : 'e__213) _
                    (loc : Ploc.t) ->
                       ...
                       [Grammar.production
                        ...
                        Grammar.production
                          (Grammar.r_next Grammar.r_stop
                           ...
                           "194fe98d",
                           (fun (a : string) (loc : Ploc.t) ->
                              (Qast.VaAnt ("_lilongid", loc, a) : 'e__212)));
                        Grammar.production
                          (Grammar.r_next Grammar.r_stop
                             (Grammar.s_token ("ANTIQUOT", "lilongid")),
                           "194fe98d",
           ...
           [Grammar.production
            ...
            Grammar.production
              (Grammar.r_next
                 ...
                 (Grammar.s_token ("", ")")),
               "194fe98d",
               (fun _ (p : 'patt) _ (loc : Ploc.t) ->
                  (p : 'class_self_patt)))]];
        Grammar.extension (class_str_item : 'class_str_item Grammar.Entry.e)
          None
          [None, None,
           [Grammar.production
              (Grammar.r_next Grammar.r_stop
            ...
            Grammar.production
              (Grammar.r_next Grammar.r_stop
               ...
               "194fe98d",
               (fun (attr : 'floating_attribute) (loc : Ploc.t) ->
                  (Qast.Node ("CrFlAtt", [Qast.Loc; attr]) :
                   'class_str_item)));
            Grammar.production
              (Grammar.r_next
                 (Grammar.r_next
                 ...
                 (Grammar.s_nterm
                    (item_attributes : 'item_attributes Grammar.Entry.e)),
               "194fe98d",
               (fun (attrs : 'item_attributes) (se : 'expr) _
                    (loc : Ploc.t) ->
            ...
            Grammar.production
              (Grammar.r_next
               ...
               (fun (attrs : 'item_attributes) (e : 'fun_binding)
                    (topt : 'e__232) (l : 'e__231) (pf : 'e__230)
                    (ovf : 'e__229) _ (loc : Ploc.t) ->
                  (Qast.Node
                     ("CrMth", [Qast.Loc; ovf; pf; l; topt; e; attrs]) :
                   'class_str_item)));
            Grammar.production
              (Grammar.r_next
                 (Grammar.r_next
                 ...
                 (Grammar.s_nterm
                    (item_attributes : 'item_attributes Grammar.Entry.e)),
               "194fe98d",
               (fun (attrs : 'item_attributes) (t : 'ctyp) _ (l : 'e__228)
                    (pf : 'e__227) _ _ (loc : Ploc.t) ->
            ...
            Grammar.production
              (Grammar.r_next
                 ...
                 (Grammar.s_nterm
                    (item_attributes : 'item_attributes Grammar.Entry.e)),
               "194fe98d",
               (fun (attrs : 'item_attributes) (t : 'ctyp) _ (lab : 'e__226)
                    (mf : 'e__225) _ _ (loc : Ploc.t) ->
            ...
            Grammar.production
              (Grammar.r_next
               ...
               (fun (attrs : 'item_attributes) (e : 'cvalue_binding)
                    (lab : 'e__224) (mf : 'e__223) (ovf : 'e__222) _
                    (loc : Ploc.t) ->
            ...
            Grammar.production
              (Grammar.r_next
                          ...
                          [Grammar.production
                             (Grammar.r_next Grammar.r_stop
                                (Grammar.s_opt
                                   (Grammar.s_nterm
                                      (as_lident :
                                       'as_lident Grammar.Entry.e))),
                              "194fe98d",
                              (fun (a : 'as_lident option) (loc : Ploc.t) ->
                                 (Qast.VaVal (Qast.Option a) : 'e__221)));
                           Grammar.production
                             (Grammar.r_next Grammar.r_stop
                                (Grammar.s_token ("ANTIQUOT", "_opt")),
                              "194fe98d",
                 ...
                 (Grammar.s_nterm
                    (item_attributes : 'item_attributes Grammar.Entry.e)),
               "194fe98d",
               (fun (attrs : 'item_attributes) (pb : 'e__221)
                    (ce : 'class_expr) (ovf : 'e__220) _ (loc : Ploc.t) ->
        ...
        Grammar.extension (cvalue_binding : 'cvalue_binding Grammar.Entry.e)
          None
          [None, None,
           [Grammar.production
              (Grammar.r_next
            ...
            Grammar.production
              (Grammar.r_next
               ...
               (fun (e : 'expr) _ (t2 : 'ctyp) _ (t : 'ctyp) _
                    (loc : Ploc.t) ->
                  (Qast.Node
                     ("ExCoe", [Qast.Loc; e; Qast.Option (Some t); t2]) :
                   'cvalue_binding)));
            Grammar.production
              (Grammar.r_next
                 (Grammar.r_next
          ...
          [Some "top", Some Gramext.RightA,
           [Grammar.production
              (Grammar.r_next
                 ...
                 Grammar.s_self,
               "194fe98d",
               (fun (ce : 'class_type) _ (i : 'extended_longident)
                    (ovf : 'e__233) _ _ (loc : Ploc.t) ->
           ...
           [Grammar.production
              (Grammar.r_next
                 ...
                 (Grammar.s_token ("", "]")),
               "194fe98d",
               (fun _ (attr : 'e__234) _ (t1 : 'class_type) (loc : Ploc.t) ->
           ...
           [Grammar.production
              (Grammar.r_next
                 ...
                 (Grammar.s_token ("", "]")),
               "194fe98d",
               (fun _ (tl : 'e__238) _ (ct : 'class_type) (loc : Ploc.t) ->
            ...
            Grammar.production
              (Grammar.r_next
                 ...
                 (Grammar.s_token ("", "end")),
               "194fe98d",
               (fun _ (csf : 'e__237) (cst : 'e__235) _ (loc : Ploc.t) ->
           ...
           [Grammar.production
            ...
            Grammar.production
              (Grammar.r_next
                 ...
                 (Grammar.s_token ("", ")")),
               "194fe98d",
               (fun _ (ct : 'class_type) _ (loc : Ploc.t) ->
                  (ct : 'class_type)));
            Grammar.production
              (Grammar.r_next Grammar.r_stop
                 (Grammar.s_facto
                          ...
                          (Grammar.r_next Grammar.r_stop
                           ...
                           (fun (a : string) (loc : Ploc.t) ->
                              (Qast.VaVal (Qast.VaAnt ("lid", loc, a)) :
                               'e__239)))])),
               "194fe98d",
               (fun (i : 'e__239) _ (li : 'extended_longident)
                    (loc : Ploc.t) ->
                  (Qast.Node ("CtLongLid", [Qast.Loc; li; i]) :
                   'class_type)))]];
          ...
          [None, None,
           [Grammar.production
              (Grammar.r_next
                 ...
                 (Grammar.s_token ("", ")")),
               "194fe98d",
               (fun _ (t : 'ctyp) _ (loc : Ploc.t) ->
                  (t : 'class_self_type)))]];
        Grammar.extension (class_sig_item : 'class_sig_item Grammar.Entry.e)
          None
          [None, None,
           [Grammar.production
              (Grammar.r_next Grammar.r_stop
            ...
            Grammar.production
              (Grammar.r_next Grammar.r_stop
               ...
               "194fe98d",
               (fun (attr : 'floating_attribute) (loc : Ploc.t) ->
                  (Qast.Node ("CgFlAtt", [Qast.Loc; attr]) :
                   'class_sig_item)));
            Grammar.production
              (Grammar.r_next
                 (Grammar.r_next
            ...
            Grammar.production
              (Grammar.r_next
                 ...
                 (Grammar.s_nterm
                    (item_attributes : 'item_attributes Grammar.Entry.e)),
               "194fe98d",
               (fun (attrs : 'item_attributes) (t : 'ctyp) _ (l : 'e__249)
                    (pf : 'e__248) _ (loc : Ploc.t) ->
            ...
            Grammar.production
              (Grammar.r_next
                 ...
                 (Grammar.s_nterm
                    (item_attributes : 'item_attributes Grammar.Entry.e)),
               "194fe98d",
               (fun (attrs : 'item_attributes) (t : 'ctyp) _ (l : 'e__247)
                    (pf : 'e__246) _ _ (loc : Ploc.t) ->
            ...
            Grammar.production
              (Grammar.r_next
                 ...
                 (Grammar.s_nterm
                    (item_attributes : 'item_attributes Grammar.Entry.e)),
               "194fe98d",
               (fun (attrs : 'item_attributes) (t : 'ctyp) _ (l : 'e__245)
                    (vf : 'e__244) (mf : 'e__243) _ (loc : Ploc.t) ->
            ...
            Grammar.production
              (Grammar.r_next
                 ...
                 (Grammar.s_token ("", "end")),
               "194fe98d",
               (fun _ (st : 'e__242) _ (loc : Ploc.t) ->
                  (Qast.Node ("CgDcl", [Qast.Loc; st]) : 'class_sig_item)))]];
        Grammar.extension
          (class_description : 'class_description Grammar.Entry.e) None
          [None, None,
           [Grammar.production
              (Grammar.r_next
                 (Grammar.r_next
               ...
               (fun (attrs : 'item_attributes) (ct : 'class_type) _
                    (ctp : 'class_type_parameters) (n : 'e__251)
                    (vf : 'e__250) (loc : Ploc.t) ->
                  (Qast.Record
                     ["ciLoc", Qast.Loc; "ciVir", vf; "ciPrm", ctp;
                      "ciNam", n; "ciExp", ct; "ciAttributes", attrs] :
                   'class_description)))]];
        Grammar.extension
          ...
          [None, None,
           [Grammar.production
              (Grammar.r_next
               ...
               "194fe98d",
               (fun (attrs : 'item_attributes) (cs : 'class_type) _
                    (ctp : 'class_type_parameters) (n : 'e__253)
                    (vf : 'e__252) (loc : Ploc.t) ->
                  (Qast.Record
                     ["ciLoc", Qast.Loc; "ciVir", vf; "ciPrm", ctp;
                      "ciNam", n; "ciExp", cs; "ciAttributes", attrs] :
                   'class_type_declaration)))]];
          ...
          [None, Some Gramext.LeftA,
           [Grammar.production
              (Grammar.r_next
                 ...
                 (Grammar.s_token ("", "end")),
               "194fe98d",
               (fun _ (cf : 'class_structure) (cspo : 'e__255) _
                    (loc : Ploc.t) ->
                       ...
                       [Grammar.production
                        ...
                        Grammar.production
                          (Grammar.r_next Grammar.r_stop
                           ...
                           "194fe98d",
                           (fun (a : string) (loc : Ploc.t) ->
                              (Qast.VaAnt ("_lilongid", loc, a) : 'e__254)));
                        Grammar.production
                          (Grammar.r_next Grammar.r_stop
                             (Grammar.s_token ("ANTIQUOT", "lilongid")),
                           "194fe98d",
                          ...
                          (Grammar.r_next Grammar.r_stop
                           ...
                           (fun (a : string) (loc : Ploc.t) ->
                              (Qast.VaVal (Qast.VaAnt ("lid", loc, a)) :
                               'e__256)))])),
               "194fe98d",
               (fun (lab : 'e__256) _ (e : 'expr) (loc : Ploc.t) ->
          ...
          [None, None,
           [Grammar.production
              (Grammar.r_next
                       ...
                       (Grammar.s_rules
                          [Grammar.production
                             (Grammar.r_next Grammar.r_stop
                              ...
                              "194fe98d",
                              (fun (a : bool) (loc : Ploc.t) ->
                                 (Qast.VaVal (Qast.Bool a) : 'e__260)));
                           Grammar.production
                             (Grammar.r_next Grammar.r_stop
                                (Grammar.s_token ("ANTIQUOT", "_opt")),
                              "194fe98d",
                              (fun (a : string) (loc : Ploc.t) ->
                                 (Qast.VaAnt ("_opt", loc, a) : 'e__260)));
                           Grammar.production
                             (Grammar.r_next Grammar.r_stop
                                (Grammar.s_token ("ANTIQUOT", "opt")),
                              "194fe98d",
                 ...
                 (Grammar.s_token ("", ">")),
               "194fe98d",
               (fun _ (v : 'e__260) (ml : 'e__259) _ (loc : Ploc.t) ->
                    ...
                    (Grammar.s_rules
                       [Grammar.production
                          (Grammar.r_next Grammar.r_stop
                           ...
                           "194fe98d",
                           (fun (a : 'extended_longident_lident)
                                (loc : Ploc.t) ->
                              (Qast.VaVal a : 'e__258)));
                        Grammar.production
                          (Grammar.r_next Grammar.r_stop
                           ...
                           "194fe98d",
                           (fun (a : string) (loc : Ploc.t) ->
                              (Qast.VaAnt ("_lilongid", loc, a) : 'e__258)));
                        Grammar.production
                          (Grammar.r_next Grammar.r_stop
                             (Grammar.s_token ("ANTIQUOT", "lilongid")),
                           "194fe98d",
        ...
        Grammar.extension
          (longident_lident : 'longident_lident Grammar.Entry.e) None
          [None, None,
           [Grammar.production
              (Grammar.r_next Grammar.r_stop
                 (Grammar.s_facto
                          ...
                          (Grammar.r_next Grammar.r_stop
                           ...
                           (fun (a : string) (loc : Ploc.t) ->
                              (Qast.VaVal (Qast.VaAnt ("lid", loc, a)) :
                               'e__262)))])),
               "194fe98d",
               (fun (i : 'e__262) _ (li : 'e__261) (loc : Ploc.t) ->
                          ...
                          (Grammar.r_next Grammar.r_stop
                           ...
                           (fun (a : string) (loc : Ploc.t) ->
                              (Qast.VaVal (Qast.VaAnt ("lid", loc, a)) :
                               'e__265)))])),
               "194fe98d",
               (fun (i : 'e__265) _ (li : 'e__264) (loc : Ploc.t) ->
                  (Qast.Tuple [Qast.Option (Some li); i] :
                   'extended_longident_lident)))]];
        (* Labels *)
        Grammar.extension (ctyp : 'ctyp Grammar.Entry.e)
          ...
          [None, Some Gramext.NonA,
           [Grammar.production
              (Grammar.r_next
                 ...
                 Grammar.s_self,
               "194fe98d",
               (fun (t : 'ctyp) (i : 'e__268) (loc : Ploc.t) ->
          ...
          [None, None,
           [Grammar.production
              (Grammar.r_next
                 ...
                 (Grammar.s_token ("", "]")),
               "194fe98d",
               (fun _ (ntl : 'e__269) _ (rfl : 'poly_variant_list) _ _
                    (loc : Ploc.t) ->
                  (Qast.Node
                     ("TyVrn",
                      [Qast.Loc; rfl;
              ...
              (Grammar.r_next
               ...
               (fun _ (rfl : 'poly_variant_list) _ _ (loc : Ploc.t) ->
                  (Qast.Node
                     ("TyVrn",
                      [Qast.Loc; rfl;
                       Qast.Option (Some (Qast.Option None))]) :
                   'ctyp)));
            Grammar.production
              (Grammar.r_next
                 (Grammar.r_next
               ...
               (fun _ (rfl : 'poly_variant_list) _ _ (loc : Ploc.t) ->
                  (Qast.Node ("TyVrn", [Qast.Loc; rfl; Qast.Option None]) :
                   'ctyp)))]];
        Grammar.extension
          (poly_variant_list : 'poly_variant_list Grammar.Entry.e) None
          [None, None,
           [Grammar.production
              (Grammar.r_next Grammar.r_stop
                 (Grammar.s_facto
            ...
            Grammar.production
              (Grammar.r_next
                       ...
                       (Grammar.s_rules
                          [Grammar.production
                             (Grammar.r_next Grammar.r_stop
                              ...
                              "194fe98d",
                              (fun (a : 'ctyp list) (loc : Ploc.t) ->
                                 (Qast.VaVal (Qast.List a) : 'e__274)));
                           Grammar.production
                             (Grammar.r_next Grammar.r_stop
                                (Grammar.s_token ("ANTIQUOT", "_list")),
                              "194fe98d",
                              (fun (a : string) (loc : Ploc.t) ->
                                 (Qast.VaAnt ("_list", loc, a) : 'e__274)));
                           Grammar.production
                             (Grammar.r_next Grammar.r_stop
                                (Grammar.s_token ("ANTIQUOT", "list")),
                              "194fe98d",
                 ...
                 (Grammar.s_nterm
                    (alg_attributes : 'alg_attributes Grammar.Entry.e)),
               "194fe98d",
               (fun (alg_attrs : 'alg_attributes) (l : 'e__274) (ao : 'e__273)
                    _ (i : 'e__272) _ (loc : Ploc.t) ->
            ...
            Grammar.production
              (Grammar.r_next
                 ...
                 (Grammar.s_nterm
                    (alg_attributes : 'alg_attributes Grammar.Entry.e)),
               "194fe98d",
               (fun (alg_attrs : 'alg_attributes) (i : 'e__271) _
                    (loc : Ploc.t) ->
                  (Qast.Node
                     ("PvTag",
           ...
           [Grammar.production
                    ...
                    (Grammar.s_rules
                       [Grammar.production
                          (Grammar.r_next Grammar.r_stop
                           ...
                           "194fe98d",
                           (fun (a : 'a_ti) (loc : Ploc.t) -> (a : 'e__282)));
                        Grammar.production
                          (Grammar.r_next Grammar.r_stop
            ...
            Grammar.production
              (Grammar.r_next
                 ...
                 Grammar.s_self,
               "194fe98d",
               (fun (p : 'patt) (i : 'e__281) (loc : Ploc.t) ->
                  (let _ = warning_deprecated_since_6_00 loc in
                   Qast.Node
                     ("PaLab",
                      [Qast.Loc; Qast.Node ("PaLid", [Qast.Loc; i]);
            ...
            Grammar.production
              (Grammar.r_next
                 (Grammar.r_next
                    (Grammar.r_next
                       (Grammar.r_next
                          ...
                          (Grammar.s_token ("", "{")))
                       (Grammar.s_nterm
                          (patt_tcon : 'patt_tcon Grammar.Entry.e)))
                    (Grammar.s_facto
                       (Grammar.s_rules
                          [Grammar.production
                             (Grammar.r_next Grammar.r_stop
                                   ...
                                   (Grammar.s_rules
                                      [Grammar.production
                                         (Grammar.r_next
                                            ...
                                            (Grammar.s_nterm
                                               (expr :
                                                'expr Grammar.Entry.e)),
                                          "194fe98d",
                                          (fun (e : 'expr) _ (loc : Ploc.t) ->
                                             (e : 'e__279)))])),
                              "194fe98d",
                              (fun (a : 'e__279 option) (loc : Ploc.t) ->
                                 (Qast.VaVal (Qast.Option a) : 'e__280)));
                           Grammar.production
                             (Grammar.r_next Grammar.r_stop
                                (Grammar.s_token ("ANTIQUOT", "_opt")),
                              "194fe98d",
                              (fun (a : string) (loc : Ploc.t) ->
                                 (Qast.VaAnt ("_opt", loc, a) : 'e__280)));
                           Grammar.production
                             (Grammar.r_next Grammar.r_stop
                                (Grammar.s_token ("ANTIQUOT", "opt")),
                              "194fe98d",
                 ...
                 (Grammar.s_token ("", "}")),
               "194fe98d",
               (fun _ (eo : 'e__280) (p : 'patt_tcon) _ _ (loc : Ploc.t) ->
            ...
            Grammar.production
              (Grammar.r_next
                                   ...
                                   (Grammar.s_rules
                                      [Grammar.production
                                         (Grammar.r_next
                                            ...
                                            (Grammar.s_nterm
                                               (patt :
                                                'patt Grammar.Entry.e)),
                                          "194fe98d",
                                          (fun (p : 'patt) _ (loc : Ploc.t) ->
                                             (p : 'e__277)))])),
                              "194fe98d",
                              (fun (a : 'e__277 option) (loc : Ploc.t) ->
                 ...
                 (Grammar.s_token ("", "}")),
               "194fe98d",
               (fun _ (po : 'e__278) (p : 'patt_tcon) _ _ (loc : Ploc.t) ->
                       ...
                       [Grammar.production
                        ...
                        Grammar.production
                          (Grammar.r_next Grammar.r_stop
                           ...
                           "194fe98d",
                           (fun (a : string) (loc : Ploc.t) ->
                              (Qast.VaAnt ("_lilongid", loc, a) : 'e__276)));
                        Grammar.production
                          (Grammar.r_next Grammar.r_stop
                             (Grammar.s_token ("ANTIQUOT", "lilongid")),
                           "194fe98d",
           ...
           [Grammar.production
                    ...
                    (Grammar.s_rules
                       [Grammar.production
                          (Grammar.r_next Grammar.r_stop
                             (Grammar.s_nterm (a_ti : 'a_ti Grammar.Entry.e)),
                           "194fe98d",
                           (fun (a : 'a_ti) (loc : Ploc.t) -> (a : 'e__288)));
                        Grammar.production
                          (Grammar.r_next Grammar.r_stop
                             (Grammar.s_token ("TILDEIDENT", "")),
                           "194fe98d",
            ...
            Grammar.production
              (Grammar.r_next
                 ...
                 Grammar.s_self,
               "194fe98d",
               (fun (p : 'ipatt) (i : 'e__287) (loc : Ploc.t) ->
                  (let _ = warning_deprecated_since_6_00 loc in
                   Qast.Node
                     ("PaLab",
                      [Qast.Loc; Qast.Node ("PaLid", [Qast.Loc; i]);
            ...
            Grammar.production
              (Grammar.r_next
                                      ...
                                      [Grammar.production
                                         (Grammar.r_next
                                          ...
                                          (fun (e : 'expr) _ (loc : Ploc.t) ->
                                             (e : 'e__285)))])),
                              "194fe98d",
                              (fun (a : 'e__285 option) (loc : Ploc.t) ->
                 ...
                 (Grammar.s_token ("", "}")),
               "194fe98d",
               (fun _ (eo : 'e__286) (p : 'ipatt_tcon) _ _ (loc : Ploc.t) ->
            ...
            Grammar.production
              (Grammar.r_next
                                      ...
                                      [Grammar.production
                                         (Grammar.r_next
                                          ...
                                          (fun (p : 'patt) _ (loc : Ploc.t) ->
                                             (p : 'e__283)))])),
                              "194fe98d",
                              (fun (a : 'e__283 option) (loc : Ploc.t) ->
                                 (Qast.VaVal (Qast.Option a) : 'e__284)));
                           Grammar.production
                             (Grammar.r_next Grammar.r_stop
                                (Grammar.s_token ("ANTIQUOT", "_opt")),
                              "194fe98d",
                              (fun (a : string) (loc : Ploc.t) ->
                                 (Qast.VaAnt ("_opt", loc, a) : 'e__284)));
                           Grammar.production
                             (Grammar.r_next Grammar.r_stop
                                (Grammar.s_token ("ANTIQUOT", "opt")),
                              "194fe98d",
                 ...
                 (Grammar.s_token ("", "}")),
               "194fe98d",
               (fun _ (po : 'e__284) (p : 'ipatt_tcon) _ _ (loc : Ploc.t) ->
        ...
        Grammar.extension
          (patt_option_label : 'patt_option_label Grammar.Entry.e) None
          [None, None,
           [Grammar.production
              (Grammar.r_next
                 (Grammar.r_next
            ...
            Grammar.production
              (Grammar.r_next
                 ...
                 (Grammar.s_token ("", ")")),
               "194fe98d",
               (fun _ (e : 'expr) _ (i : 'e__300) _ _ (loc : Ploc.t) ->
                  (Qast.Node
                     ("PaOlb",
                      [Qast.Loc; Qast.Node ("PaLid", [Qast.Loc; i]);
            ...
            Grammar.production
              (Grammar.r_next
                 ...
                 (Grammar.s_token ("", ")")),
               "194fe98d",
               (fun _ (t : 'ctyp) _ (i : 'e__299) _ _ (loc : Ploc.t) ->
                  (Qast.Node
                     ("PaOlb",
                      [Qast.Loc;
                       Qast.Node
            ...
            Grammar.production
              (Grammar.r_next
                 ...
                 (Grammar.s_token ("", ")")),
               "194fe98d",
               (fun _ (e : 'expr) _ (t : 'ctyp) _ (i : 'e__298) _ _
                    (loc : Ploc.t) ->
                  (Qast.Node
                     ("PaOlb",
                      [Qast.Loc;
                    ...
                    (Grammar.s_rules
                       [Grammar.production
                          (Grammar.r_next Grammar.r_stop
                           ...
                           "194fe98d",
                           (fun (a : 'a_qi) (loc : Ploc.t) -> (a : 'e__297)));
                        Grammar.production
                          (Grammar.r_next Grammar.r_stop
                             (Grammar.s_token ("QUESTIONIDENT", "")),
                           "194fe98d",
                           (fun (a : string) (loc : Ploc.t) ->
                              (Qast.VaVal (Qast.Str a) : 'e__297)));
                        Grammar.production
                          (Grammar.r_next Grammar.r_stop
                             (Grammar.s_token ("ANTIQUOT", "?_")),
                           "194fe98d",
                           (fun (a : string) (loc : Ploc.t) ->
                              (Qast.VaAnt ("?_", loc, a) : 'e__297)));
                        Grammar.production
                          (Grammar.r_next Grammar.r_stop
                             (Grammar.s_token ("ANTIQUOT", "?")),
                           "194fe98d",
            ...
            Grammar.production
              (Grammar.r_next
                 ...
                 (Grammar.s_token ("", ")")),
               "194fe98d",
               (fun _ (j : 'e__296) _ (i : 'e__295) (loc : Ploc.t) ->
                  (Qast.Node
                     ("PaOlb",
                      [Qast.Loc; Qast.Node ("PaLid", [Qast.Loc; i]);
                       Qast.VaVal
            ...
            Grammar.production
              (Grammar.r_next
                 ...
                 (Grammar.s_token ("", ")")),
               "194fe98d",
               (fun _ (e : 'expr) _ (j : 'e__294) _ (i : 'e__293)
                    (loc : Ploc.t) ->
                  (Qast.Node
                     ("PaOlb",
                      [Qast.Loc; Qast.Node ("PaLid", [Qast.Loc; i]);
            ...
            Grammar.production
              (Grammar.r_next
                 ...
                 (Grammar.s_token ("", ")")),
               "194fe98d",
               (fun _ (t : 'ctyp) _ (j : 'e__292) _ (i : 'e__291)
                    (loc : Ploc.t) ->
                  (Qast.Node
                     ("PaOlb",
                      [Qast.Loc;
            ...
            Grammar.production
              (Grammar.r_next
                 ...
                 (Grammar.s_token ("", ")")),
               "194fe98d",
               (fun _ (e : 'expr) _ (t : 'ctyp) _ (j : 'e__290) _
                    (i : 'e__289) (loc : Ploc.t) ->
                  (Qast.Node
                     ("PaOlb",
                      [Qast.Loc;
           ...
           [Grammar.production
                    ...
                    (Grammar.s_rules
                       [Grammar.production
                          (Grammar.r_next Grammar.r_stop
                             (Grammar.s_nterm (a_qi : 'a_qi Grammar.Entry.e)),
                           "194fe98d",
                           (fun (a : 'a_qi) (loc : Ploc.t) -> (a : 'e__307)));
                        Grammar.production
                          (Grammar.r_next Grammar.r_stop
                             (Grammar.s_token ("QUESTIONIDENT", "")),
                           "194fe98d",
                           (fun (a : string) (loc : Ploc.t) ->
                              (Qast.VaVal (Qast.Str a) : 'e__307)));
                        Grammar.production
                          (Grammar.r_next Grammar.r_stop
                             (Grammar.s_token ("ANTIQUOT", "?_")),
                           "194fe98d",
            ...
            Grammar.production
              (Grammar.r_next
                 ...
                 Grammar.s_self,
               "194fe98d",
               (fun (e : 'expr) (i : 'e__306) (loc : Ploc.t) ->
                  (let _ = warning_deprecated_since_6_00 loc in
                   Qast.Node
                     ("ExOlb",
                      [Qast.Loc; Qast.Node ("PaLid", [Qast.Loc; i]);
                    ...
                    (Grammar.s_rules
                       [Grammar.production
                          (Grammar.r_next Grammar.r_stop
                             (Grammar.s_nterm (a_ti : 'a_ti Grammar.Entry.e)),
                           "194fe98d",
                           (fun (a : 'a_ti) (loc : Ploc.t) -> (a : 'e__305)));
                        Grammar.production
                          (Grammar.r_next Grammar.r_stop
                             (Grammar.s_token ("TILDEIDENT", "")),
                           "194fe98d",
            ...
            Grammar.production
              (Grammar.r_next
                 ...
                 Grammar.s_self,
               "194fe98d",
               (fun (e : 'expr) (i : 'e__304) (loc : Ploc.t) ->
                  (let _ = warning_deprecated_since_6_00 loc in
                   Qast.Node
                     ("ExLab",
                      [Qast.Loc; Qast.Node ("PaLid", [Qast.Loc; i]);
            ...
            Grammar.production
              (Grammar.r_next
                 ...
                 (Grammar.s_token ("", "}")),
               "194fe98d",
               (fun _ (eo : 'e__303) (p : 'ipatt_tcon) _ _ (loc : Ploc.t) ->
    ...
    let antiquot_xtr loc n a =
      if !(Pcaml.strict_mode) then
        Qast.Node
          (n, [Qast.Loc; Qast.VaAnt ("xtr", loc, a); Qast.Option None])
         ...
         [None, None,
          [Grammar.production
             (Grammar.r_next Grammar.r_stop
              ...
              (fun (a : string) (loc : Ploc.t) ->
                 (Qast.Node
                    ("ExAnt", [Qast.Loc; Qast.VaAnt ("anti", loc, a)]) :
                  'expr)));
           Grammar.production
             (Grammar.r_next Grammar.r_stop
                (Grammar.s_token ("ANTIQUOT", "xtr")),
         ...
         [None, None,
          [Grammar.production
             (Grammar.r_next Grammar.r_stop
              ...
              (fun (a : string) (loc : Ploc.t) ->
                 (Qast.Node
                    ("PaAnt", [Qast.Loc; Qast.VaAnt ("anti", loc, a)]) :
                  'patt)));
           Grammar.production
             (Grammar.r_next Grammar.r_stop
                (Grammar.s_token ("ANTIQUOT", "xtr")),
    ...
    let apply_entry e q =
      ...
      let patt s =
        ...
        let qast =
          ...
          if locate then
            match qast with
              Qast.Node (n, Qast.Loc :: nl) ->
                Qast.Node (n, Qast.TrueLoc :: nl)
    ...
    Grammar.safe_extend
      [Grammar.extension
       ...
       Grammar.extension (class_expr_eoi : 'class_expr_eoi Grammar.Entry.e)
         None
         [None, None,
          [Grammar.production
             (Grammar.r_next
       ...
       Grammar.extension (class_type_eoi : 'class_type_eoi Grammar.Entry.e)
         None
         [None, None,
          [Grammar.production
             (Grammar.r_next
       ...
       Grammar.extension
         (extended_longident_eoi : 'extended_longident_eoi Grammar.Entry.e)
         None
         [None, None,
          [Grammar.production
             (Grammar.r_next
       ...
       Grammar.extension
         (extension_constructor_eoi :
          'extension_constructor_eoi Grammar.Entry.e)
         None
         [None, None,
          [Grammar.production
             (Grammar.r_next
       ...
       Grammar.extension (constructor_eoi : 'constructor_eoi Grammar.Entry.e)
         None
         [None, None,
          [Grammar.production
             (Grammar.r_next
         ...
         [None, None,
          [Grammar.production
             (Grammar.r_next
                ...
                (Grammar.s_token ("EOI", "")),
              "194fe98d",
              (fun _ (x : 'longident) (loc : Ploc.t) ->
                 (x : 'longident_eoi)))]];
       Grammar.extension (module_expr_eoi : 'module_expr_eoi Grammar.Entry.e)
         None
         [None, None,
          [Grammar.production
             (Grammar.r_next
              ...
              (fun _ (x : 'module_expr) (loc : Ploc.t) ->
                 (x : 'module_expr_eoi)))]];
       Grammar.extension (module_type_eoi : 'module_type_eoi Grammar.Entry.e)
         None
         [None, None,
          [Grammar.production
             (Grammar.r_next
       ...
       Grammar.extension
         (poly_variant_eoi : 'poly_variant_eoi Grammar.Entry.e) None
         [None, None,
          [Grammar.production
             (Grammar.r_next
                (Grammar.r_next Grammar.r_stop
       ...
       Grammar.extension (with_constr_eoi : 'with_constr_eoi Grammar.Entry.e)
         None
         [None, None,
          [Grammar.production
             (Grammar.r_next
                    ...
                    MLast.ExApp
                      (loc,
                       MLast.ExLong
                         (loc,
                          MLast.LiAcc
                            (loc, MLast.LiUid (loc, "Ploc"), "VaAnt")),
                       MLast.ExAnt (loc, a))
                  else
                    MLast.ExApp
