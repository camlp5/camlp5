...
module OldPrinters =
  struct
    ...
    let pr_str_item =
      {pr_fun = (fun _ -> raise (Match_failure ("pcaml.ml", 393, 34)));
       pr_levels = []}
    ;;
    let pr_sig_item =
    ...
    ;;
    let pr_module_type =
      {pr_fun = (fun _ -> raise (Match_failure ("pcaml.ml", 395, 37)));
       pr_levels = []}
    ;;
    let pr_module_expr =
    ...
    ;;
    let pr_expr =
      {pr_fun = (fun _ -> raise (Match_failure ("pcaml.ml", 397, 30)));
       pr_levels = []}
    ;;
    let pr_patt =
    ...
    let pr_class_sig_item =
      {pr_fun = (fun _ -> raise (Match_failure ("pcaml.ml", 400, 40)));
       pr_levels = []}
    ;;
