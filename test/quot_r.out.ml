...
MLast.MtFun loc (Some (Some (Ploc.VaVal smtf1), smtf2)) mt;
MLast.MtFun loc (Some (Some smtf1, smtf2)) mt;
...
MLast.MeFun loc (Some (Some (Ploc.VaVal smtf1), smtf2)) me;
MLast.MeFun loc (Some (Some smtf1, smtf2)) me;
