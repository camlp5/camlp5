...
List.iter
  ...
  [("expr", apply_entry expr_eoi Meta.E.expr Meta.P.expr);
   ("patt", apply_entry patt_eoi Meta.E.patt Meta.P.patt);
   ("ctyp", apply_entry ctyp_eoi Meta.E.ctyp Meta.P.ctyp);
   ("str_item", apply_entry str_item_eoi Meta.E.str_item Meta.P.str_item);
   ("sig_item", apply_entry sig_item_eoi Meta.E.sig_item Meta.P.sig_item);
   ("module_expr",
    apply_entry module_expr_eoi Meta.E.module_expr Meta.P.module_expr);
   ("module_type",
    apply_entry module_type_eoi Meta.E.module_type Meta.P.module_type);
   ("with_constr",
    apply_entry with_constr_eoi Meta.E.with_constr Meta.P.with_constr);
   ("poly_variant",
    apply_entry poly_variant_eoi Meta.E.poly_variant Meta.P.poly_variant);
   ("class_expr",
    apply_entry class_expr_eoi Meta.E.class_expr Meta.P.class_expr);
   ("class_type",
    apply_entry class_type_eoi Meta.E.class_type Meta.P.class_type);
   ("class_str_item",
    apply_entry class_str_item_eoi Meta.E.class_str_item
      Meta.P.class_str_item);
   ("class_sig_item",
    apply_entry class_sig_item_eoi Meta.E.class_sig_item
      Meta.P.class_sig_item)]
;
