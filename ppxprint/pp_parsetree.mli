...
module Location :
  sig
    ...
    ;
    value pp_loc : Fmt.t 'a -> Fmt.t (loc 'a);
    value show_loc : Fmt.t 'a -> loc 'a -> Stdlib.String.t;
    [@@@"end"];
  end
;
module Longident :
...
value pp_open_infos : Fmt.t 'a -> Fmt.t (open_infos 'a);
value show_open_infos : Fmt.t 'a -> open_infos 'a -> Stdlib.String.t;
...
value pp_include_infos : Fmt.t 'a -> Fmt.t (include_infos 'a);
value show_include_infos : Fmt.t 'a -> include_infos 'a -> Stdlib.String.t;
