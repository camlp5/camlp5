...
module Ploc =
  struct
    include Ploc;
    value pp ppf x = Fmt.(const string "<loc>" ppf ());
    type vala 'a =
      Ploc.vala 'a ==
        [ VaAnt of string
        | VaVal of 'a ][@@"deriving_inline" show;]
    ;
    value rec pp_vala : ! 'a . Fmt.t 'a -> Fmt.t (vala 'a) =
    ...
    and show_vala : ! 'a . Fmt.t 'a -> vala 'a -> Stdlib.String.t =
...
value rec pp_class_infos : ! 'a . Fmt.t 'a -> Fmt.t (class_infos 'a) =
  fun (type a) (tp_0 : Fmt.t a) (ofmt : Format.formatter) arg ->
    (fun ofmt
